Return-Path: <linux-xfs+bounces-30091-lists+linux-xfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-xfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id ELh+Ii50cWm3HAAAu9opvQ
	(envelope-from <linux-xfs+bounces-30091-lists+linux-xfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-xfs@lfdr.de>; Thu, 22 Jan 2026 01:49:50 +0100
X-Original-To: lists+linux-xfs@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id 78B00600F8
	for <lists+linux-xfs@lfdr.de>; Thu, 22 Jan 2026 01:49:50 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 181BF3C2A10
	for <lists+linux-xfs@lfdr.de>; Thu, 22 Jan 2026 00:49:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 06D1030ACF2;
...
X-Spamd-Result: default: False [-1.46 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-30091-lists,linux-xfs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[ams.mirrors.kernel.org:helo,ams.mirrors.kernel.org:rdns,lst.de:email,suse.com:email]
X-Rspamd-Queue-Id: 78B00600F8
