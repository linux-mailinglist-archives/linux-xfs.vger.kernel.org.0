Return-Path: <linux-xfs+bounces-74-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 6D1067F8718
	for <lists+linux-xfs@lfdr.de>; Sat, 25 Nov 2023 00:57:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id C5639B21558
	for <lists+linux-xfs@lfdr.de>; Fri, 24 Nov 2023 23:57:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 87D5B3DB8D;
	Fri, 24 Nov 2023 23:57:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="BhJhIjI2"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 489473DB88
	for <linux-xfs@vger.kernel.org>; Fri, 24 Nov 2023 23:57:05 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 15ED1C433C7;
	Fri, 24 Nov 2023 23:57:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1700870225;
	bh=OakVHMRRY2nywOAxGWkpHnFxeihZL/MsSvmgamobYjk=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Fri, 24 Nov 2023 15:57:04 -0800
Subject: [PATCH 5/5] xfs: repair quotas
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: linux-xfs@vger.kernel.org
Message-ID: <170086928871.2771741.2277452744114090363.stgit@frogsfrogsfrogs>
...
---
 ...
 10 files changed, 628 insertions(+), 8 deletions(-)
...
index 0000000000000..0bab4c30cb85a
--- /dev/null
...
index f54dff9268bcc..da0866f9b4525 100644
...
index 4641522fd9070..d0e24ffaf7547 100644
...
index 3bfd53b4e8d0b..f8e316357f56f 100644
--- a/fs/xfs/scrub/trace.h
+++ b/fs/xfs/scrub/trace.h
@@ -1732,6 +1732,35 @@ TRACE_EVENT(xrep_cow_free_staging,
 		  __entry->blockcount)
 );
...
index 60ec401e26ffd..a93ad76f23c56 100644
