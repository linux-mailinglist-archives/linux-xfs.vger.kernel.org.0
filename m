Return-Path: <linux-xfs+bounces-5207-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A23887EFCA
	for <lists+linux-xfs@lfdr.de>; Mon, 18 Mar 2024 19:32:10 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 50B99283A3B
	for <lists+linux-xfs@lfdr.de>; Mon, 18 Mar 2024 18:32:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 52BF41D68C;
	Mon, 18 Mar 2024 18:32:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="udM1iABj"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 11BED3C2D
	for <linux-xfs@vger.kernel.org>; Mon, 18 Mar 2024 18:32:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710786726; cv=none; b=s/BNdwXO+rv07/mN7BfwXhMZwwdRsvj0YTWUMRV1J+cl0hXmAWVwixSee2pp5v2vutqmlFbpwB3fuFniul6Ueohoo3NCUedLYtKOxEGYU7s49EfnBKPOuZfw1udPVG/eDK+tvu+l1U2bTlmefqW3iJw/r/Vts2dzqN14fs5mqaI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710786726; c=relaxed/simple;
	bh=gMWqnSVHUvVsUh6DKTe/6rxL1fWoceo3zTxE2yVhdYk=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=hk6RfDp1KiybfrDo69m5cmaRlHizLs+nOEUPHbpN0w0j2a2klAE1OxehG0Zs1SzTxWUUHUPTAS0EJzLv62sqo/pSD8/YtgiG3ChWs6dyaCmkdNSlmpZnN/nT7R0qsdroqdPThkdrazaWlHuWzNpfLJcHFkn4gvsObA6mDWPWYPU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=udM1iABj; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 9D99DC433C7;
	Mon, 18 Mar 2024 18:32:05 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1710786725;
	bh=gMWqnSVHUvVsUh6DKTe/6rxL1fWoceo3zTxE2yVhdYk=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=
Date: Mon, 18 Mar 2024 11:32:05 -0700
From: "Darrick J. Wong" <djwong@kernel.org>
To: cem@kernel.org
Cc: linux-xfs@vger.kernel.org
Subject: [PATCH v24.5.1 1/8] xfs_db: add a bmbt inflation command
Message-ID: <20240318183205.GJ1927156@frogsfrogsfrogs>
...
index d00801ab4739..83389376c36c 100644
--- a/db/Makefile
+++ b/db/Makefile
...
index 000000000000..33b0c954d8f8
--- /dev/null
+++ b/db/bmap_inflate.c
@@ -0,0 +1,551 @@
...
index 2bbd7b0b24f9..6cda03e9856d 100644
--- a/db/command.c
+++ b/db/command.c
...
index a89e71504f9c..2c2926afd7b5 100644
--- a/db/command.h
+++ b/db/command.h
...
index f53ddd67d87c..a7f6d55ed8be 100644
--- a/man/man8/xfs_db.8
+++ b/man/man8/xfs_db.8
@@ -388,6 +388,29 @@ and
