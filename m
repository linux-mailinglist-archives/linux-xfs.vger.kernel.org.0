...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4C6BE7989FA
	for <lists+linux-xfs@lfdr.de>; Fri,  8 Sep 2023 17:28:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239662AbjIHP2f (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 8 Sep 2023 11:28:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39794 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229530AbjIHP2f (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Fri, 8 Sep 2023 11:28:35 -0400
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8B1D91FC1
        for <linux-xfs@vger.kernel.org>; Fri,  8 Sep 2023 08:28:28 -0700 (PDT)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 07869C433C9;
        Fri,  8 Sep 2023 15:28:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1694186908;
        bh=dKzxxUCCZv4ZzThRc+s1w9eKm7bf+1KYTOz9fuAMuok=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Fri, 8 Sep 2023 08:28:27 -0700
...
Message-ID: <20230908152827.GX28186@frogsfrogsfrogs>
...
In-Reply-To: <ZPqYU79pTYYZFmf9@dread.disaster.area>
...
With the unit cleanups in place, I can actually tell what's going on in
the rt allocator just by looking at variables types, instead of trying
to guess whether a particular xfs_fsblock_t refers to (a) segmented
address on the data device, (b) block in rt volume, (c) extent in rt
volume, (d) block offset in bitmap or summaryfile, or (e) other random
places where someone needed a u64.
...
Yeah, I was thinking about changing all the APIs to pass a structure
around like we do for the bnobt. :)
