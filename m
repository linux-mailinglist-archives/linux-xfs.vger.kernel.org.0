Return-Path: <linux-xfs+bounces-29939-lists+linux-xfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-xfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 8BOBFhPSb2mgMQAAu9opvQ
	(envelope-from <linux-xfs+bounces-29939-lists+linux-xfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-xfs@lfdr.de>; Tue, 20 Jan 2026 20:05:55 +0100
X-Original-To: lists+linux-xfs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id BDC664A003
	for <lists+linux-xfs@lfdr.de>; Tue, 20 Jan 2026 20:05:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 6EE69A251FE
	for <lists+linux-xfs@lfdr.de>; Tue, 20 Jan 2026 16:54:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4C8FB3491D0;
...
X-Spamd-Result: default: False [1.54 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-29939-lists,linux-xfs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	DMARC_POLICY_ALLOW(0.00)[oracle.com,reject];
	MIME_TRACE(0.00)[0:+];
	FORGED_SENDER_MAILLIST(0.00)[];
	DKIM_TRACE(0.00)[oracle.com:+,oracle.onmicrosoft.com:+];
	DBL_BLOCKED_OPENRESOLVER(0.00)[lucifer.local:mid,dfw.mirrors.kernel.org:rdns,dfw.mirrors.kernel.org:helo,oracle.com:dkim,oracle.onmicrosoft.com:dkim];
	TO_DN_SOME(0.00)[];
