...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D5324611C70
	for <lists+linux-xfs@lfdr.de>; Fri, 28 Oct 2022 23:35:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229542AbiJ1VfN (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 28 Oct 2022 17:35:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53734 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229792AbiJ1VfM (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Fri, 28 Oct 2022 17:35:12 -0400
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 459A240E04
        for <linux-xfs@vger.kernel.org>; Fri, 28 Oct 2022 14:35:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666992907; x=1698528907;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=PktSXR4ghONs13vy1W+etG9YK34GKRQXuahXxxQ4wr4=;
  b=nUlDhRGLm/RJxcfLgeGDbEbRmvc0OcukhUTDftBp+lDq4//5a1kB4/S5
   Csf4DWVqWQnpJakBDkrr5ZLOtZsyJ2/74ZaNB2dXElc3PToqy5QNHcjDx
   ZYEfijVjaDyqkeZr359Yrszx1BzkaxiCT7zkalQbF9kbfaZrfJ6qaCWUE
   SAbJWYhLVGm2dEd8lQlKy930ghHOtGui34L9tqUQJ6GTtyXGqwlFw8Jj1
   EH/nYeX43ZWVz05ZLNFQTKKkACrYOIiN0DEfyOmcr+HUYmq9ko35S6N+8
   3ThFIgmyTPHFMXOMHAoqGhdI1SIOM95b/pc0YRgrPdTNobBQq5jPrwe1Z
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10514"; a="307324134"
X-IronPort-AV: E=Sophos;i="5.95,222,1661842800"; 
   d="scan'208";a="307324134"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Oct 2022 14:35:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10514"; a="610887957"
X-IronPort-AV: E=Sophos;i="5.95,222,1661842800"; 
   d="scan'208";a="610887957"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by orsmga006.jf.intel.com with ESMTP; 28 Oct 2022 14:35:04 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ooX0J-000AF9-2t;
        Fri, 28 Oct 2022 21:35:03 +0000
Date:   Sat, 29 Oct 2022 05:35:00 +0800
From:   kernel test robot <lkp@intel.com>
To:     Brian Foster <bfoster@redhat.com>, linux-xfs@vger.kernel.org
Cc:     llvm@lists.linux.dev, oe-kbuild-all@lists.linux.dev
Subject: Re: [PATCH] xfs: redirty eof folio on truncate to avoid filemap flush
Message-ID: <202210290512.Hy5PuJpl-lkp@intel.com>
References: <20221028131109.977581-1-bfoster@redhat.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="cp8HHlV8D1ovgsJ0"
...
url:    https://github.com/intel-lab-lkp/linux/commits/Brian-Foster/xfs-redirty-eof-folio-on-truncate-to-avoid-filemap-flush/20221028-211253
base:   https://git.kernel.org/pub/scm/fs/xfs/xfs-linux.git for-next
patch link:    https://lore.kernel.org/r/20221028131109.977581-1-bfoster%40redhat.com
patch subject: [PATCH] xfs: redirty eof folio on truncate to avoid filemap flush
config: x86_64-randconfig-a014
compiler: clang version 14.0.6 (https://github.com/llvm/llvm-project f28c006a5895fc0e329fe15fead81e37457cb1d1)
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/b16e2c202472f3fc46e66c37fdc7c381b968af75
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Brian-Foster/xfs-redirty-eof-folio-on-truncate-to-avoid-filemap-flush/20221028-211253
        git checkout b16e2c202472f3fc46e66c37fdc7c381b968af75
...
>> fs/xfs/xfs_iops.c:863:8: warning: variable 'eof_dirty' is used uninitialized whenever 'if' condition is false [-Wsometimes-uninitialized]
                           if (folio_test_dirty(eof_folio) ||
                               ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   fs/xfs/xfs_iops.c:867:9: note: uninitialized use occurs here
                           if (!eof_dirty) {
                                ^~~~~~~~~
   fs/xfs/xfs_iops.c:863:4: note: remove the 'if' if its condition is always true
                           if (folio_test_dirty(eof_folio) ||
                           ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   fs/xfs/xfs_iops.c:793:18: note: initialize the variable 'eof_dirty' to silence this warning
           bool                    eof_dirty;
                                            ^
                                             = 0
   1 warning generated.
...
vim +863 fs/xfs/xfs_iops.c
   ...
   787		struct folio		*eof_folio = NULL;
   ...
   815			return xfs_setattr_nonsize(mnt_userns, ip, iattr);
   816		}
   817	
   818		/*
   ...
   844		} else {
   845			/*
   846			 * iomap won't detect a dirty folio over an unwritten block (or
   847			 * a cow block over a hole) and subsequently skips zeroing the
   848			 * newly post-EOF portion of the folio. Doing a flush here (i.e.
   849			 * as is done for fallocate ZERO_RANGE) updates extent state for
   850			 * iomap, but has too much overhead for the truncate path.
   851			 *
   852			 * Instead, check whether the new EOF is dirty in pagecache. If
   853			 * so, hold a reference across the pagecache truncate and dirty
   854			 * the folio. This ensures that partial folio zeroing from the
   855			 * truncate makes it to disk in the rare event that iomap skips
   856			 * zeroing and writeback happens to complete before the
   857			 * pagecache truncate. Note that this really should be handled
   858			 * properly by iomap zero range.
   859			 */
   860			eof_folio = filemap_lock_folio(inode->i_mapping,
   861						(newsize - 1) >> PAGE_SHIFT);
   862			if (eof_folio) {
 > 863				if (folio_test_dirty(eof_folio) ||
   864				    folio_test_writeback(eof_folio))
   865					eof_dirty = true;
   866				folio_unlock(eof_folio);
   867				if (!eof_dirty) {
   868					folio_put(eof_folio);
   869					eof_folio = NULL;
   870				}
   871			}
   872			error = xfs_truncate_page(ip, newsize, &did_zeroing);
   873		}
   874	
   875		if (error) {
   876			if (eof_folio)
   877				folio_put(eof_folio);
   878			return error;
   879		}
   880	
   881		/*
   ...
   903		if (eof_folio) {
   904			trace_printk("%d: ino 0x%llx newsize 0x%llx folio idx 0x%lx did_zeroing %d\n",
   905				__LINE__, ip->i_ino, newsize, folio_index(eof_folio), did_zeroing);
   906			if (!did_zeroing) {
   907				filemap_dirty_folio(inode->i_mapping, eof_folio);
   908				did_zeroing = true;
   909			}
   910			folio_put(eof_folio);
   911		}
   912	
   913		/*
   ...
   920		 */
   921		if (did_zeroing ||
   922		    (newsize > ip->i_disk_size && oldsize != ip->i_disk_size)) {
   923			error = filemap_write_and_wait_range(VFS_I(ip)->i_mapping,
   924							ip->i_disk_size, newsize - 1);
   925			if (error)
   926				return error;
   927		}
   928	
   ...
   985		}
   986	
   987		ASSERT(!(iattr->ia_valid & (ATTR_UID | ATTR_GID)));
   988		setattr_copy(mnt_userns, inode, iattr);
   989		xfs_trans_log_inode(tp, ip, XFS_ILOG_CORE);
   990	
   991		XFS_STATS_INC(mp, xs_ig_attrchg);
   992	
   993		if (xfs_has_wsync(mp))
