...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 511B9F25B6
	for <lists+linux-xfs@lfdr.de>; Thu,  7 Nov 2019 04:02:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732732AbfKGDC1 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 6 Nov 2019 22:02:27 -0500
Received: from aserp2120.oracle.com ([141.146.126.78]:56478 "EHLO
        aserp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727665AbfKGDC1 (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 6 Nov 2019 22:02:27 -0500
Received: from pps.filterd (aserp2120.oracle.com [127.0.0.1])
        by aserp2120.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xA72xkjJ039500;
        Thu, 7 Nov 2019 03:02:07 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=subject : from : to :
 cc : date : message-id : in-reply-to : references : mime-version :
 content-type : content-transfer-encoding; s=corp-2019-08-05;
 bh=gd8UUhu9TgN+fq3frSpl4gIy+afWe+Hpn8sJJy/OTqc=;
 b= cg== 
Received: from userp3020.oracle.com (userp3020.oracle.com [156.151.31.79])
        by aserp2120.oracle.com with ESMTP id 2w41w0u0e8-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Thu, 07 Nov 2019 03:02:06 +0000
Received: from pps.filterd (userp3020.oracle.com [127.0.0.1])
        by userp3020.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xA72wiwg106531;
        Thu, 7 Nov 2019 03:02:05 GMT
Received: from aserv0122.oracle.com (aserv0122.oracle.com [141.146.126.236])
        by userp3020.oracle.com with ESMTP id 2w41wg12ku-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Thu, 07 Nov 2019 03:02:05 +0000
Received: from abhmp0001.oracle.com (abhmp0001.oracle.com [141.146.116.7])
        by aserv0122.oracle.com (8.14.4/8.14.4) with ESMTP id xA7324QD028784;
        Thu, 7 Nov 2019 03:02:04 GMT
Received: from localhost (/67.169.218.210)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Wed, 06 Nov 2019 19:02:03 -0800
Subject: [PATCH 2/4] xfs: kill the XFS_WANT_CORRUPT_* macros
From:   "Darrick J. Wong" <darrick.wong@oracle.com>
To:     darrick.wong@oracle.com
Cc:     linux-xfs@vger.kernel.org, hch@infradead.org
Date:   Wed, 06 Nov 2019 19:02:01 -0800
Message-ID: <157309572114.45542.3388449920293224134.stgit@magnolia>
...
index f609e1ab14d4..68f9535b076b 100644
...
+	}
 	...
 	/*
@@ -1554,7 +1576,10 @@ xfs_alloc_ag_vextent_near(
 						&i);
 				if (error)
 					goto out;
...
@@ -1679,7 +1704,10 @@ xfs_alloc_ag_vextent_size(
...
+			}
 			...
 			busy = xfs_alloc_compute_aligned(args, fbno, flen,
 					&rbno, &rlen, &busy_gen);
@@ -1713,8 +1741,11 @@ xfs_alloc_ag_vextent_size(
...
@@ -1733,15 +1764,21 @@ xfs_alloc_ag_vextent_size(
...
+			}
 			if (rlen > bestrlen) {
 				bestrlen = rlen;
 				bestrbno = rbno;
@@ -1754,7 +1791,10 @@ xfs_alloc_ag_vextent_size(
...
+		}
 		...
 		rbno = bestrbno;
 		flen = bestflen;
@@ -1777,7 +1817,10 @@ xfs_alloc_ag_vextent_size(
...
+	}
 	 ...
 	 */
@@ -1791,10 +1834,12 @@ xfs_alloc_ag_vextent_size(
...
@@ -1866,7 +1911,10 @@ xfs_free_ag_extent(
 		 */
...
+		}
 		 ...
 		 */
@@ -1878,8 +1926,10 @@ xfs_free_ag_extent(
...
+			}
 	...
 	/*
@@ -1894,7 +1944,10 @@ xfs_free_ag_extent(
 		 */
...
+		}
 		 ...
 		 * It's not contiguous, though.
 		 */
@@ -1906,7 +1959,10 @@ xfs_free_ag_extent(
 			 * space was invalid, it's (partly) already free.
 			 * Very bad.
 			 */
...
+			}
 	...
 	/*
@@ -1923,31 +1979,49 @@ xfs_free_ag_extent(
 		 */
...
@@ -1960,9 +2034,11 @@ xfs_free_ag_extent(
...
+			}
 ...
 #endif
 		/*
@@ -1983,17 +2059,26 @@ xfs_free_ag_extent(
 		 */
 		if ((error = xfs_alloc_lookup_eq(cnt_cur, ltbno, ltlen, &i)))
 			goto error0;
-		XFS_WANT_CORRUPTED_GOTO(mp, i == 1, error0);
...
@@ -2009,10 +2094,16 @@ xfs_free_ag_extent(
 		 */
 		if ((error = xfs_alloc_lookup_eq(cnt_cur, gtbno, gtlen, &i)))
 			goto error0;
-		XFS_WANT_CORRUPTED_GOTO(mp, i == 1, error0);
...
@@ -2031,7 +2122,10 @@ xfs_free_ag_extent(
 		nlen = len;
 		if ((error = xfs_btree_insert(bno_cur, &i)))
 			goto error0;
-		XFS_WANT_CORRUPTED_GOTO(mp, i == 1, error0);
...
+		}
 	...
 	bno_cur = NULL;
@@ -2040,10 +2134,16 @@ xfs_free_ag_extent(
 	 */
...
@@ -3168,12 +3268,17 @@ __xfs_free_extent(
 	if (error)
 		return error;
...
index 7392ca92ab34..d08bdb066555 100644
...
@@ -4985,7 +5125,10 @@ xfs_bmap_del_extent_real(
...
@@ -5009,7 +5152,10 @@ xfs_bmap_del_extent_real(
 		}
 		if ((error = xfs_btree_delete(cur, &i)))
 			goto done;
-		XFS_WANT_CORRUPTED_GOTO(mp, i == 1, done);
...
+		}
 	...
 	case BMAP_LEFT_FILLING:
 		/*
@@ -5080,7 +5226,10 @@ xfs_bmap_del_extent_real(
 				error = xfs_bmbt_lookup_eq(cur, &got, &i);
 				if (error)
 					goto done;
-				XFS_WANT_CORRUPTED_GOTO(mp, i == 1, done);
...
@@ -5097,7 +5246,10 @@ xfs_bmap_del_extent_real(
 				error = -ENOSPC;
 				goto done;
 			}
-			XFS_WANT_CORRUPTED_GOTO(mp, i == 1, done);
...
@@ -5582,18 +5734,21 @@ xfs_bmse_merge(
 	error = xfs_bmbt_lookup_eq(cur, got, &i);
 	if (error)
 		return error;
-	XFS_WANT_CORRUPTED_RETURN(mp, i == 1);
...
+		return -EFSCORRUPTED;
 	...
 	if (error)
@@ -5641,7 +5796,8 @@ xfs_bmap_shift_update_extent(
 		error = xfs_bmbt_lookup_eq(cur, &prev, &i);
 		if (error)
 			return error;
-		XFS_WANT_CORRUPTED_RETURN(mp, i == 1);
...
+			return -EFSCORRUPTED;
 		...
 		if (error)
@@ -5705,8 +5861,10 @@ xfs_bmap_collapse_extents(
 		*done = true;
 		goto del_cursor;
 	}
...
@@ -5832,8 +5990,10 @@ xfs_bmap_insert_extents(
 			goto del_cursor;
 		}
 	}
-	XFS_WANT_CORRUPTED_GOTO(mp, !isnullstartblock(got.br_startblock),
...
+	}
 	...
 	if (stop_fsb >= got.br_startoff + got.br_blockcount) {
 		ASSERT(0);
@@ -5941,7 +6101,10 @@ xfs_bmap_split_extent_at(
 		error = xfs_bmbt_lookup_eq(cur, &got, &i);
 		if (error)
 			goto del_cursor;
...
@@ -5966,11 +6129,17 @@ xfs_bmap_split_extent_at(
 		error = xfs_bmbt_lookup_eq(cur, &new, &i);
 		if (error)
 			goto del_cursor;
...
index 098abfb50252..b236a1bcd03b 100644
--- a/fs/xfs/libxfs/xfs_btree.c
+++ b/fs/xfs/libxfs/xfs_btree.c
@@ -1995,7 +1995,8 @@ xfs_btree_lookup(
...
@@ -2450,7 +2451,10 @@ xfs_btree_lshift(
 		if (error)
 			goto error0;
...
+		}
 		...
 		if (error)
@@ -2617,7 +2621,10 @@ xfs_btree_rshift(
 	if (error)
 		goto error0;
...
+	}
 	...
 	if (error)
@@ -3471,7 +3478,10 @@ xfs_btree_insert(
 			goto error0;
 		}
...
+		}
 		...
 		/*
@@ -3875,15 +3885,24 @@ xfs_btree_delrec(
...
@@ -3927,12 +3946,18 @@ xfs_btree_delrec(
...
@@ -3946,13 +3971,19 @@ xfs_btree_delrec(
 		 * previous block.
 		 */
 		i = xfs_btree_firstrec(tcur, level);
-		XFS_WANT_CORRUPTED_GOTO(cur->bc_mp, i == 1, error0);
