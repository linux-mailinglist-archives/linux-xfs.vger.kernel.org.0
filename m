...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A134E42B043
	for <lists+linux-xfs@lfdr.de>; Wed, 13 Oct 2021 01:34:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235893AbhJLXgO (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Tue, 12 Oct 2021 19:36:14 -0400
Received: from mail.kernel.org ([198.145.29.99]:48588 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235950AbhJLXgN (ORCPT <rfc822;linux-xfs@vger.kernel.org>);
        Tue, 12 Oct 2021 19:36:13 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 7053F60EBB;
        Tue, 12 Oct 2021 23:34:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1634081651;
        bh=HWBbYleB0UPwgvbA0IcC9HhDs4Suu4jvNdSzc9bLAws=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Subject: [PATCH 2/2] xfs: rename _zone variables to _cache
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org, david@fromorbit.com
Cc:     linux-xfs@vger.kernel.org
Date:   Tue, 12 Oct 2021 16:34:11 -0700
Message-ID: <163408165114.4151624.13496624863133229226.stgit@magnolia>
...
index 115060d22887..29aa979ab734 100644
...
index da31ac85b709..729b8f3bb95a 100644
...
index 399d7cfc7d4b..b786c050c04b 100644
--- a/fs/xfs/xfs_super.c
+++ b/fs/xfs/xfs_super.c
@@ -1992,196 +1992,196 @@ xfs_destroy_btree_cur_caches(void)
 }
...
+	kmem_cache_destroy(xfs_log_ticket_cache);
 ...
 STATIC int __init
@@ -2274,13 +2274,13 @@ init_xfs_fs(void)
 	if (error)
 		goto out;
...
+		goto out_destroy_caches;
 	...
 	if (error)
@@ -2355,8 +2355,8 @@ init_xfs_fs(void)
...
+	xfs_destroy_caches();
  ...
  out:
@@ -2379,7 +2379,7 @@ exit_xfs_fs(void)
 	xfs_buf_terminate();
 	xfs_mru_cache_uninit();
 	xfs_destroy_workqueues();
-	xfs_destroy_zones();
