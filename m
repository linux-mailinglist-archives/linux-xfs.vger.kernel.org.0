Return-Path: <linux-xfs+bounces-60-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 61EEE7F8703
	for <lists+linux-xfs@lfdr.de>; Sat, 25 Nov 2023 00:53:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 107AC282357
	for <lists+linux-xfs@lfdr.de>; Fri, 24 Nov 2023 23:53:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6D3EE3DB8B;
	Fri, 24 Nov 2023 23:53:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="eokPiJ1o"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2CED23DB84
	for <linux-xfs@vger.kernel.org>; Fri, 24 Nov 2023 23:53:26 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id E3B61C433C8;
	Fri, 24 Nov 2023 23:53:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1700870006;
	bh=493i+I7OVrDn+5FAUMasTRamw2eP+v4Q1/tE+bbeaqg=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Fri, 24 Nov 2023 15:53:25 -0800
Subject: [PATCH 2/5] xfs: repair inode fork block mapping data structures
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: linux-xfs@vger.kernel.org
Message-ID: <170086927942.2771366.11233494127863883983.stgit@frogsfrogsfrogs>
...
---
 ...
 17 files changed, 1172 insertions(+), 34 deletions(-)
...
index 8360256cff168..626486f632e2c 100644
...
+	cur->bc_ino.forksize = xfs_inode_fork_size(ip, whichfork);
 	...
 	return cur;
@@ -587,6 +598,74 @@ xfs_bmbt_block_maxrecs(
...
index c12ccc9141163..737ab982a2d7a 100644
...
index 0000000000000..2c593eebb1fc4
--- /dev/null
...
index 506b808b9fbb3..1033d8172be62 100644
--- a/fs/xfs/scrub/common.h
+++ b/fs/xfs/scrub/common.h
@@ -233,7 +233,11 @@ int xchk_metadata_inode_forks(struct xfs_scrub *sc);
 			(sc)->mp->m_super->s_id, \
...
index 82c9760776248..4d5bfb2e4cf08 100644
...
index 46bf841524f8f..9f0c77b38ae28 100644
...
index b9edda17ab64b..52a09e0652693 100644
--- a/fs/xfs/scrub/scrub.c
+++ b/fs/xfs/scrub/scrub.c
@@ -290,13 +290,13 @@ static const struct xchk_meta_ops meta_scrub_ops[] = {
 		.type	= ST_INODE,
...
index 6cd5d04c0410c..3d55f65c00835 100644
...
index 305c9d07bf1b2..11e3d50078be9 100644
--- a/fs/xfs/xfs_trans.c
+++ b/fs/xfs/xfs_trans.c
@@ -132,6 +132,62 @@ xfs_trans_dup(
 	return ntp;
 }
...
@@ -1236,6 +1292,45 @@ xfs_trans_alloc_inode(
 	return error;
 }
