...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B6D08228441
	for <lists+linux-xfs@lfdr.de>; Tue, 21 Jul 2020 17:53:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726919AbgGUPx7 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Tue, 21 Jul 2020 11:53:59 -0400
Received: from userp2130.oracle.com ([156.151.31.86]:49266 "EHLO
        userp2130.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726029AbgGUPx5 (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Tue, 21 Jul 2020 11:53:57 -0400
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
        by userp2130.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 06LFgT9H082406;
        Tue, 21 Jul 2020 15:53:21 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=date : from : to : cc
 : subject : message-id : references : mime-version : content-type :
 in-reply-to; s=corp-2020-01-29;
 bh=SAcZUt6h7KCvFsJBBlNdGn+9l5D9hmuKqbi/vvp8f9c=;
 b= 4A== 
Received: from aserp3020.oracle.com (aserp3020.oracle.com [141.146.126.70])
        by userp2130.oracle.com with ESMTP id 32brgre4a5-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL);
        Tue, 21 Jul 2020 15:53:20 +0000
Received: from pps.filterd (aserp3020.oracle.com [127.0.0.1])
        by aserp3020.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 06LFhxqH060652;
        Tue, 21 Jul 2020 15:51:19 GMT
Received: from aserv0122.oracle.com (aserv0122.oracle.com [141.146.126.236])
        by aserp3020.oracle.com with ESMTP id 32e33gh0x0-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 21 Jul 2020 15:51:18 +0000
Received: from abhmp0007.oracle.com (abhmp0007.oracle.com [141.146.116.13])
        by aserv0122.oracle.com (8.14.4/8.14.4) with ESMTP id 06LFpHd2027181;
        Tue, 21 Jul 2020 15:51:17 GMT
Received: from localhost (/67.169.218.210)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Tue, 21 Jul 2020 08:51:16 -0700
Date:   Tue, 21 Jul 2020 08:51:15 -0700
From:   "Darrick J. Wong" <darrick.wong@oracle.com>
To:     Christoph Hellwig <hch@lst.de>
Cc:     linux-xfs@vger.kernel.org
Subject: Re: [PATCH] xfsprogs: remove the libxfs_* API redirections
Message-ID: <20200721155115.GA3151642@magnolia>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 phishscore=0 suspectscore=7
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 malwarescore=0 bulkscore=0 spamscore=0
 impostorscore=0 suspectscore=7 adultscore=0 clxscore=1015 mlxlogscore=999
...
On Fri, Jul 10, 2020 at 06:02:59PM +0200, Christoph Hellwig wrote:
...
>  60 files changed, 846 insertions(+), 1076 deletions(-)
>  delete mode 100644 libxfs/libxfs_api_defs.h

Hee hee, treewide changes...

Reviewed-by: Darrick J. Wong <darrick.wong@oracle.com>

Insofar as I really only doomscrolled the entire patch and didn't see
anything at all^W^Wobviously wrong.
...
> index 12c03b6d..bc3c3e2a 100644
> --- a/db/check.c
> +++ b/db/check.c
...
> index 2e6cd280..3a6e539f 100644
> --- a/mkfs/xfs_mkfs.c
> +++ b/mkfs/xfs_mkfs.c
...
> index c25fccca..01f5565f 100755
