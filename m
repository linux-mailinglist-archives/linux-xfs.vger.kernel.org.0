...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1A4E064FDA0
	for <lists+linux-xfs@lfdr.de>; Sun, 18 Dec 2022 05:48:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230080AbiLREsS (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Sat, 17 Dec 2022 23:48:18 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48902 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229537AbiLREsP (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Sat, 17 Dec 2022 23:48:15 -0500
Received: from mx0b-0016e101.pphosted.com (mx0b-0016e101.pphosted.com [148.163.141.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 54072DFA9
        for <linux-xfs@vger.kernel.org>; Sat, 17 Dec 2022 20:48:13 -0800 (PST)
Received: from pps.filterd (m0151357.ppops.net [127.0.0.1])
        by mx0b-0016e101.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 2BI45g50002760
        for <linux-xfs@vger.kernel.org>; Sat, 17 Dec 2022 20:48:12 -0800
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ucsd.edu; h=mime-version :
 ...
 bh=4B6334Ax8ceG9wJl9OuY3kAb4Q2h3XqoN859p6UPX0M=;
 b= SA== 
Received: from mail-qk1-f197.google.com (mail-qk1-f197.google.com [209.85.222.197])
        by mx0b-0016e101.pphosted.com (PPS) with ESMTPS id 3mhdc350ru-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT)
        for <linux-xfs@vger.kernel.org>; Sat, 17 Dec 2022 20:48:12 -0800
Received: by mail-qk1-f197.google.com with SMTP id bk24-20020a05620a1a1800b006ffcdd05756so4937192qkb.22
        for <linux-xfs@vger.kernel.org>; Sat, 17 Dec 2022 20:48:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         ...
         :message-id:reply-to;
        bh=4B6334Ax8ceG9wJl9OuY3kAb4Q2h3XqoN859p6UPX0M=;
        b=PB+WDR3GJ5Q+qQpYay9kFhkHEwqCmt7iN/ciFxWsmulTGRHVjudAHCymr+CGbs5Wfw
         njPCQlsVGvczLcUEpWTRReb4NZsWBRrv/oCl7uQiPBTjDP798Jiu05ojhc+u5mdaPJgU
         gDAHqnAHANkNG8knvM13/b0WgVd6ZsAxPOaTg=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=4B6334Ax8ceG9wJl9OuY3kAb4Q2h3XqoN859p6UPX0M=;
        b=
X-Gm-Message-State: ANoB5plD6yg/g7ALwRCP/gHcTVz/dk5X/hIez/4JvdnszrRxL53M2OQ3
        mm6H1W7bZVNyzLYQpkXmoxhzV8TSAO2QOEM3RV7KhCAfFEvgnDsNgAGnvQ7w1J3Ldm+ceQU1h/0
        TGJEqfVP7/LoqfHyidHx3sdtj6vWDJh6m69k=
X-Received: by 2002:a0c:cd81:0:b0:4c7:9363:a120 with SMTP id v1-20020a0ccd81000000b004c79363a120mr539997qvm.35.1671338891309;
        Sat, 17 Dec 2022 20:48:11 -0800 (PST)
X-Google-Smtp-Source: AMrXdXs+mdqQAn3wUe6Js4memCRQ4p8ylkMVSoinV75dmAxLX/Dzcg0V6X7g3JbKAS5DG09cvS1fNo/ZBSKmAQ39Gr4=
X-Received: by 2002:a0c:cd81:0:b0:4c7:9363:a120 with SMTP id
 v1-20020a0ccd81000000b004c79363a120mr539991qvm.35.1671338890826; Sat, 17 Dec
 2022 20:48:10 -0800 (PST)
MIME-Version: 1.0
...
Date:   Sat, 17 Dec 2022 20:47:45 -0800
Message-ID: <CACQnzjtPXY=8nj0H+x+qdR7B=f+m4xgvFzc2LST+=KcMQkL9bg@mail.gmail.com>
...
X-Proofpoint-ORIG-GUID: ve0fgo97gDy0hVwdCrrydTtC1xp8KPux
X-Proofpoint-GUID: ve0fgo97gDy0hVwdCrrydTtC1xp8KPux
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 impostorscore=0
 ...
 spamscore=0 priorityscore=1501 phishscore=0 clxscore=1015 mlxlogscore=907
 bulkscore=0 classifier=spam adjust=0 reason=mlx scancount=1
 engine=8.12.0-2212070000 definitions=main-2212180044
...
Le sam. 17 d=C3=A9c. 2022 =C3=A0 17:46, Dave Chinner <david@fromorbit.com> =
a =C3=A9crit :
>
...
> >
> > > > Regardless of the block device (the plot includes results for optan=
e
> > > > and RamFS), it seems like the ioctl(FICLONE) call is slow.
> > >
> > > Please define "slow" - is it actually slower than it should be (i.e. =
a
> > > bug) or does it simply not perform according to your expectations?
> >
> > I was surprised that on a DRAM-backed file system the ioctl(FICLONE) to=
ok
> > *milli*seconds right from the start, and grew to *tens* of milliseconds=
.
> > There's no slow block storage device to increase latency; all of the la=
tency
...
> > a huge number of applications --- can make clones of said files and rec=
over
...
>
> > In many
> > situations this is much easier and better than shoe-horning application=
 data
...
>
> > Cloning for crash
> > tolerance usually requires durable media beneath the file system (HDD o=
r
> > SSD, not DRAM), so performance on block storage devices matters too.  W=
e
> > measured performance of cloning atop DRAM to understand how much latenc=
y is
...
> > related mechanisms in the HP Advanced File System (AdvFS), a Linux port=
 of
> > the DEC Tru64 file system, taught me to expect cloning to be *faster* t=
han
...
>
>
> > https://urldefense.com/v3/__https://www.usenix.org/system/files/confere=
nce/fast15/fast15-paper-verma.pdf__;!!Mih3wA!AwAzZFK3qihFyPfIfwMf5quwRDqABL=
90i9zLcTfSWLBfwrxWyzUNT1Hj49btqv4v1RtiOx_IkjbSIg$
>
...
> recovery on next acces, add in-memory tracking of ephemeral shared extent=
s to trigger
...
>
> > The point I'm trying to make is:  I'm a serious customer who loves clon=
ing
> > and my performance expectations aren't based on idle speculation but on
> > experience with other cloning implementations.  (AdvFS is not open sour=
ce
> > and I'm no longer an HP employee, so I no longer have access to it.)
> >
> > More recently I torture-tested XFS cloning as a crash-tolerance mechani=
sm by
> > subjecting it to real whole-system power interruptions:
> >
> > https://urldefense.com/v3/__https://dl.acm.org/doi/pdf/10.1145/3400899.=
3400902__;!!Mih3wA!AwAzZFK3qihFyPfIfwMf5quwRDqABL90i9zLcTfSWLBfwrxWyzUNT1Hj=
49btqv4v1RtiOx_th521GQ$
>
...
down
> > to storage.  I would have expected that the implementation of cloning w=
ould
> > always operate upon memory alone, and that an explicit fsync() would be
> > required to force data down to durable media.  Analogy:  write() doesn'=
t
> > modify storage; write() plus fsync() does.  Is there a reason why copyi=
ng
...
> > However the constant factors surprise me.  If memory serves we were see=
ing
> > latencies of milliseconds atop DRAM for the first few clones on files t=
hat
> > began as sparse files and had only a few blocks written to them.  Copyi=
ng
