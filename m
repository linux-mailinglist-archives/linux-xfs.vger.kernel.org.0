Return-Path: <linux-xfs+bounces-13977-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 38CFB99994A
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 03:28:20 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 76AC31F23854
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 01:28:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D5818DF59;
	Fri, 11 Oct 2024 01:28:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="Y8RADrez"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 93442DDA9
	for <linux-xfs@vger.kernel.org>; Fri, 11 Oct 2024 01:28:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1728610093; cv=none; b=QCCvGAMaY0IqcK84BOVoZJbG7sCl7QVo/J5Agx8plmPYrW1Slp73V8GaZsUtgIK5i1G+g/rVhNaTPuBGOCGf6f4ZW5NaqHqFOYkyDnoKPMykF7tURwpULbnHQ2HT1KtUKpdIil0OpBjgsGckFsc4o2tSG38rGiSC75KvYd3q9Wk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1728610093; c=relaxed/simple;
	bh=RUXhnY+xe1JvJbZpf4+f5d578mf+00yDWus/hWIYNgA=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=KixuUU8yaG3qZVHHxUWhy+Yes/Vy9/NfYgHJwS+b4bp3l90yEquVZFWMjL8bcJJlUIOBHtLdN9MFxautqKAKHvNXd8X/fwKgEfxTk74vK+hBlRuvEUogqST7w/fy5gC6v8B0LuiyI23XDdLVRHXe49L91l0fbGQe/XnWS6B2oS8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=Y8RADrez; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 66F9DC4CEC5;
	Fri, 11 Oct 2024 01:28:13 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1728610093;
	bh=RUXhnY+xe1JvJbZpf4+f5d578mf+00yDWus/hWIYNgA=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Thu, 10 Oct 2024 18:28:12 -0700
Subject: [PATCH 14/43] xfs_repair: support realtime groups
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org, aalbersh@kernel.org
Cc: hch@lst.de, linux-xfs@vger.kernel.org
Message-ID: <172860655581.4184637.7163145648617110310.stgit@frogsfrogsfrogs>
...
index 4b30ef504c869b..0675324cfaf6d2 100644
...
index daadacd1c43634..da712eb6fef4d9 100644
--- a/repair/agheader.c
+++ b/repair/agheader.c
@@ -358,7 +358,7 @@ secondary_sb_whack(
...
index 7c613ed8d8668b..4dbe0305c9e88e 100644
--- a/repair/dinode.c
+++ b/repair/dinode.c
@@ -21,6 +21,7 @@
 #include "slab.h"
...
index 99019e94bab285..5dffa8edc87684 100644
--- a/repair/phase6.c
+++ b/repair/phase6.c
...
+	}
 	...
 	if (!fs_quotas)
 		return;
@@ -3245,6 +3368,49 @@ _("        - resetting contents of realtime bitmap and summary inodes\n"));
...
+
 ...
 {
@@ -3293,7 +3459,10 @@ phase6(xfs_mount_t *mp)
...
index 1d35218fac00d2..05fd886f37ba6a 100644
--- a/repair/sb.c
+++ b/repair/sb.c
...
@@ -485,6 +517,10 @@ verify_sb(char *sb_buf, xfs_sb_t *sb, int is_primary_sb)
 	if (xfs_sb_version_hasmetadir(sb)) {
