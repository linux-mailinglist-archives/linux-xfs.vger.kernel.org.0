Return-Path: <linux-xfs+bounces-4527-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 850F686E246
	for <lists+linux-xfs@lfdr.de>; Fri,  1 Mar 2024 14:36:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 23C6528710F
	for <lists+linux-xfs@lfdr.de>; Fri,  1 Mar 2024 13:36:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3A96C6EB69;
	Fri,  1 Mar 2024 13:31:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="aqJVKhnw"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E63A96E2B8;
	Fri,  1 Mar 2024 13:31:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709299884; cv=none; b=f4MnXJkwwQ8IvW4oywGcxxbrZEpqvTf9mKXMrSWk3JlZI+H2fg3X81qXloAhOIk4Vcrmbg28FuXyeK/0hkDrAY3fpS0YbB6Mi/77tKOCwYqPZUUAIU5h5X5FR6Oy9oO5yYLB3jug9HIT3rNZW7OkYcaG/IQV9W8+Be/GaBYjgNE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709299884; c=relaxed/simple;
	bh=Xz2iNoZfrukt1Sypye/Uud56Q9eOM/bBU8PGM3eXvTQ=;
	h=Message-ID:Subject:From:To:Cc:Date:In-Reply-To:References:
	 Content-Type:MIME-Version; b=HzWz0OwG5O/shsE08o1J1IZE26s1stYrK9DtQlhI9XN3kvrh7ArYoiOkCNpELLC27jN0cx6hyVxpLKfV8G9NYKaGTtoROIqfkTAnDSgExPTDx7bupGYkXbFYrlwpmYv3Q/RkbmLjDdXFo0aPJZzb3NeFWbJZFbMNF9u7hdHBPG0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=aqJVKhnw; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 00821C433C7;
	Fri,  1 Mar 2024 13:31:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1709299883;
	bh=Xz2iNoZfrukt1Sypye/Uud56Q9eOM/bBU8PGM3eXvTQ=;
	h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
	b=
Message-ID: <bf2f4a0e7033091d34139540737674dc998fe010.camel@kernel.org>
Subject: Re: [PATCH 14/13] xfs: make XFS_IOC_COMMIT_RANGE freshness data
 opaque
From: Jeff Layton <jlayton@kernel.org>
To: "Darrick J. Wong" <djwong@kernel.org>, Amir Goldstein
 <amir73il@gmail.com>
Cc: linux-fsdevel@vger.kernel.org, linux-xfs@vger.kernel.org, hch@lst.de
Date: Fri, 01 Mar 2024 08:31:21 -0500
