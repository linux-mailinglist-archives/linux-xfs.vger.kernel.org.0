...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CD59B1C0A99
	for <lists+linux-xfs@lfdr.de>; Fri,  1 May 2020 00:47:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727838AbgD3WrS (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 30 Apr 2020 18:47:18 -0400
Received: from userp2130.oracle.com ([156.151.31.86]:58884 "EHLO
        userp2130.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727818AbgD3WrN (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 30 Apr 2020 18:47:13 -0400
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
        by userp2130.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 03UMhKX9063547
        for <linux-xfs@vger.kernel.org>; Thu, 30 Apr 2020 22:47:11 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : subject :
 date : message-id : in-reply-to : references; s=corp-2020-01-29;
 bh=wltmcqTBEqgmouGbSXm7LPDVjRzB96KSB7tyjl19Kjw=;
 b= Qw== 
Received: from userp3030.oracle.com (userp3030.oracle.com [156.151.31.80])
        by userp2130.oracle.com with ESMTP id 30r7f80285-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-xfs@vger.kernel.org>; Thu, 30 Apr 2020 22:47:11 +0000
Received: from pps.filterd (userp3030.oracle.com [127.0.0.1])
        by userp3030.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 03UMhRKf181405
        for <linux-xfs@vger.kernel.org>; Thu, 30 Apr 2020 22:47:11 GMT
Received: from userv0121.oracle.com (userv0121.oracle.com [156.151.31.72])
        by userp3030.oracle.com with ESMTP id 30r7fes2cu-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-xfs@vger.kernel.org>; Thu, 30 Apr 2020 22:47:11 +0000
Received: from abhmp0018.oracle.com (abhmp0018.oracle.com [141.146.116.24])
        by userv0121.oracle.com (8.14.4/8.13.8) with ESMTP id 03UMlALu012301
...
Subject: [PATCH v9 20/43] xfsprogs: Add xfs_has_attr and subroutines
Date:   Thu, 30 Apr 2020 15:46:37 -0700
Message-Id: <20200430224700.4183-21-allison.henderson@oracle.com>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 spamscore=0 adultscore=0 bulkscore=0
 mlxlogscore=999 phishscore=0 suspectscore=4 malwarescore=0 mlxscore=0
...
@@ -704,21 +750,56 @@ xfs_attr_leaf_get(xfs_da_args_t *args)
...
+
  ...
  *========================================================================*/
@@ -751,17 +832,14 @@ xfs_attr_node_addname(
 	dp = args->dp;
 	mp = dp->i_mount;
 restart:
-	state = xfs_da_state_alloc();
...
+
 	...
 	if (retval == -ENOATTR && (args->attr_flags & XATTR_REPLACE))
@@ -966,29 +1044,15 @@ xfs_attr_node_removename(
 {
 	struct xfs_da_state	*state;
...
@@ -1083,7 +1147,8 @@ xfs_attr_node_removename(
 	error = 0;
...
@@ -1203,31 +1268,23 @@ xfs_attr_node_get(xfs_da_args_t *args)
 {
