...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 212113C7DD4
	for <lists+linux-xfs@lfdr.de>; Wed, 14 Jul 2021 07:06:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237802AbhGNFI7 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 14 Jul 2021 01:08:59 -0400
Received: from mail106.syd.optusnet.com.au ([211.29.132.42]:40198 "EHLO
        mail106.syd.optusnet.com.au" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S237892AbhGNFI7 (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 14 Jul 2021 01:08:59 -0400
Received: from dread.disaster.area (pa49-181-34-10.pa.nsw.optusnet.com.au [49.181.34.10])
        by mail106.syd.optusnet.com.au (Postfix) with ESMTPS id B176A80C0EA
...
Subject: [PATCH 1/3] xfs: AIL needs asynchronous CIL forcing
Date:   Wed, 14 Jul 2021 15:05:58 +1000
Message-Id: <20210714050600.2632218-2-david@fromorbit.com>
...
X-Optus-CM-Analysis: v=2.3 cv=Tu+Yewfh c=1 sm=1 tr=0
        ...
        a=e_q4qTt1xDgA:10 a=20KFwNOVAAAA:8 a=VwQbUJbxAAAA:8 a=yPCof4ZbAAAA:8
        a=frthO3jOuRkPAE1aD6kA:9 a=AjGcO6oz07-iQ99wixmX:22
Precedence: bulk
...
index 98d8fea6a83b..5e6c94ddd15d 100644
--- a/fs/xfs/xfs_log.c
+++ b/fs/xfs/xfs_log.c
...
-STATIC void
 xlog_grant_push_ail(
 	struct xlog		*log,
 	int			need_bytes);
@@ -3100,7 +3095,7 @@ xfs_log_ticket_ungrant(
...
index 3f680f0c9744..526df0ae4cc2 100644
--- a/fs/xfs/xfs_log.h
+++ b/fs/xfs/xfs_log.h
...
index 5ef47aed10f9..f45cf3d669bd 100644
--- a/fs/xfs/xfs_log_cil.c
+++ b/fs/xfs/xfs_log_cil.c
@@ -831,6 +831,7 @@ xlog_cil_push_work(
 	xfs_lsn_t		push_seq;
 	struct bio		bio;
...
@@ -841,6 +842,8 @@ xlog_cil_push_work(
...
@@ -1049,8 +1052,16 @@ xlog_cil_push_work(
...
@@ -1144,13 +1155,26 @@ xlog_cil_push_background(
 /*
...
@@ -1160,7 +1184,8 @@ xlog_cil_push_now(
...
@@ -1173,6 +1198,7 @@ xlog_cil_push_now(
 	}
...
@@ -1257,12 +1283,27 @@ xlog_cil_commit(
...
@@ -1278,13 +1319,17 @@ xlog_cil_force_seq(
...
@@ -1308,6 +1353,7 @@ xlog_cil_force_seq(
...
index 400471fa12d2..0a62d6780069 100644
--- a/fs/xfs/xfs_log_priv.h
+++ b/fs/xfs/xfs_log_priv.h
@@ -269,6 +269,7 @@ struct xfs_cil {
...
@@ -509,6 +510,8 @@ int	xlog_write(struct xlog *log, struct xfs_cil_ctx *ctx,
...
+		int eventual_size);
 ...
 /*
@@ -582,6 +585,7 @@ void	xlog_cil_set_ctx_write_state(struct xfs_cil_ctx *ctx,
 /*
  * CIL force routines
  */
...
index e26ade9fc630..a0dcc049f2a6 100644
