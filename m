...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 28AD146727F
	for <lists+linux-xfs@lfdr.de>; Fri,  3 Dec 2021 08:20:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1378843AbhLCHX1 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 3 Dec 2021 02:23:27 -0500
Received: from mga14.intel.com ([192.55.52.115]:31956 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1378847AbhLCHX0 (ORCPT <rfc822;linux-xfs@vger.kernel.org>);
        Fri, 3 Dec 2021 02:23:26 -0500
X-IronPort-AV: E=McAfee;i="6200,9189,10186"; a="237153796"
X-IronPort-AV: E=Sophos;i="5.87,283,1631602800"; 
   d="scan'208";a="237153796"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Dec 2021 23:20:02 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.87,283,1631602800"; 
   d="scan'208";a="610296823"
Received: from lkp-server02.sh.intel.com (HELO 9e1e9f9b3bcb) ([10.239.97.151])
  by orsmga004.jf.intel.com with ESMTP; 02 Dec 2021 23:20:00 -0800
Received: from kbuild by 9e1e9f9b3bcb with local (Exim 4.92)
        (envelope-from <lkp@intel.com>)
        id 1mt2rP-000HDM-IT; Fri, 03 Dec 2021 07:19:59 +0000
Date:   Fri, 3 Dec 2021 15:19:53 +0800
From:   kernel test robot <lkp@intel.com>
To:     Dave Chinner <david@fromorbit.com>, linux-xfs@vger.kernel.org
Cc:     llvm@lists.linux.dev, kbuild-all@lists.01.org
Subject: Re: [PATCH 05/36] xfs: pass perag to xfs_alloc_read_agf()
Message-ID: <202112031527.dpUjvB8h-lkp@intel.com>
...
config: hexagon-randconfig-r036-20211203 (https://download.01.org/0day-ci/archive/20211203/202112031527.dpUjvB8h-lkp@intel.com/config)
...
>> fs/xfs/xfs_reflink.c:129:1: warning: no previous prototype for function 'xfs_reflink_find_shared' [-Wmissing-prototypes]
   ...
   ^
   static 
   fs/xfs/xfs_reflink.c:996:12: warning: variable 'qdelta' set but not used [-Wunused-but-set-variable]
           int64_t                 qdelta = 0;
                                   ^
