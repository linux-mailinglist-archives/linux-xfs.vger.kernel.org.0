Return-Path: <linux-xfs+bounces-13832-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 7EE7E999857
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 02:50:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A164B1C21B65
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 00:50:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DB5E78BEA;
	Fri, 11 Oct 2024 00:50:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="CNUmMDNH"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9982F8BE5
	for <linux-xfs@vger.kernel.org>; Fri, 11 Oct 2024 00:50:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1728607829; cv=none; b=BNOfi3U8La068l51zcMfLSB8BXz0CJz34HMqfSASuKt0SmhAssf4UmSCm3T353YlSc1LA7x9pusmDtrZJyc9szYJ8LpySg4tsg77RUGnwjP5e6J3GA6ksyFTOpe4sAcmscHm1IOpwhkqY/V5I28rv4vjOI2U4gKw47uYf5tiPMg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1728607829; c=relaxed/simple;
	bh=3nFXLplx94o05zxItzueTCQXBSkrWzu7gP1w90W2EkQ=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=sWlKipZSLHW73g8zYmhnFkExVTMHnGfUx0cQKOnbmeo83HN+8e6eOH2q/v5aRPAoJrBnZAkYkAh2CVSXXnw5/DQsho+v1ewQpdYMr9oOXE2ChwaWD5GHFnP5cKm1x0CJbznl22k+2oBazh0QJzaCccI2LbVN9rSq8OWFdLx0AGA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=CNUmMDNH; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 1D7ACC4CEC5;
	Fri, 11 Oct 2024 00:50:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1728607829;
	bh=3nFXLplx94o05zxItzueTCQXBSkrWzu7gP1w90W2EkQ=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Thu, 10 Oct 2024 17:50:28 -0700
Subject: [PATCH 08/28] xfs: read and write metadata inode directory tree
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: linux-xfs@vger.kernel.org, hch@lst.de
Message-ID: <172860642153.4176876.12287092924780866159.stgit@frogsfrogsfrogs>
...
index 1709abafe6000e..165ae3b0827b3f 100644
--- a/fs/xfs/xfs_icache.c
+++ b/fs/xfs/xfs_icache.c
@@ -849,7 +849,7 @@ xfs_trans_metafile_iget(
 	int			error;
...
index a1a63c47eb6af2..061a3c43cd1d36 100644
...
index fd71f932f89932..552e5a4a60382a 100644
...
+struct xfs_metadir_update;
 ...
 #define XFS_ATTR_FILTER_FLAGS \
 	{ XFS_ATTR_ROOT,	"ROOT" }, \
@@ -5357,6 +5358,107 @@ DEFINE_EVENT(xfs_getparents_class, name, \
