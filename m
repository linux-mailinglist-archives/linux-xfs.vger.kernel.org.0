...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6DFF812A6AF
	for <lists+linux-xfs@lfdr.de>; Wed, 25 Dec 2019 09:18:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726435AbfLYIRV (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 25 Dec 2019 03:17:21 -0500
Received: from esa3.hgst.iphmx.com ([216.71.153.141]:57094 "EHLO
        esa3.hgst.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726395AbfLYIRV (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 25 Dec 2019 03:17:21 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=wdc.com; i=@wdc.com; q=dns/txt; s=dkim.wdc.com;
  t=1577261840; x=1608797840;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=FSZSoYewaW7SHW0OK7x64xfQgR/nDhhZxT7/9E6RFr4=;
  b=qY7Sayn+8ZnKihczYandJFTrd3mjKJNneLPUWE2ti5rwXVQ/oN9NJ/hl
   QU5zez7IezkGboSdShI2OnF8Kc3Kuf1BI4NVZcs6D1qKZlvmlfGF9/l2W
   rcRlZm+tRowyxQ3cLr51J06nvCOsAO0ULnXkmYmFX3szt0u2UkW+eVGuU
   bMMUvjTkW0eIpeYXoo6RGfk1bN9hRM8gL0rHrviIbVJTxexEtnXz0RykO
   O1w8tP7mujM8rafsx6ZxVcwIjwmZBqy1j7idPFZk0MeoF7qlswq4+5HBB
   7FvfaM/yG3zl07fTGWgJ4LS7EeCmShGBKAQ+5/0sDQ8aYwu+60kxPCspk
   w==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.69,353,1571673600"; 
   d="scan'208";a="130541477"
Received: from uls-op-cesaip01.wdc.com (HELO uls-op-cesaep01.wdc.com) ([199.255.45.14])
  by ob1.hgst.iphmx.com with ESMTP; 25 Dec 2019 16:17:20 +0800
IronPort-SDR: 
 UUiOXZKAt37foASkNVBr5maL
Received: from uls-op-cesaip02.wdc.com ([10.248.3.37])
  by uls-op-cesaep01.wdc.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Dec 2019 00:11:32 -0800
IronPort-SDR: 
WDCIronportException: Internal
Received: from washi.fujisawa.hgst.com ([10.149.53.254])
  by uls-op-cesaip02.wdc.com with ESMTP; 25 Dec 2019 00:17:17 -0800
...
Subject: [PATCH v4 1/2] fs: New zonefs file system
Date:   Wed, 25 Dec 2019 17:17:15 +0900
Message-Id: <20191225081716.327348-2-damien.lemoal@wdc.com>
...
new file mode 100644
index 000000000000..7749917baf1d
--- /dev/null
+++ b/fs/zonefs/super.c
@@ -0,0 +1,1165 @@
+// SPDX-License-Identifier: GPL-2.0
...
+{
+	inode_init_owner(inode, parent, S_IFDIR | S_IRUGO | S_IXUGO);
...
+	sbi->s_perm = S_IRUSR | S_IWUSR | S_IRGRP;
+
