Return-Path: <linux-xfs+bounces-14006-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 18AC1999987
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 03:36:07 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 93D9F1F22C50
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 01:36:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E0B9DFBF0;
	Fri, 11 Oct 2024 01:35:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="FJ9kGwIe"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A0802EEA9
	for <linux-xfs@vger.kernel.org>; Fri, 11 Oct 2024 01:35:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1728610546; cv=none; b=o9Kumxf21qzSXDoFk7yaZ5tVE/2C17RdtURE70BO4n5dGqItK2wNbV8AfCkprGKpUv27Hd4DkJTulOQEADLkQLMSLslNMMCn9N4OMPBO6PVfQRoGZlvQ74V58Pvrr26ex9NJvnIDB6hN1vCk+UgfEdwFavVH91I4V6ggtuvnZqo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1728610546; c=relaxed/simple;
	bh=mgj8F8wiVgWB3BZFcX3uCus4KukRldcDyg90xJa4EfA=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=iZof9p2Q8gbtApc7CXFSPPcIQGYennlgYLGatIZn8/ruQZAmCwXY6fyfVqXhP9J+oVrwx3NeS43Kf64BpOvmozt5EsuUAXkmwGfCn3OBqFVhZHsClIYebwgzB8Qmk0GFp+9f9f5XtNP6JDnZwLCcbe9rYzpQ2kzDsjvNCscvarU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=FJ9kGwIe; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 7843CC4CEC5;
	Fri, 11 Oct 2024 01:35:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1728610546;
	bh=mgj8F8wiVgWB3BZFcX3uCus4KukRldcDyg90xJa4EfA=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Thu, 10 Oct 2024 18:35:46 -0700
Subject: [PATCH 43/43] mkfs: format realtime groups
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org, aalbersh@kernel.org
Cc: hch@lst.de, linux-xfs@vger.kernel.org
Message-ID: <172860656025.4184637.9088560847985719945.stgit@frogsfrogsfrogs>
...
index cad4b3fdd8cc98..b9287a7da4208d 100644
...
index 4796c9f571d1ff..fc43fc8c9edab5 100644
--- a/libxfs/libxfs_priv.h
+++ b/libxfs/libxfs_priv.h
@@ -306,12 +306,6 @@ find_next_zero_bit(const unsigned long *addr, unsigned long size,
 }
...
index a76c6a9ee695b3..004dac350e2dc9 100644
--- a/man/man8/mkfs.xfs.8.in
+++ b/man/man8/mkfs.xfs.8.in
@@ -1129,6 +1129,37 @@ .SH OPTIONS
 .BI noalign
...
index d3cbfb324c641e..a24d8e88f9f25e 100644
--- a/mkfs/proto.c
+++ b/mkfs/proto.c
@@ -879,8 +879,8 @@ create_sb_metadata_file(
 }
...
index 4ea734a4d48f59..4e02adbd1913fa 100644
--- a/mkfs/xfs_mkfs.c
+++ b/mkfs/xfs_mkfs.c
@@ -132,6 +132,8 @@ enum {
 	R_FILE,
...
-	unsigned int		rbmblocksize = cfg->blocksize;
 	...
 	if (!xi->rt.dev) {
 		if (cli->rtsize) {
@@ -3254,10 +3298,13 @@ reported by the device (%u).\n"),
...
+						NBBY * cfg->blocksize);
 ...
 static bool
@@ -3498,6 +3545,189 @@ an AG size that is one stripe unit smaller or larger, for example %llu.\n"),
...
+
 ...
 calculate_imaxpct(
 	struct mkfs_params	*cfg,
@@ -3651,8 +3881,13 @@ sb_set_features(
 		 */
...
+	}
 ...
 /*
@@ -4046,6 +4281,7 @@ start_superblock_setup(
...
+	libxfs_sb_mount_rextsize(mp, sbp);
 ...
 static void
@@ -4106,7 +4342,7 @@ finish_superblock_setup(
