Return-Path: <linux-xfs+bounces-5576-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5524288B840
	for <lists+linux-xfs@lfdr.de>; Tue, 26 Mar 2024 04:17:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 08D8A2E511A
	for <lists+linux-xfs@lfdr.de>; Tue, 26 Mar 2024 03:17:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6BE58128814;
	Tue, 26 Mar 2024 03:16:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="egBV786k"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2BEE257314
	for <linux-xfs@vger.kernel.org>; Tue, 26 Mar 2024 03:16:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711423016; cv=none; b=ojIFDeXjGBfkRkMkscfWG6lsCPftJsamMOHe3xP2lAn/xqtMZ7KTidQMb1nDeIRX6WhburNrk/YunB2k9gQHhyJLhjRdPP33gOOL6RKQtd2niJbcN/E73EwQNoH7qd1r2qVDwVR71dfcNld+JYQBX/Obfg8iCerVvzCMhjjONzk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711423016; c=relaxed/simple;
	bh=gu4Q+I/40Q4R+ro3p5sNrYDIvK8kGV577lcRjjiAtWE=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=XfFTRw/kD0yNhIgaKiyvzNu2dTtPoC1h8cT5aTG+sMz32SLMsgyCcTdeJHAy0yUx2yvAjinmIbCfjYegtNMtQNubJWl00rUTtl7EAURBPs5p19+O7jimW2ZPSFzB/x1mhPiQ8qryP5hqicr/llWpky4VfncSRPaU4bI1Qe8ZTh0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=egBV786k; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id EDF7AC433F1;
	Tue, 26 Mar 2024 03:16:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1711423016;
	bh=gu4Q+I/40Q4R+ro3p5sNrYDIvK8kGV577lcRjjiAtWE=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Mon, 25 Mar 2024 20:16:55 -0700
...
Message-ID: <171142127734.2212320.9439656806130978777.stgit@frogsfrogsfrogs>
...
index 063721ca98f2..5a6fd2036a37 100644
--- a/db/namei.c
+++ b/db/namei.c
@@ -290,14 +290,12 @@ list_sfdir(
...
index 8517bfb64b52..8cea0c1500b4 100644
--- a/libxfs/util.c
+++ b/libxfs/util.c
...
index cb6c8d081fd3..d7512efd42a8 100644
--- a/libxfs/xfs_attr.c
+++ b/libxfs/xfs_attr.c
@@ -1047,9 +1047,8 @@ xfs_attr_set(
...
index 8329348eb78b..5ab52bf1aa66 100644
...
index b977032d8244..5e6a5e1f355b 100644
--- a/libxfs/xfs_bmap.c
+++ b/libxfs/xfs_bmap.c
...
index c19684b34017..a781520c856d 100644
--- a/libxfs/xfs_dir2.c
+++ b/libxfs/xfs_dir2.c
...
index bb9301b76880..bf950c7001f8 100644
...
index 260eccacf176..b2b43e937476 100644
...
index 5d0be2dc8fed..24124039fdd8 100644
...
index 80f4215d24bd..fbcda5f544a7 100644
...
index 535be5c03689..7edcf0e8cd53 100644
...
index cf894b5276ac..fa90b179314d 100644
...
index fcb26d594b10..43a4c1406372 100644
--- a/repair/phase6.c
+++ b/repair/phase6.c
