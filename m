...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B1A79E1181
	for <lists+linux-xfs@lfdr.de>; Wed, 23 Oct 2019 07:12:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389020AbfJWFMl (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 23 Oct 2019 01:12:41 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:31954 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1728697AbfJWFMl (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 23 Oct 2019 01:12:41 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1571807560;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=BhVJJHD+KN4CoFKM9rjLlSOaVtJxb0ZmEPKtdmREGRM=;
        b=UZHMjKJn1a4O5mnf3hGtd/Tb3/E3DfA2gXslceBlva8NnyAqdSsNFSgX9MNleiqFYxJPRA
        ZWUxkiERiCyyzcSFC/T3BMyWD4ZPxOehqX+40Bu48fhF9MvQsHDCq5A4EJg4fS4xnZ5tnY
        ECdopHdejzPF30rCEUxKs928mBXQUEw=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-386-cfId-lJTNda5naZPjp5FBA-1; Wed, 23 Oct 2019 01:12:37 -0400
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id B037A800D57;
        Wed, 23 Oct 2019 05:12:36 +0000 (UTC)
Received: from localhost (dhcp-12-102.nay.redhat.com [10.66.12.102])
        by smtp.corp.redhat.com (Postfix) with ESMTP id DC1CD60BE1;
        Wed, 23 Oct 2019 05:12:35 +0000 (UTC)
Date:   Wed, 23 Oct 2019 13:20:56 +0800
From:   Zorro Lang <zlang@redhat.com>
To:     Yang Xu <xuyang2018.jy@cn.fujitsu.com>
Cc:     fstests@vger.kernel.org, linux-xfs@vger.kernel.org,
        ikent@redhat.com
Subject: Re: [PATCH] xfstests: xfs mount option sanity test
Message-ID: <20191023052056.GU7239@dhcp-12-102.nay.redhat.com>
References: <20191022100118.18506-1-zlang@redhat.com>
 <65b4bd1d-e60e-7cad-a4c8-3eb3039dbc1f@cn.fujitsu.com>
MIME-Version: 1.0
In-Reply-To: <65b4bd1d-e60e-7cad-a4c8-3eb3039dbc1f@cn.fujitsu.com>
User-Agent: Mutt/1.10.1 (2018-07-13)
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.12
X-MC-Unique: cfId-lJTNda5naZPjp5FBA-1
...
On Wed, Oct 23, 2019 at 12:58:34PM +0800, Yang Xu wrote:
>=20
>=20
...
> But xfs/191 is not worth updating because it needs to update every time i=
f
> mkfs.xfs changed. mount action has the same problem.

This case tests xfs mount options(refer to man 5 xfs), focus on xfs_parsear=
gs(),
not mkfs.xfs itself.
