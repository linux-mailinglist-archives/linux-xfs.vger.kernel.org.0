...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5AD81548221
	for <lists+linux-xfs@lfdr.de>; Mon, 13 Jun 2022 10:55:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239483AbiFMIuo (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Mon, 13 Jun 2022 04:50:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42160 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229733AbiFMIuo (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Mon, 13 Jun 2022 04:50:44 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D496A1156;
        Mon, 13 Jun 2022 01:50:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1655110239; x=1686646239;
  h=date:from:to:cc:subject:message-id:mime-version:
   content-transfer-encoding:in-reply-to;
  bh=pIkQOnVcvgKEKo49/rmRWTJUtAOz2bcEkOXq7i4TwnQ=;
  b=UU3vKxONCuCrZdhE4COAeiB3iDjPll3DZVIwzvFeYYCMmcTnTIGcOqdg
   LOvuoBN+FiumtS1uyCR4kHoXRzT5mReNa+NEQcdQHpvgsqsmsD0nitWeP
   jsTtrZpRWv+TBDaQL14TMn6cezSira33k8XKEz5YwJYAcd4lrSb/zet0e
   zC6k/0nD7B7pk/dL9xCoOjVf6bG99fqOyOzIRZcPPNxgWzOmILHa94KNq
   QHJl4iyZNY8jnrWqUp7Z4W5OpUCXKHtp+CslbcTB8k9azs9fyZj+KiUw7
   TaWNO19Qv0LwOB3WERl7sZHO2L0eDbbbRaebf0cTWCgOBMGYf8yrUa6ct
   Q==;
X-IronPort-AV: E=McAfee;i="6400,9594,10376"; a="303611377"
X-IronPort-AV: E=Sophos;i="5.91,296,1647327600"; 
   d="yaml'?scan'208";a="303611377"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jun 2022 01:50:39 -0700
X-IronPort-AV: E=Sophos;i="5.91,296,1647327600"; 
   d="yaml'?scan'208";a="587689438"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.143])
  by fmsmga007-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jun 2022 01:50:32 -0700
Date:   Mon, 13 Jun 2022 16:50:29 +0800
From:   kernel test robot <oliver.sang@intel.com>
To:     Stefan Roesch <shr@fb.com>
Cc:     0day robot <lkp@intel.com>, Christoph Hellwig <hch@lst.de>,
        ...
        fan.zhao@intel.com, io-uring@vger.kernel.org, kernel-team@fb.com,
        linux-mm@kvack.org, linux-xfs@vger.kernel.org, shr@fb.com,
        david@fromorbit.com, hch@infradead.org, axboe@kernel.dk
Subject: [fs]  b6c81e63ec:
 phoronix-test-suite.fio.SequentialWrite.Sync.Yes.No.4KB.DefaultTestDirectory.mb_s
 -4.3% regression
Message-ID: <20220613085029.GG7252@xsang-OptiPlex-9020>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="pE2VAHO2njSJCslu"
...
Content-Disposition: attachment; filename="config-5.18.0-13850-gb6c81e63ec1e"
...
kbuild_queue_analysis'
	...
	export submit_id='62a4b09ffc3e78d4c0ee9e54'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86_64-20220611-54464-10ogdtg-3.yaml'
	export id='2c5e1c7c97d009fa5eb1f6be9c31f7471ac28e09'
	...
	export commit='b6c81e63ec1e668f8df716a91c5386074411dbbe'
...
SATA_AHCI'
	...
	export enqueue_time='2022-06-11 23:11:30 +0800'
	export _id='62a4b09ffc3e78d4c0ee9e54'
	export _rt='/result/phoronix-test-suite/performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe'
	export user='lkp'
	export compiler='gcc-11'
	export LKP_SERVER='internal-lkp-server'
	export head_commit='be7d66b30a7749d965b4351727fb2893e3d246ce'
	export base_commit='f2906aa863381afb0015a9eb7fefad885d4e5a56'
	export branch='linux-review/Stefan-Roesch/io-uring-xfs-support-async-buffered-writes/20220609-013837'
	export result_root='/result/phoronix-test-suite/performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/3'
...
RESULT_ROOT=/result/phoronix-test-suite/performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/3
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/vmlinuz-5.18.0-13850-gb6c81e63ec1e
branch=linux-review/Stefan-Roesch/io-uring-xfs-support-async-buffered-writes/20220609-013837
job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86_64-20220611-54464-10ogdtg-3.yaml
user=lkp
ARCH=x86_64
kconfig=x86_64-rhel-8.3
commit=b6c81e63ec1e668f8df716a91c5386074411dbbe
max_uptime=2100
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/modules.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20220216.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.19.0-rc1-00095-g874c8ca1e60b'
	export repeat_to=6
	export schedule_notify_address=
	export kbuild_queue_analysis=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/vmlinuz-5.18.0-13850-gb6c81e63ec1e'
	export dequeue_time='2022-06-11 23:12:45 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86_64-20220611-54464-10ogdtg-3.cgz'
...
run_job()
{
	...
	run_test test='fio-1.14.1' option_a='Sequential Write' option_b='Sync' option_c='Yes' option_d='No' option_e='4KB' option_f='Default Test Directory' $LKP_SRC/tests/wrapper phoronix-test-suite
}
...
extract_stats()
{
	...
	env test='fio-1.14.1' option_a='Sequential Write' option_b='Sync' option_c='Yes' option_d='No' option_e='4KB' option_f='Default Test Directory' $LKP_SRC/stats/wrapper phoronix-test-suite
...
submit_id: 62a49b1dfc3e78ce3e6959a5
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86_64-20220611-52798-sxcyqk-1.yaml"
id: 82757beff6935824a8e047c60422d48d0f960f51
...
enqueue_time: 2022-06-11 21:39:41.629170406 +08:00
_id: 62a4a22bfc3e78ce3e6959a6
_rt: "/result/phoronix-test-suite/performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe"
:#! schedule options:
user: lkp
compiler: gcc-11
LKP_SERVER: internal-lkp-server
...
result_root: "/result/phoronix-test-suite/performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a/lkp-csl-2sp7/debian-x86_64-phoronix/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/0"
...
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/vmlinuz-5.18.0-13850-gb6c81e63ec1e
- branch=linux-devel/devel-hourly-20220610-100950
- job=/lkp/jobs/scheduled/lkp-csl-2sp7/phoronix-test-suite-performance-Sequential_Write-Sync-Yes-No-4KB-Default_Test_Directory-fio-1.14.1-ucode=0x500320a-debian-x86_64-20220611-52798-sxcyqk-1.yaml
- user=lkp
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- commit=b6c81e63ec1e668f8df716a91c5386074411dbbe
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-11/b6c81e63ec1e668f8df716a91c5386074411dbbe/vmlinuz-5.18.0-13850-gb6c81e63ec1e"
dequeue_time: 2022-06-11 22:12:48.137097982 +08:00
job_state: finished
loadavg: 0.95 0.55 0.22 1/1005 8810
start_time: '1654954483'
end_time: '1654954601'
...
do
 ...
 "phoronix-test-suite" "run" "fio-1.14.1"
