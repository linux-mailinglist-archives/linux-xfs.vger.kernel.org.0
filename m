...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 60E05711BB9
	for <lists+linux-xfs@lfdr.de>; Fri, 26 May 2023 02:53:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233820AbjEZAw6 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 25 May 2023 20:52:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49684 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234575AbjEZAw6 (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 25 May 2023 20:52:58 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 77D5D195
        for <linux-xfs@vger.kernel.org>; Thu, 25 May 2023 17:52:54 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 0667361ADD
        for <linux-xfs@vger.kernel.org>; Fri, 26 May 2023 00:52:54 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 5E4B8C433D2;
        Fri, 26 May 2023 00:52:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1685062373;
        bh=mNHqRTi284I+nhguT1gvO4eO8YykvPzafuuA6tSeo9c=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 25 May 2023 17:52:52 -0700
Subject: [PATCH 3/6] xfs: repair inode records
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org
Cc:     linux-xfs@vger.kernel.org
Message-ID: <168506058352.3730405.2786021335811667659.stgit@frogsfrogsfrogs>
...
index cc74e2fe850e..b18c5dd6c169 100644
--- a/fs/xfs/Makefile
+++ b/fs/xfs/Makefile
...
index 267c169a21ca..964089e24ca6 100644
...
index 6b6d912c710e..fcd6e9df618f 100644
...
index 000000000000..d48a2b4acc80
--- /dev/null
...
index e41d2fd106a1..b2f06f9142a3 100644
...
index a4b6b2a3846b..9f98b70e630c 100644
...
index e95734d0c0ad..6e390a449e48 100644
--- a/fs/xfs/scrub/scrub.c
+++ b/fs/xfs/scrub/scrub.c
@@ -281,7 +281,7 @@ static const struct xchk_meta_ops meta_scrub_ops[] = {
 		.type	= ST_INODE,
...
index 69eb301fd81e..fffbdf436648 100644
--- a/fs/xfs/scrub/trace.h
+++ b/fs/xfs/scrub/trace.h
@@ -1346,6 +1346,135 @@ DEFINE_NEWBT_EXTENT_EVENT(xrep_newbt_alloc_file_blocks);
