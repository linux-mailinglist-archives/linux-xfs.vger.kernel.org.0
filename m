...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 43B2340A3BF
	for <lists+linux-xfs@lfdr.de>; Tue, 14 Sep 2021 04:43:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234374AbhINCoT (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Mon, 13 Sep 2021 22:44:19 -0400
Received: from mail.kernel.org ([198.145.29.99]:53908 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S237856AbhINCoR (ORCPT <rfc822;linux-xfs@vger.kernel.org>);
        Mon, 13 Sep 2021 22:44:17 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id AB4BB610F9;
        Tue, 14 Sep 2021 02:43:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1631587380;
        bh=2w9pYtof5Cupp5Fq4q/8QU4809ELhyhp8dYD5PeR8s8=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Subject: [PATCH 33/43] xfs_{copy,db,logprint,repair}: replace xfs_sb_version
 checks with feature flag checks
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     sandeen@sandeen.net, djwong@kernel.org
Cc:     linux-xfs@vger.kernel.org
Date:   Mon, 13 Sep 2021 19:43:00 -0700
Message-ID: <163158738037.1604118.6563213780558776723.stgit@magnolia>
...
index 5c4f65b4..c7efc3eb 100644
--- a/copy/xfs_copy.c
+++ b/copy/xfs_copy.c
@@ -523,8 +523,7 @@ sb_update_uuid(
...
@@ -1278,7 +1277,7 @@ write_log_header(int fd, wbuf *buf, xfs_mount_t *mp)
 	}
...
index 593d0fa2..d36595cf 100644
--- a/libxfs/init.c
+++ b/libxfs/init.c
...
index 713ef9af..f4e76029 100644
--- a/libxfs/rdwr.c
+++ b/libxfs/rdwr.c
...
index 81c01526..f6174172 100644
--- a/repair/phase2.c
+++ b/repair/phase2.c
@@ -34,7 +34,7 @@ zero_log(
