...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EEFF961FBA6
	for <lists+linux-xfs@lfdr.de>; Mon,  7 Nov 2022 18:41:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232890AbiKGRlv (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Mon, 7 Nov 2022 12:41:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51594 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232711AbiKGRlu (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Mon, 7 Nov 2022 12:41:50 -0500
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 828D31A383
        for <linux-xfs@vger.kernel.org>; Mon,  7 Nov 2022 09:41:46 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1667842906; x=1699378906;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=YbIcIoCwCM2RRylfB0I/T541yOH1G5olAOgi4GjTtms=;
  b=JPPlvGlI3d6pXaGfEwu3QxvZsTfmCVTIvRi80NqzfyLa9m2OysmkRwZH
   VA2x3X04gE6pC9gZB4Ts8M9rXgNFqcJhCeXjab6gZZWfmWMIij7iWDauR
   MWv4UyhCWeNGBw8ifyfK+D8YIzO5Chn76jxCScFFD4pdaHWhpiDrLVWCp
   FJ25wKH3qVJy2gHpIjWPYHxSxkgURpxEpMzIEr6OfuIxDQrUm8iKRouyN
   FNwJYRLDLbIusjja0mO1Vx+/kXFEsCCNn4qoIUPsuT3P9C0yYxOlrd17J
   bnDMDeciMZFZ7Yq4asWvYozsu6fVTByA+p4GaI5WYDcQIUa6qN8vr26yi
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="374743620"
X-IronPort-AV: E=Sophos;i="5.96,145,1665471600"; 
   d="scan'208";a="374743620"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Nov 2022 09:30:59 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10524"; a="704967180"
X-IronPort-AV: E=Sophos;i="5.96,145,1665471600"; 
   d="scan'208";a="704967180"
Received: from lkp-server01.sh.intel.com (HELO 462403710aa9) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 07 Nov 2022 09:30:56 -0800
Received: from kbuild by 462403710aa9 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1os5xY-0000sK-17;
        Mon, 07 Nov 2022 17:30:56 +0000
Date:   Tue, 8 Nov 2022 01:30:41 +0800
From:   kernel test robot <lkp@intel.com>
To:     allison.henderson@oracle.com, linux-xfs@vger.kernel.org
Cc:     llvm@lists.linux.dev, oe-kbuild-all@lists.linux.dev
Subject: Re: [PATCH v5 16/26] xfs: add parent attributes to symlink
Message-ID: <202211080133.ss4EgvqC-lkp@intel.com>
References: <20221107090156.299319-17-allison.henderson@oracle.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="DPwJfMp3cHuN1FO1"
Content-Disposition: inline
In-Reply-To: <20221107090156.299319-17-allison.henderson@oracle.com>
...
url:    https://github.com/intel-lab-lkp/linux/commits/allison-henderson-oracle-com/Parent-Pointers/20221107-170748
base:   https://git.kernel.org/pub/scm/fs/xfs/xfs-linux.git for-next
patch link:    https://lore.kernel.org/r/20221107090156.299319-17-allison.henderson%40oracle.com
patch subject: [PATCH v5 16/26] xfs: add parent attributes to symlink
config: riscv-randconfig-r042-20221107
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/c75557829f31b72a783b111912357b96a5d18575
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review allison-henderson-oracle-com/Parent-Pointers/20221107-170748
        git checkout c75557829f31b72a783b111912357b96a5d18575
...
>> fs/xfs/xfs_symlink.c:148:1: warning: no previous prototype for function 'xfs_symlink_space_res' [-Wmissing-prototypes]
   xfs_symlink_space_res(
   ^
   fs/xfs/xfs_symlink.c:147:1: note: declare 'static' if the function is not intended to be used outside of this translation unit
   unsigned int
   ^
   static 
   1 warning generated.
...
vim +/xfs_symlink_space_res +148 fs/xfs/xfs_symlink.c

   146	
   147	unsigned int
 > 148	xfs_symlink_space_res(
   149		struct xfs_mount	*mp,
   150		unsigned int		namelen,
   151		unsigned int		fsblocks)
   152	{
   153		unsigned int		ret;
   154	
   155		ret = XFS_IALLOC_SPACE_RES(mp) + XFS_DIRENTER_SPACE_RES(mp, namelen) +
   156				fsblocks;
   157	
   158		if (xfs_has_parent(mp))
   159			ret += xfs_pptr_calc_space_res(mp, namelen);
   160	
   161		return ret;
   162	}
   163	
