...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 342DDED628
	for <lists+linux-xfs@lfdr.de>; Sun,  3 Nov 2019 23:25:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727969AbfKCWZV (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Sun, 3 Nov 2019 17:25:21 -0500
Received: from aserp2120.oracle.com ([141.146.126.78]:39936 "EHLO
        aserp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727503AbfKCWZV (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Sun, 3 Nov 2019 17:25:21 -0500
Received: from pps.filterd (aserp2120.oracle.com [127.0.0.1])
        by aserp2120.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xA3MOGSu073209
        for <linux-xfs@vger.kernel.org>; Sun, 3 Nov 2019 22:25:18 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=subject : from : to :
 cc : date : message-id : in-reply-to : references : mime-version :
 content-type : content-transfer-encoding; s=corp-2019-08-05;
 bh=nfBxameV9vdAGzCjM0VDdRhyhIRDZIBvT5NdcnLcxn4=;
 b= ag== 
Received: from aserp3020.oracle.com (aserp3020.oracle.com [141.146.126.70])
        by aserp2120.oracle.com with ESMTP id 2w11rpm492-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-xfs@vger.kernel.org>; Sun, 03 Nov 2019 22:25:18 +0000
Received: from pps.filterd (aserp3020.oracle.com [127.0.0.1])
        by aserp3020.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xA3MOAUN071436
        for <linux-xfs@vger.kernel.org>; Sun, 3 Nov 2019 22:25:18 GMT
Received: from aserv0121.oracle.com (aserv0121.oracle.com [141.146.126.235])
        by aserp3020.oracle.com with ESMTP id 2w1ka8e7jn-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-xfs@vger.kernel.org>; Sun, 03 Nov 2019 22:25:17 +0000
Received: from abhmp0017.oracle.com (abhmp0017.oracle.com [141.146.116.23])
        by aserv0121.oracle.com (8.14.4/8.13.8) with ESMTP id xA3MPH2w032413
        for <linux-xfs@vger.kernel.org>; Sun, 3 Nov 2019 22:25:17 GMT
Received: from localhost (/67.169.218.210)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Sun, 03 Nov 2019 14:25:17 -0800
Subject: [PATCH 05/10] xfs: report dir/attr block corruption errors to the
 health system
From:   "Darrick J. Wong" <darrick.wong@oracle.com>
To:     darrick.wong@oracle.com
Cc:     linux-xfs@vger.kernel.org
Date:   Sun, 03 Nov 2019 14:25:15 -0800
Message-ID: <157281991584.4152102.5773934835175995862.stgit@magnolia>
...
index 3e39b7d40f25..0d6404fd5f14 100644
...
@@ -260,17 +261,18 @@ xfs_attr3_rmt_hdr_set(
  */
 STATIC int
...
@@ -286,6 +288,7 @@ xfs_attr_rmtval_copyout(
 				xfs_alert(mp,
...
@@ -404,10 +407,12 @@ xfs_attr_rmtval_get(
 						   mp->m_ddev_targp,
 						   dblkno, dblkcnt, 0, &bp,
...
index 36fc8ffc06b1..c641bcbcb2ac 100644
...
index 9d4596b52b72..f05a2f0124dc 100644
...
index d58cfbe29316..f9c20af0d803 100644
...
index 01cbc1950cfd..25d926a44766 100644
...
index a516d83158d1..cbf5ff949e03 100644
