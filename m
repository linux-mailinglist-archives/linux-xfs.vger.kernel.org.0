...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 502A56BD640
	for <lists+linux-xfs@lfdr.de>; Thu, 16 Mar 2023 17:48:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229986AbjCPQsf (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 16 Mar 2023 12:48:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43742 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229479AbjCPQse (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 16 Mar 2023 12:48:34 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BC36BCC30C
        for <linux-xfs@vger.kernel.org>; Thu, 16 Mar 2023 09:48:29 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 32C21B8227B
        for <linux-xfs@vger.kernel.org>; Thu, 16 Mar 2023 16:48:28 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id DE611C4339B;
        Thu, 16 Mar 2023 16:48:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1678985307;
        bh=FQ7+uNVcPQy1aQGJwrGbiqfscGcG2yjHz0XiPcjMbIA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 16 Mar 2023 09:48:26 -0700
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     Dave Chinner <david@fromorbit.com>
Cc:     xfs <linux-xfs@vger.kernel.org>
Subject: [PATCH] xfs: test dir/attr hash when loading module
Message-ID: <20230316164826.GM11376@frogsfrogsfrogs>
MIME-Version: 1.0
...
index 35c1b41a3ef1..bbabf898cabc 100644
--- a/fs/xfs/Makefile
+++ b/fs/xfs/Makefile
@@ -127,6 +127,7 @@ xfs-y				+= xfs_aops.o \
 				   xfs_bmap_util.o \
 				   xfs_bio_io.o \
 				   xfs_buf.o \
+				   xfs_dahash_test.o \
