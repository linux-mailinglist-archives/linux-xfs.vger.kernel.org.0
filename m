...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E3EB6711C11
	for <lists+linux-xfs@lfdr.de>; Fri, 26 May 2023 03:07:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231691AbjEZBHq (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 25 May 2023 21:07:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53744 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233104AbjEZBHq (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 25 May 2023 21:07:46 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C980E1A4
        for <linux-xfs@vger.kernel.org>; Thu, 25 May 2023 18:07:28 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 2AF3460C3F
        for <linux-xfs@vger.kernel.org>; Fri, 26 May 2023 01:07:28 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 8152DC433EF;
        Fri, 26 May 2023 01:07:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1685063247;
        bh=qMHTVy1+0mnoRxR5WA834TIWTbgUGPTMt+ZUcchyWn0=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 25 May 2023 18:07:27 -0700
Subject: [PATCH 2/4] xfs: repair the rmapbt
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org
Cc:     linux-xfs@vger.kernel.org
Message-ID: <168506062328.3733354.10122956926888530699.stgit@frogsfrogsfrogs>
...
---
 ...
 fs/xfs/scrub/rmap_repair.c     | 1443 ++++++++++++++++++++++++++++++++++++++++
 fs/xfs/scrub/scrub.c           |    2 
 fs/xfs/scrub/trace.h           |   33 +
 19 files changed, 1617 insertions(+), 19 deletions(-)
 create mode 100644 fs/xfs/scrub/rmap_repair.c


diff --git a/fs/xfs/Makefile b/fs/xfs/Makefile
index 8602e14354c9..b07471303b85 100644
--- a/fs/xfs/Makefile
+++ b/fs/xfs/Makefile
...
index 1e49ed208ef1..86180103f5ca 100644
--- a/fs/xfs/libxfs/xfs_bmap.c
+++ b/fs/xfs/libxfs/xfs_bmap.c
@@ -6378,3 +6378,46 @@ xfs_bunmapi_range(
 out:
 	return error;
 }
+
...
index 9bc78c717ecf..2ceb6c20bbfa 100644
--- a/fs/xfs/libxfs/xfs_bmap.h
+++ b/fs/xfs/libxfs/xfs_bmap.h
@@ -281,4 +281,12 @@ extern struct kmem_cache	*xfs_bmap_intent_cache;
...
index 8c2a99ab73aa..ded712917b47 100644
...
index 3c98d9d50afb..69fdeddda83b 100644
...
index 43ff2236f623..4ec61bbe3be2 100644
...
index d74f706ff33c..e78b6ed160a5 100644
...
index 8159a3c4173d..a20e319c370b 100644
...
@@ -88,6 +89,10 @@ static inline int xagb_bitmap_disunion(struct xagb_bitmap *bitmap,
...
index e98d86f74a94..0c64544ab417 100644
...
index 782ab50ec9de..4cbc59df94e9 100644
...
index 63e42af90f78..420703f599a2 100644
...
index 3e9321b52d27..797864ff264c 100644
...
index d39c14f7cbcf..f1103f82fdc5 100644
...
index 787d3a706dfd..e20e8399aa86 100644
...
index 2e72b2557f65..a31621c81488 100644
...
@@ -103,6 +104,7 @@ int xrep_agfl(struct xfs_scrub *sc);
...
@@ -168,6 +170,7 @@ xrep_setup_nothing(
 	return 0;
 }
...
@@ -186,6 +189,7 @@ static inline int xrep_setup_rtbitmap(struct xfs_scrub *sc, unsigned int *x)
...
index d29a26ecddd6..c99eca78ea2a 100644
...
index 000000000000..ccec73dd6ce1
--- /dev/null
...
index e57c8e7ad48a..44b83848148a 100644
--- a/fs/xfs/scrub/scrub.c
+++ b/fs/xfs/scrub/scrub.c
@@ -279,7 +279,7 @@ static const struct xchk_meta_ops meta_scrub_ops[] = {
...
index edc86a06da21..8d235e75bef9 100644
--- a/fs/xfs/scrub/trace.h
+++ b/fs/xfs/scrub/trace.h
@@ -1474,7 +1474,6 @@ DEFINE_EVENT(xrep_rmap_class, name, \
...
@@ -1592,6 +1591,38 @@ TRACE_EVENT(xrep_bmap_found,
 		  __entry->state)
 );
