Return-Path: <linux-xfs+bounces-5883-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 23B3488D404
	for <lists+linux-xfs@lfdr.de>; Wed, 27 Mar 2024 02:53:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 273561C23FCA
	for <lists+linux-xfs@lfdr.de>; Wed, 27 Mar 2024 01:53:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 971551CD3B;
	Wed, 27 Mar 2024 01:53:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="lcEmUZjE"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 57F0B18C36
	for <linux-xfs@vger.kernel.org>; Wed, 27 Mar 2024 01:53:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711504433; cv=none; b=UN2M1WNokKr2VQqE7bNwRFcbsnCRtNQMWYF5FmqAg6Ovht+/KpTh4KNJIHEpY5Sk7/eQpO4CpRw9/r2X4itdWADEDUEP4w2H3zycNA0VIjJjs6mQoHy+mD4rFs07U5SBwr4qDpSx7+J10lNDI6N/4FDPI9YoDHx+teYPdUZCLow=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711504433; c=relaxed/simple;
	bh=j8nnuCfN4jNBfZPp+s235oBcoHNQt1fnjVA1Oee45g4=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=mxFi2FLHHxcalltDsBsB3T5X4/i+KHB6MRNNc4uZxe4uZIGSQ7V1HnFxuSRAJpzA0fEPye63J8jjjFuIE9vX6j0cHYnIgkuyCbks7dWQtRQJ9KOUTVAqPAKBFRODyGnZC9hbeIG376j6IPmMHY4lo1peWw+amFPUtzuRo3rMafE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=lcEmUZjE; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 288FEC433F1;
	Wed, 27 Mar 2024 01:53:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1711504433;
	bh=j8nnuCfN4jNBfZPp+s235oBcoHNQt1fnjVA1Oee45g4=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Tue, 26 Mar 2024 18:53:52 -0700
Subject: [PATCH 04/15] xfs: introduce a file mapping exchange log intent item
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: Christoph Hellwig <hch@lst.de>, hch@lst.de, linux-xfs@vger.kernel.org
Message-ID: <171150380732.3216674.5999741892452595331.stgit@frogsfrogsfrogs>
...
index 346ad9fceca73..042b105c42dc2 100644
...
index a2dcbac6effe9..7bb867fd31041 100644
...
@@ -2195,8 +2196,24 @@ xfs_init_caches(void)
...
@@ -2253,6 +2270,8 @@ xfs_destroy_caches(void)
 	 * destroy caches.
 	 */
 	rcu_barrier();
+	kmem_cache_destroy(xfs_xmd_cache);
