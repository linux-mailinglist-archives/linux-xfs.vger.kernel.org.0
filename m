...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C9BBC765FC7
	for <lists+linux-xfs@lfdr.de>; Fri, 28 Jul 2023 00:36:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233322AbjG0WgE (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 27 Jul 2023 18:36:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49384 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233332AbjG0Wfs (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 27 Jul 2023 18:35:48 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E571F35AF
        for <linux-xfs@vger.kernel.org>; Thu, 27 Jul 2023 15:35:06 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 2917461F57
        for <linux-xfs@vger.kernel.org>; Thu, 27 Jul 2023 22:35:00 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 7DCA0C433C7;
        Thu, 27 Jul 2023 22:34:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1690497299;
        bh=iSkeFynwXx+zwp/mawhR14jby5bA7lFEcmMsxHD+K6k=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 27 Jul 2023 15:34:59 -0700
Subject: [PATCH 5/5] xfs: repair problems in CoW forks
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org
Cc:     linux-xfs@vger.kernel.org
Message-ID: <169049626935.922742.10885580986229391504.stgit@frogsfrogsfrogs>
...
index 0000000000000..551b2fb78ab4b
--- /dev/null
...
index 34e6c419e21f9..94bdb0b42b4c7 100644
...
index 1ec850a8e70cc..9be4bfb1f0609 100644
--- a/fs/xfs/scrub/repair.h
+++ b/fs/xfs/scrub/repair.h
@@ -103,6 +103,7 @@ int xrep_refcountbt(struct xfs_scrub *sc);
...
@@ -165,6 +166,7 @@ xrep_setup_nothing(
...
index 31023f82d4b58..3e57275c13bbb 100644
...
index b9f497385f700..d42c39b397cc8 100644
--- a/fs/xfs/scrub/trace.h
+++ b/fs/xfs/scrub/trace.h
@@ -1572,6 +1572,90 @@ TRACE_EVENT(xrep_dinode_count_rmaps,
 		  __entry->block0)
 );
