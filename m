...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A4189135CDD
	for <lists+linux-xfs@lfdr.de>; Thu,  9 Jan 2020 16:35:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731052AbgAIPfz (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 9 Jan 2020 10:35:55 -0500
Received: from foss.arm.com ([217.140.110.172]:32962 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728098AbgAIPfy (ORCPT <rfc822;linux-xfs@vger.kernel.org>);
        Thu, 9 Jan 2020 10:35:54 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 3494D1FB;
        Thu,  9 Jan 2020 07:35:53 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 6185B3F534;
        Thu,  9 Jan 2020 07:35:52 -0800 (PST)
Subject: Re: [PATCH] xfs: Fix xfs_dir2_sf_entry_t size check
To:     Eric Sandeen <sandeen@sandeen.net>, darrick.wong@oracle.com,
...
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.2.2
MIME-Version: 1.0
In-Reply-To: <c43539f2-aa9b-4afa-985c-c438099732ff@sandeen.net>
Content-Type: multipart/mixed;
 boundary="------------79B1B62B98B64264C440095C"
...
>> In function =E2=80=98xfs_check_ondisk_structs=E2=80=99,
>>     inlined from =E2=80=98init_xfs_fs=E2=80=99 at linux/fs/xfs/xfs_sup=
er.c:2025:2:
>> linux/include/linux/compiler.h:350:38:
>>     error: call to =E2=80=98__compiletime_assert_107=E2=80=99 declared=
 with attribute
>>     error: XFS: sizeof(xfs_dir2_sf_entry_t) is wrong, expected 3
>>     _compiletime_assert(condition, msg, __compiletime_assert_, __LINE_=
_)
>>
>> Restore the correct behavior defining the correct size.
>=20
> # pahole -C xfs_dir2_sf_entry fs/xfs/xfs.o=20
>=20
...
> };
>=20
> Can you please the same command on your machine, along with which arm a=
bi is
> in use etc just for clarity?
>

The abi is arm32 eabihf. You can reproduce my scenario using randconfig w=
ith
seed 0x72F68201.

In this case I get size 4, hence my patch.

If I enable xfs on the defconfig though size is 3 accordingly to what you=
 have
