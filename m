Return-Path: <linux-xfs+bounces-13892-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 85CC59998A2
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 03:06:14 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id ECAE1B22185
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 01:06:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 96F55440C;
	Fri, 11 Oct 2024 01:06:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="MKBSxvPD"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 56FB910F9
	for <linux-xfs@vger.kernel.org>; Fri, 11 Oct 2024 01:06:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1728608767; cv=none; b=CmzLUJZ/7uM3Nm8kMyKCB5Q29oahET4v+TzBKXOZcqFXlfQ/BMabldo7k1U56qLJZlQGBoCPc6QiV0TFAS1TE1T/4I4lNBwU73NW1BZ7tjyksxVfnkq9XfUVLhlvMkyIW6kwcJxnkN6XyeORqyvyjwAqnKUHnCeIruK19LXFXD4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1728608767; c=relaxed/simple;
	bh=iGd5tTXFgeCaiQ3VGA4kVyX8z2tJptWcvCklcpSS/wo=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=Et/wSDunAby6OnjkVblKHtXtVG8k34YL6G90AqejvnT4sZ4So1j8PyH9nLq3+ETmWUc+V8POhnwM1B2KiFCYL9ke8YaBgxmVDTHyf6BP/4NE5udwMKzmRYw0Im82NZUPuuMRQ5mwKJtDTLrh7c+nGthd47VC4a5EVcC7MUnQsUE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=MKBSxvPD; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 32145C4CEC5;
	Fri, 11 Oct 2024 01:06:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1728608767;
	bh=iGd5tTXFgeCaiQ3VGA4kVyX8z2tJptWcvCklcpSS/wo=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Thu, 10 Oct 2024 18:06:06 -0700
Subject: [PATCH 17/36] xfs: support logging EFIs for realtime extents
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: linux-xfs@vger.kernel.org, hch@lst.de
Message-ID: <172860644534.4178701.15918386563724757390.stgit@frogsfrogsfrogs>
...
index db25c8ad104206..aecf799d318f80 100644
...
index 517179a0abe98c..1f9290b966d30d 100644
--- a/fs/xfs/libxfs/xfs_alloc.h
+++ b/fs/xfs/libxfs/xfs_alloc.h
@@ -239,7 +239,11 @@ int xfs_free_extent_later(struct xfs_trans *tp, xfs_fsblock_t bno,
...
@@ -259,6 +263,12 @@ struct xfs_extent_free_item {
...
index 699ea8b957ab88..413ea8d460550e 100644
...
index a6abc09864edd0..5f19f677794ca0 100644
...
index 5256b9cccf2e9b..0ea03dcd04769f 100644
...
@@ -2773,13 +2774,20 @@ DECLARE_EVENT_CLASS(xfs_free_extent_deferred_class,
 	),
 	TP_fast_assign(
...
+		  __print_symbolic(__entry->type, XG_TYPE_STRINGS),
 		  ...
 		  __entry->agbno,
 		  __entry->len,
@@ -2789,7 +2797,6 @@ DECLARE_EVENT_CLASS(xfs_free_extent_deferred_class,
