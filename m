...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BA7256EAE2A
	for <lists+linux-xfs@lfdr.de>; Fri, 21 Apr 2023 17:38:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231955AbjDUPiO (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 21 Apr 2023 11:38:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35656 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232708AbjDUPiI (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Fri, 21 Apr 2023 11:38:08 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E66B6125A2
        for <linux-xfs@vger.kernel.org>; Fri, 21 Apr 2023 08:38:02 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 6040660C7F
        for <linux-xfs@vger.kernel.org>; Fri, 21 Apr 2023 15:38:02 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B591EC433EF;
        Fri, 21 Apr 2023 15:38:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1682091481;
        bh=uv6YqhxPS6dFy+x+sk9Fh+xTshGU82aJGRO+2jXhWCo=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Fri, 21 Apr 2023 08:38:01 -0700
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     Carlos Maiolino <cem@kernel.org>
Cc:     linux-xfs@vger.kernel.org, david@fromorbit.com
Subject: Re: [PATCH 1/2] libfrog: move crc32c selftest buffer into a separate
 file
Message-ID: <20230421153801.GK360889@frogsfrogsfrogs>
References: <168073967113.1654766.1707855494706927672.stgit@frogsfrogsfrogs>
 <lXUmjjC_wCkHsoP6i3WBPq0AtmY0FtQjXE8dJtdKHENI1eBREAGSxBJ3ZtCfBZqGAPo2qbbKB2a4QSDlb1tx4Q==@protonmail.internalid>
 <168073967676.1654766.11209657711850717788.stgit@frogsfrogsfrogs>
 <20230421085849.24enyzdftmiw5jiy@andromeda>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20230421085849.24enyzdftmiw5jiy@andromeda>
...
On Fri, Apr 21, 2023 at 10:58:49AM +0200, Carlos Maiolino wrote:
> On Wed, Apr 05, 2023 at 05:07:56PM -0700, Darrick J. Wong wrote:
> > From: Darrick J. Wong <djwong@kernel.org>
> > 
...
> 
> Hi Darrick.
> My apologies taking too long to process these patches, but, is there any reason
> why you sent this series twice? In any case, I'm picking up this more recent one
> to push today into for-next.

In between the first and second postings, it became a prerequisite for
the userspace port of the ascii-ci fixes in the previous series, and I
didn't want people to have to dig for it in the mailing list.

Then my mailer screwed up and sent the asciici patches first, so they
ended up on the list in the wrong order.

Also, please slurp up Dave's RVB tags from the first posting if you
haven't already.
...
> > index 01107082..b89818ed 100644
> > --- a/libfrog/Makefile
> > +++ b/libfrog/Makefile
> > @@ -26,6 +26,7 @@ paths.c \
> >  projects.c \
...
> >  workqueue.h
> > 
> > @@ -69,9 +71,9 @@ crc32table.h: gen_crc32table.c crc32defs.h
...
> > index 447a7f7d..757a9cf1 100644
