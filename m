...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9F66C734DA8
	for <lists+linux-xfs@lfdr.de>; Mon, 19 Jun 2023 10:29:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229462AbjFSI3G (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Mon, 19 Jun 2023 04:29:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35050 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229636AbjFSI3F (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Mon, 19 Jun 2023 04:29:05 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 976EE100
        for <linux-xfs@vger.kernel.org>; Mon, 19 Jun 2023 01:29:02 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 260FB615D2
        for <linux-xfs@vger.kernel.org>; Mon, 19 Jun 2023 08:29:02 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPS id 8DBD8C433D9
        for <linux-xfs@vger.kernel.org>; Mon, 19 Jun 2023 08:29:01 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1687163341;
        bh=T/7uw9gxYHm6yCoTFWY+DdhvRT1Bo014Zz5vW8bpixQ=;
        h=From:To:Subject:Date:From;
        b=
Received: by aws-us-west-2-korg-bugzilla-1.web.codeaurora.org (Postfix, from userid 48)
        id 7DF43C4332E; Mon, 19 Jun 2023 08:29:01 +0000 (UTC)
From:   bugzilla-daemon@kernel.org
To:     linux-xfs@vger.kernel.org
Subject: [Bug 217572] New: Initial blocked tasks causing deterioration over
 hours until (nearly) complete system lockup and data loss with PostgreSQL 13
Date:   Mon, 19 Jun 2023 08:29:00 +0000
...
X-Bugzilla-Changed-Fields: bug_id short_desc product version rep_platform
 ...
 cf_regression
Message-ID: <bug-217572-201763@https.bugzilla.kernel.org/>
...
while performing our nightly backup using pg_dump. Normally this takes at m=
ost
...
this message.
[330289.823098] task:.postgres-wrapp state:D stack:0     pid:11884 ppid:118=
81=20
flags:0x00000002
...
this message.
[330289.835926] task:.postgres-wrapp state:D stack:0     pid:1245532 ppid:1=
1881
 flags:0x00000002
...
[330584.620052]         (t=3D21000 jiffies g=3D142859597 q=3D21168 ncpus=3D=
3)
...
[330584.621844] Code: 04 48 8b 44 c2 08 c3 cc cc cc cc 48 8b 07 48 8b 40 08=
 c3
cc cc cc cc 0f 1f 84 00 00 00 00 00 e8 3b ff ff ff 48 89 c2 83 e2 03 <48> 8=
3 fa
...
[330584.636437] Code: 48 e8 9d dc f2 ff 41 b8 02 00 00 00 e9 38 f6 ff ff 66=
 90
f3 0f 1e fa 80 3d bd ac 0e 00 00 49 89 ca 74 10 b8 11 00 00 00 0f 05 <48> 3=
d 00
...
0000562bb5fe04d0
[330584.640313]  </TASK>
[330584.721995] rcu: INFO: rcu_preempt detected expedited stalls on CPUs/ta=
sks:
...
[330584.723783] Code: 00 e8 3b ff ff ff 48 89 c2 83 e2 03 48 83 fa 02 75 08=
 48
3d 00 10 00 00 77 05 c3 cc cc cc cc 0f b6 4f 10 48 8d 70 fe 38 48 fe <72> e=
e e8
...
[331277.848088]         (t=3D714253 jiffies g=3D142859597 q=3D1821602 ncpus=
=3D3)
...
[331290.069700] systemd[1]: systemd-journald.service: Watchdog timeout (lim=
it
3min)!
...
/var/lib/systemd/coredump/core.systemd-journal.0.39df468c96764e8c8fffc53a0d=
0a47d1.528.1686881003000000.zst
...
build-id.
[331290.288111] systemd-coredump[1267441]: Module libmnl.so.0 without build=
-id.
...
build-id.
[331290.290940] systemd-coredump[1267441]: Module libpam.so.0 without build=
-id.
[331290.291419] systemd-coredump[1267441]: Module liblz4.so.1 without build=
-id.
...
build-id.
[331290.296160] systemd-coredump[1267441]: Module libcap.so.2 without build=
-id.
[331290.296708] systemd-coredump[1267441]: Module libacl.so.1 without build=
-id.
...
journal_file_find_data_object_with_hash (libsystemd-shared-253.so + 0x234a7=
1)
...
[331290.307350] systemd-coredump[1267441]: #10 0x00007f3e9645cb48 sd_event_=
run
...
[389370.874126]         (t=3D21002 jiffies g=3D167843445 q=3D13889 ncpus=3D=
3)
...
[389370.875991] Code: cc cc cc cc 0f b6 0e 48 8b 57 08 48 d3 ea 83 e2 3f 89=
 d0
48 83 c0 04 48 8b 44 c6 08 48 89 77 18 48 89 c1 83 e1 03 48 83 f9 02 <75> 0=
8 48
