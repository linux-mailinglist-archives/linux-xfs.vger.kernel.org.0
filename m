Return-Path: <linux-xfs+bounces-518-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 2AD82807EC3
	for <lists+linux-xfs@lfdr.de>; Thu,  7 Dec 2023 03:41:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7FB76281A28
	for <lists+linux-xfs@lfdr.de>; Thu,  7 Dec 2023 02:41:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DA4DC1390;
	Thu,  7 Dec 2023 02:41:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="MJ/2X6vQ"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9DFE9A51
	for <linux-xfs@vger.kernel.org>; Thu,  7 Dec 2023 02:41:27 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 08A1FC433C7;
	Thu,  7 Dec 2023 02:41:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1701916887;
	bh=wPB0EU/lRHnA13X+SxRskXhQAzMpzeSSafZbogHwRY0=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Wed, 06 Dec 2023 18:41:26 -0800
Subject: [PATCH 6/7] xfs: repair inode btrees
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: Dave Chinner <dchinner@redhat.com>, linux-xfs@vger.kernel.org
Message-ID: <170191665714.1181880.17886548347278537110.stgit@frogsfrogsfrogs>
...
---
 ...
 11 files changed, 1022 insertions(+), 51 deletions(-)
 create mode 100644 fs/xfs/scrub/ialloc_repair.c


diff --git a/fs/xfs/Makefile b/fs/xfs/Makefile
index 3af3cadc1ca1c..8758abdcbb206 100644
--- a/fs/xfs/Makefile
+++ b/fs/xfs/Makefile
...
index d61d03e5b853b..2361a22035b0c 100644
...
index fe824bb04a091..f1412183bb44b 100644
...
index 23944fcc1a6ca..e0d6d8c9f6402 100644
...
index 83d9a29ce91e8..a720fc62262a6 100644
...
index 0000000000000..b3f7182dd2f5d
--- /dev/null
...
index 01b7e8d1a58b1..a604f0cea8c1e 100644
...
index ebc3b68a8ffbf..02ddfddfbed46 100644
...
index 5f934a2a4cb9f..7fc50654c4fe7 100644
