...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D27D23E9B3D
	for <lists+linux-xfs@lfdr.de>; Thu, 12 Aug 2021 01:28:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232803AbhHKX3V (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 11 Aug 2021 19:29:21 -0400
Received: from mail.kernel.org ([198.145.29.99]:45280 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232664AbhHKX3V (ORCPT <rfc822;linux-xfs@vger.kernel.org>);
        Wed, 11 Aug 2021 19:29:21 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id BD0A160E52;
        Wed, 11 Aug 2021 23:28:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1628724536;
        bh=ueHVRiLoG2TOWiiiMJIKVMv21HmYqME9OAYxwDIrfcg=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Wed, 11 Aug 2021 16:28:56 -0700
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     Dave Chinner <david@fromorbit.com>
Cc:     linux-xfs@vger.kernel.org
Subject: Re: [PATCH 07/16] xfs: convert mount flags to features
Message-ID: <20210811232856.GM3601443@magnolia>
...
In-Reply-To: <20210811003800.GW3601443@magnolia>
Precedence: bulk
...
Furthermore, this breaks upgrading an attr1 filesystem to attr2 through
the use of the mount option because the function that adds the feature
will exit early because FEAT_ATTR2 was set by the mount option even
though it's not set on disk:

# mkfs.xfs -m crc=0 /dev/sda -f
meta-data=/dev/sda               isize=256    agcount=4, agsize=644992 blks
...
# xfs_db -x -c 'version attr1' /dev/sda
writing all SBs
versionnum [0xb4b4+0x282] = V4,NLINK,DIRV2,ATTR,ALIGN,LOGV2,EXTFLG,MOREBITS,LAZYSBCOUNT,PROJID32BIT,FTYPE

# mount /dev/sda /mnt -o attr2
# attr -s moo -V urk /mnt
Attribute "moo" set to a 3 byte value for /mnt:
urk

# umount /mnt
# xfs_db -c version /dev/sda
versionnum [0xb4b4+0x282] = V4,NLINK,DIRV2,ATTR,ALIGN,LOGV2,EXTFLG,MOREBITS,LAZYSBCOUNT,PROJID32BIT,FTYPE

So I think this patch needs more work.
