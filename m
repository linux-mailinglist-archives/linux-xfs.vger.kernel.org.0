...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3E644E4770
	for <lists+linux-xfs@lfdr.de>; Fri, 25 Oct 2019 11:35:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2394325AbfJYJfL (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 25 Oct 2019 05:35:11 -0400
Received: from us-smtp-2.mimecast.com ([207.211.31.81]:23761 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S2394339AbfJYJfL (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Fri, 25 Oct 2019 05:35:11 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1571996109;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=8eoKM31R2oh+MK04ZKDjjAkBl4uN+UwJxdd5l2kKlBc=;
        b=S7y+9fSmJdNMO21bZf1I0PryuC7S9+jnd/Qh2Mwq79Oe9dB9b4dCm4yU2n7lMGH05OgVKm
        7BLkOD1LuYCtu2XdT4LJfihfjdD3k51R+d07sM7828hV6poXiO/r/2iB1kxtBl3VVaZ7PT
        cS/LW0N71gy2xcSkKWG9VQeRCdxs3EM=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-355-nFRR5FnuOU281hkaCQPBCA-1; Fri, 25 Oct 2019 05:35:05 -0400
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id C3331107AD31;
        Fri, 25 Oct 2019 09:35:04 +0000 (UTC)
Received: from localhost (dhcp-12-102.nay.redhat.com [10.66.12.102])
        by smtp.corp.redhat.com (Postfix) with ESMTP id EB010194B6;
        Fri, 25 Oct 2019 09:35:03 +0000 (UTC)
Date:   Fri, 25 Oct 2019 17:42:27 +0800
...
Message-ID: <20191025094227.GB3802@dhcp-12-102.nay.redhat.com>
...
MIME-Version: 1.0
In-Reply-To: <d086542e379f9025796cdffab3a37a7f2934033d.camel@redhat.com>
User-Agent: Mutt/1.10.1 (2018-07-13)
X-Scanned-By: MIMEDefang 2.84 on 10.5.11.23
X-MC-Unique: nFRR5FnuOU281hkaCQPBCA-1
...
> > > > > rw,relatime,seclabel,attr2,inode64,logbufs=3D8,logbsize=3D32k,noq=
uo
> > > > > ta
> > > > > ,
> > > > > but not found
...
> > > >=20
> > > > 2) The case expect there's not "logbufs=3DN" or "logbsize=3DN" outp=
ut
> > > > as
> > > > default.
...
Hmm... so the 'default behavior' is changed, should I tend to the lastest
upstream behavior, then cause old kernel testing fail (report a bug to merg=
e
the upstream change)? Or skip this test, make it as an 'undifined' behavior=
?
