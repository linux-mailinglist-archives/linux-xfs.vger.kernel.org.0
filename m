Return-Path: <linux-xfs+bounces-30483-lists+linux-xfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-xfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SB/oKAY4eml+4gEAu9opvQ
	(envelope-from <linux-xfs+bounces-30483-lists+linux-xfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-xfs@lfdr.de>; Wed, 28 Jan 2026 17:23:34 +0100
X-Original-To: lists+linux-xfs@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A5CDA5872
	for <lists+linux-xfs@lfdr.de>; Wed, 28 Jan 2026 17:23:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id EFC0C3082640
	for <lists+linux-xfs@lfdr.de>; Wed, 28 Jan 2026 16:15:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3EB7430DED4;
...
X-Spamd-Result: default: False [-0.06 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-30483-lists,linux-xfs=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lst.de:mid,lst.de:email,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,infradead.org:dkim,samsung.com:email,oracle.com:email]
X-Rspamd-Queue-Id: 5A5CDA5872
