...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E1D87765F56
	for <lists+linux-xfs@lfdr.de>; Fri, 28 Jul 2023 00:25:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231796AbjG0WZk (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 27 Jul 2023 18:25:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44300 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231776AbjG0WZj (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 27 Jul 2023 18:25:39 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D2747F0;
        Thu, 27 Jul 2023 15:25:36 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 4E38F61F5C;
        Thu, 27 Jul 2023 22:25:36 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id A2134C433C7;
        Thu, 27 Jul 2023 22:25:35 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1690496735;
        bh=LKWXoAO0TLiGtAREcpTso5m/gDVQVVc83vKbNqZpEYU=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 27 Jul 2023 15:25:35 -0700
...
Message-ID: <169049623585.921478.14484774475907349490.stgit@frogsfrogsfrogs>
...
---
 ...
 fs/xfs/scrub/trace.h   |  121 ++++++++++++++++
 fs/xfs/scrub/xfarray.c |  369 ++++++++++++++++++++++++++++++++++++++++++++++++
 fs/xfs/scrub/xfarray.h |   57 +++++++
 fs/xfs/scrub/xfile.c   |  312 +++++++++++++++++++++++++++++++++++++++++
 fs/xfs/scrub/xfile.h   |   57 +++++++
...
index 52e1823241fbc..152348b4dece2 100644
--- a/fs/xfs/Kconfig
+++ b/fs/xfs/Kconfig
...
index d562d128af8ec..7a5fa47a30936 100644
--- a/fs/xfs/Makefile
+++ b/fs/xfs/Makefile
...
index 0a975439d2b63..46249e7b17e09 100644
...
index 0000000000000..ca4a4a307010f
--- /dev/null
...
new file mode 100644
index 0000000000000..3ef7911b104b8
--- /dev/null
...
new file mode 100644
index 0000000000000..19d512887980f
--- /dev/null
...
new file mode 100644
index 0000000000000..9328a37fedaa3
--- /dev/null
