...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 10DEE444BE8
	for <lists+linux-xfs@lfdr.de>; Thu,  4 Nov 2021 01:16:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230314AbhKDATO (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 3 Nov 2021 20:19:14 -0400
Received: from mail107.syd.optusnet.com.au ([211.29.132.53]:38868 "EHLO
        mail107.syd.optusnet.com.au" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S232214AbhKDATN (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 3 Nov 2021 20:19:13 -0400
Received: from dread.disaster.area (pa49-180-20-157.pa.nsw.optusnet.com.au [49.180.20.157])
        by mail107.syd.optusnet.com.au (Postfix) with ESMTPS id CCC11F2C363;
        Thu,  4 Nov 2021 11:16:34 +1100 (AEDT)
Received: from dave by dread.disaster.area with local (Exim 4.92.3)
        (envelope-from <david@fromorbit.com>)
        id 1miQQj-004ZqU-83; Thu, 04 Nov 2021 11:16:33 +1100
Date:   Thu, 4 Nov 2021 11:16:33 +1100
From:   Dave Chinner <david@fromorbit.com>
To:     Allison Henderson <allison.henderson@oracle.com>
Cc:     linux-xfs@vger.kernel.org
Subject: Re: [PATCH] xfs: Fix double unlock in defer capture code
Message-ID: <20211104001633.GD449541@dread.disaster.area>
References: <20211103213309.824096-1-allison.henderson@oracle.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20211103213309.824096-1-allison.henderson@oracle.com>
X-Optus-CM-Score: 0
X-Optus-CM-Analysis: v=2.4 cv=epq8cqlX c=1 sm=1 tr=0 ts=61832662
        a=t5ERiztT/VoIE8AqcczM6g==:117 a=t5ERiztT/VoIE8AqcczM6g==:17
        a=kj9zAlcOel0A:10 a=vIxV3rELxO4A:10 a=VwQbUJbxAAAA:8 a=yPCof4ZbAAAA:8
        a=7-415B0cAAAA:8 a=bt-foUb8OC8NvW3FnAAA:9 a=CjuIK1q_8ugA:10
