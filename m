...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EE579151641
	for <lists+linux-xfs@lfdr.de>; Tue,  4 Feb 2020 08:06:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726706AbgBDHGq (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Tue, 4 Feb 2020 02:06:46 -0500
Received: from us-smtp-2.mimecast.com ([205.139.110.61]:34710 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1725834AbgBDHGq (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Tue, 4 Feb 2020 02:06:46 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1580800003;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding;
        bh=k2lQaXMKBn0zPUTxgb3riLhdFJ8/nTlpG2eGCd5IYss=;
        b=HvtN1hwyzqeUbSfhpdE6SbCTj41WbO4loJJkJpX9T7Dm7KIfoBTW8zp7+UqQ6uvMy8psBm
        VYghkKYQdhQhS20ivzGYO1X+mwMG4EmxCR/W1VY2PX1dVrfYc2LDTPkxqMw0rzNCG3IwiK
        +pHjE9FtbHuiki1UYUQLCSHWgVA1d+k=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-266-9E1CRE3sO4GgmH_zVUFoSA-1; Tue, 04 Feb 2020 02:06:41 -0500
X-MC-Unique: 9E1CRE3sO4GgmH_zVUFoSA-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 239AB8018A1
        for <linux-xfs@vger.kernel.org>; Tue,  4 Feb 2020 07:06:41 +0000 (UTC)
Received: from bogon.redhat.com (ovpn-13-198.pek2.redhat.com [10.72.13.198])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 30F1F60BF4
        for <linux-xfs@vger.kernel.org>; Tue,  4 Feb 2020 07:06:39 +0000 (UTC)
From:   Zorro Lang <zlang@redhat.com>
To:     linux-xfs@vger.kernel.org
Subject: [PATCH] xfs: fix invalid pointer dereference in xfs_attr3_node_inactive
Date:   Tue,  4 Feb 2020 15:06:36 +0800
Message-Id: <20200204070636.25572-1-zlang@redhat.com>
MIME-Version: 1.0
...
gets 'child_bp' at there:
  error =3D xfs_trans_get_buf(*trans, mp->m_ddev_targp,
                            child_blkno,
                            XFS_FSB_TO_BB(mp, mp->m_attr_geo->fsbcount), =
0,
                            &child_bp);
  if (error)
          return error;
...
[75626.212549] =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
[75626.245606] BUG: KASAN: use-after-free in xfs_attr3_node_inactive+0x61=
e/0x8a0 [xfs]
[75626.280164] Read of size 4 at addr ffff88881ffab004 by task rm/30390

[75626.315595] CPU: 13 PID: 30390 Comm: rm Tainted: G        W         5.=
5.0+ #1
[75626.347856] Hardware name: HP ProLiant DL380p Gen8, BIOS P70 08/02/201=
4
...
[75627.033260] Code: 73 01 c3 48 8b 0d 0d d8 2c 00 f7 d8 64 89 01 48 83 c=
8 ff c3 66 2e 0f 1f 84 00 00 00 00 00 90 f3 0f 1e fa b8 07 01 00 00 0f 05=
 <48> 3d 01 f0 ff ff 73 01 c3 48 8b 0d dd d7 2c 00 f7 d8 64 89 01 48
[75627.123796] RSP: 002b:00007ffcdf66ad38 EFLAGS: 00000246 ORIG_RAX: 0000=
000000000107
[75627.158521] RAX: ffffffffffffffda RBX: 0000562cd8b5d5b0 RCX: 00007f968=
239567b
[75627.190764] RDX: 0000000000000000 RSI: 0000562cd8b5c380 RDI: 00000000f=
fffff9c
[75627.222921] RBP: 0000562cd8b5c2f0 R08: 0000000000000003 R09: 000000000=
0000000
[75627.255236] R10: 0000000000000000 R11: 0000000000000246 R12: 00007ffcd=
f66af20
[75627.287435] R13: 0000000000000000 R14: 0000562cd8b5d5b0 R15: 000000000=
0000000
...
[75627.938572] The buggy address belongs to the object at ffff88881ffaad8=
0
...
[75628.069056] page:ffffea00207fea00 refcount:1 mapcount:0 mapping:ffff88=
8098515400 index:0xffff88881ffa9d40 compound_mapcount: 0
[75628.124539] raw: 0057ffffc0010200 dead000000000100 dead000000000122 ff=
ff888098515400
[75628.162598] raw: ffff88881ffa9d40 0000000080270025 00000001ffffffff 00=
00000000000000
[75628.197491] page dumped because: kasan: bad access detected

[75628.230389] Memory state around the buggy address:
[75628.252072]  ffff88881ffaaf00: fb fb fb fb fb fb fb fb fb fb fb fb fb =
fb fb fb
[75628.284801]  ffff88881ffaaf80: fb fb fb fb fb fb fb fb fb fb fb fb fb =
fb fb fb
[75628.317587] >ffff88881ffab000: fb fb fb fb fb fc fc fc fc fc fc fc fc =
fc fc fc
[75628.350592]                    ^
[75628.364746]  ffff88881ffab080: fc fc fc fc fc fc fc fc fb fb fb fb fb =
fb fb fb
[75628.397289]  ffff88881ffab100: fb fb fb fb fb fb fb fb fb fb fb fb fb =
fb fb fb
[75628.429955] =3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
