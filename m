...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0C4A9FCF2F
	for <lists+linux-xfs@lfdr.de>; Thu, 14 Nov 2019 21:10:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726098AbfKNUKK (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 14 Nov 2019 15:10:10 -0500
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:49702 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726592AbfKNUKK (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 14 Nov 2019 15:10:10 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1573762207;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=i4sgBHBPzGci15UC1Q6HQMJEJ3+GKDCyqprGdzfilHc=;
        b=DVoy0FVNKQi2fi8IWArnJQR7UWwCsvxD2TuGTfg0MLqa8MyKB1JqdeQAQQuUpzDzGcg2FN
        xB34Jew90Nf+XdFcaTOWDdHDZDJTtp3UaWMbhSjqMrTvJrz3lHTy/D7VPmsmXJHZsww8Kt
        8OjRfiTOyj5bBm44Wj18FD0Lq95o8BY=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-373-QZCYD6xDNEO8iRyZYFtAmw-1; Thu, 14 Nov 2019 15:10:04 -0500
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 39A089A382
        for <linux-xfs@vger.kernel.org>; Thu, 14 Nov 2019 20:10:03 +0000 (UTC)
Received: from orion.redhat.com (ovpn-204-203.brq.redhat.com [10.40.204.203])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 2BAE517F22
        for <linux-xfs@vger.kernel.org>; Thu, 14 Nov 2019 20:10:01 +0000 (UTC)
From:   Carlos Maiolino <cmaiolino@redhat.com>
To:     linux-xfs@vger.kernel.org
Subject: [PATCH 4/4] xfs: Remove kmem_free()
Date:   Thu, 14 Nov 2019 21:09:55 +0100
Message-Id: <20191114200955.1365926-5-cmaiolino@redhat.com>
...
X-MC-Unique: QZCYD6xDNEO8iRyZYFtAmw-1
...
diff --git a/fs/xfs/scrub/agheader_repair.c b/fs/xfs/scrub/agheader_repair.=
c
...
@@ -199,7 +199,7 @@ __xfs_set_acl(struct inode *inode, struct posix_acl *ac=
l, int type)
...
@@ -240,9 +240,9 @@ static inline struct xfs_efd_log_item *EFD_ITEM(struct =
xfs_log_item *lip)
 STATIC void
...
+=09=09kfree(iu);
 =09}
 =09/*
 =09 * Absorb any runtime errors that aren't a result of corruption because
...
=20
 =09/*
 =09 * If we reported one inode to userspace then we abort because we hit
...
=20
 =09/*
 =09 * Submit buffers that have been added from the last record processed,
...
@@ -127,7 +127,7 @@ __xfs_free_perag(
 =09struct xfs_perag *pag =3D container_of(head, struct xfs_perag, rcu_head=
);
=20
...
=20
 =09/*
 =09 * If we had to allocate a new rsum_cache, we either need to free the
