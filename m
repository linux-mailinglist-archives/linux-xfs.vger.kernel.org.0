...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A0ED02248BC
	for <lists+linux-xfs@lfdr.de>; Sat, 18 Jul 2020 06:34:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726249AbgGREeE (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Sat, 18 Jul 2020 00:34:04 -0400
Received: from userp2130.oracle.com ([156.151.31.86]:59336 "EHLO
        userp2130.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726207AbgGREeE (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Sat, 18 Jul 2020 00:34:04 -0400
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
        by userp2130.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 06I4SXTs055696
        for <linux-xfs@vger.kernel.org>; Sat, 18 Jul 2020 04:33:59 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : subject :
 date : message-id : in-reply-to : references : mime-version : content-type
 : content-transfer-encoding; s=corp-2020-01-29;
 bh=J92eePTJrFHCzzGKwoB0wmwaFdjiAcmEzwmMMDWXBCg=;
 b= 3Q== 
Received: from userp3030.oracle.com (userp3030.oracle.com [156.151.31.80])
        by userp2130.oracle.com with ESMTP id 32brgr05e3-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL)
        for <linux-xfs@vger.kernel.org>; Sat, 18 Jul 2020 04:33:59 +0000
Received: from pps.filterd (userp3030.oracle.com [127.0.0.1])
        by userp3030.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 06I4Woce177073
        for <linux-xfs@vger.kernel.org>; Sat, 18 Jul 2020 04:33:58 GMT
Received: from userv0121.oracle.com (userv0121.oracle.com [156.151.31.72])
        by userp3030.oracle.com with ESMTP id 32bqan5ga6-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-xfs@vger.kernel.org>; Sat, 18 Jul 2020 04:33:58 +0000
Received: from abhmp0003.oracle.com (abhmp0003.oracle.com [141.146.116.9])
        by userv0121.oracle.com (8.14.4/8.13.8) with ESMTP id 06I4XwRG008278
        for <linux-xfs@vger.kernel.org>; Sat, 18 Jul 2020 04:33:58 GMT
...
Subject: [PATCH v11 25/26] xfsprogs: Add delay ready attr set routines
Date:   Fri, 17 Jul 2020 21:33:41 -0700
Message-Id: <20200718043342.6432-26-allison.henderson@oracle.com>
...
---
 ...
 4 files changed, 442 insertions(+), 160 deletions(-)

diff --git a/libxfs/xfs_attr.c b/libxfs/xfs_attr.c
index fe01081..4b974e6 100644
--- a/libxfs/xfs_attr.c
+++ b/libxfs/xfs_attr.c
...
+/*
  ...
  */
@@ -670,41 +733,6 @@ xfs_attr_rmtval_invalidate(
 }
