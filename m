...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A6A52E4623
	for <lists+linux-xfs@lfdr.de>; Fri, 25 Oct 2019 10:48:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2406333AbfJYIsR (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 25 Oct 2019 04:48:17 -0400
Received: from us-smtp-1.mimecast.com ([205.139.110.61]:25157 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S2404126AbfJYIsQ (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Fri, 25 Oct 2019 04:48:16 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1571993294;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=LQH12B/AHxEMafK/nVAOaPWf+3qug3sp5t2xZE3IQQw=;
        b=QB3ZtmwHTK6YOaIZ+q+kngcI7W+14ukeF2ML7LSbmaKcJAlK2ut4fHCfo95dkDvlaTEn1r
        2nuDNMOG0CaeAuOLEjRuZI43cYAvGtpnKLrEd+2SvAfT0RXJfq4oCg2tAUG4FcmCD9mYcx
        JqquM2eEsaTaxbXi8DBW/9wQ2CDLL5g=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-230-USf1wEOJPbaUxDJWjAM0fg-1; Fri, 25 Oct 2019 04:48:11 -0400
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id ED7FF1800E00;
        Fri, 25 Oct 2019 08:48:09 +0000 (UTC)
Received: from donald.localdomain (vpn2-54-104.bne.redhat.com [10.64.54.104])
        by smtp.corp.redhat.com (Postfix) with ESMTPS id 29293194B6;
        Fri, 25 Oct 2019 08:48:09 +0000 (UTC)
Received: from localhost (localhost [IPv6:::1])
        by donald.localdomain (Postfix) with ESMTP id C51EA2801A5;
        Fri, 25 Oct 2019 16:48:06 +0800 (AWST)
Message-ID: <943de2c8954e0781bacf437c67bbb1104d734c1d.camel@redhat.com>
...
Date:   Fri, 25 Oct 2019 16:48:06 +0800
In-Reply-To: <c037e9c5af10e66857589cb3c00337f18ac660f2.camel@redhat.com>
...
X-MC-Unique: USf1wEOJPbaUxDJWjAM0fg-1
...
> > $opts"
> >                         echo "ERROR: expect there's $key in $info,
> > but not found"
> >                         return 1
> >                 fi
> >         else
...
> point (looks like via xfs_mountfs() from xfs_fs_fill_super() to me).
>=20
...
> > > > +
> > > > +# Test logbufs=3Dvalue. Valid numbers range from 2=E2=80=938 inclu=
sive.
...
> > > > +do_test "-o sunit=3D8,swidth=3D8" pass "sunit=3D8,swidth=3D8" "tru=
e"
> > > > +do_test "-o sunit=3D8,swidth=3D64" pass "sunit=3D8,swidth=3D64" "t=
rue"
> > > > +do_test "-o sunit=3D128,swidth=3D128" pass "sunit=3D128,swidth=3D1=
28"
> > > > "true"
> > > > +do_test "-o sunit=3D256,swidth=3D256" pass "sunit=3D256,swidth=3D2=
56"
> > > > "true"
