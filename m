Return-Path: <linux-xfs+bounces-29362-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 4961BD16098
	for <lists+linux-xfs@lfdr.de>; Tue, 13 Jan 2026 01:35:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 2228E300D434
	for <lists+linux-xfs@lfdr.de>; Tue, 13 Jan 2026 00:34:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AF1011AE877;
	Tue, 13 Jan 2026 00:34:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="X+y0PWPi"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8B79B12D1F1;
	Tue, 13 Jan 2026 00:34:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1768264448; cv=none; b=mUqsRGyjceScXbwW79hU4Toeuwkbr+NbaGgd4wtL4t911LfqO/TC0VL/2oqtTD/IP5a0uze9+/n9blJjj5e+ISH9751VJozcNljyxqVWIvgdaMoLxvmwob0dCVp+w9Gx671s54EmCCPTPWRb3CFax0EqSSJjuLOEi5VGIaEKFhE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1768264448; c=relaxed/simple;
	bh=DRWKJ4kTj39QO2YisM/ijIPfuL8gCWA28xG+DBPC8yg=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=AwPF6LolwrxaH02+CD8m3vmW9o4Ir6DhN+Yb37GtTymZGEk7hUX9gBOqqiPPZDy7ggP3xirixW+pszi/z8X4mLllqeprIBp0BS/5oYduhDClOB3LSHYtG+GceOIWrjNiQEsQDJ92o3P6yicD5nJmj9Y376eGUXYgMGpvYLsjBOo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=X+y0PWPi; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 18F0FC116D0;
	Tue, 13 Jan 2026 00:34:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1768264448;
	bh=DRWKJ4kTj39QO2YisM/ijIPfuL8gCWA28xG+DBPC8yg=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Mon, 12 Jan 2026 16:34:07 -0800
...
Message-ID: <176826412835.3493441.7037634047704901774.stgit@frogsfrogsfrogs>
...
index 20020022b0611c..c9c8d9f10fc49c 100644
...
@@ -201,6 +202,11 @@ xfs_healthmon_merge_events(
 			return false;
 		}
 		return false;
+
...
+		return true;
 	...
 	return false;
@@ -510,6 +516,28 @@ xfs_healthmon_report_inode(
...
@@ -518,6 +546,44 @@ xfs_healthmon_reset_outbuf(
 	hm->bufhead = 0;
 }
...
@@ -533,6 +599,7 @@ static const unsigned int type_map[] = {
...
@@ -561,6 +628,9 @@ xfs_healthmon_format_v0(
 		case XFS_HEALTHMON_LOST:
