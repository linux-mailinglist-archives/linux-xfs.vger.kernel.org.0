...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8589675ADEE
	for <lists+linux-xfs@lfdr.de>; Thu, 20 Jul 2023 14:10:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229691AbjGTMKs (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 20 Jul 2023 08:10:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33886 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229531AbjGTMKr (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 20 Jul 2023 08:10:47 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 77F8D1BC6
        for <linux-xfs@vger.kernel.org>; Thu, 20 Jul 2023 05:10:46 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id F2FAF61A44
        for <linux-xfs@vger.kernel.org>; Thu, 20 Jul 2023 12:10:45 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 70554C433C7;
        Thu, 20 Jul 2023 12:10:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1689855045;
        bh=j42ZQWU0s/RHDslg9X9NXth9W464uTApIwDIR3AcYBU=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Thu, 20 Jul 2023 14:10:41 +0200
From:   Carlos Maiolino <cem@kernel.org>
To:     "Darrick J. Wong" <djwong@kernel.org>
Cc:     linux-xfs@vger.kernel.org
Subject: Re: [ANNOUNCE] xfsprogs-6.4.0 released
Message-ID: <20230720121041.dcedah6vtzztngko@andromeda>
References: <20230719143257.uwxq56xc6s7mk6qa@andromeda>
 <ol5BYWklb2CjXIQQiEwpeqHP2ikUKy3sUORIaRIGDSQemECiV5U5LQqpw47ERkSdg45iN46rU8bbHmvawqRSSQ==@protonmail.internalid>
 <20230719144730.GG11352@frogsfrogsfrogs>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20230719144730.GG11352@frogsfrogsfrogs>
...
On Wed, Jul 19, 2023 at 07:47:31AM -0700, Darrick J. Wong wrote:
> On Wed, Jul 19, 2023 at 04:32:57PM +0200, Carlos Maiolino wrote:
> >
> > TL;DR;
...
> > --follow-tags.
> 
> /me suggests adopting the habit of explicitly pushing the branches and
> tags you want, e.g.
> 
> $ git push korg xfs-6.5-merge:for-next xfs-6.5-merge-1
> 
> because I've messed up with --tags in the past, and cleaning all that
> out of the main repos is a PITA.

Heh :) I usually set follow-tags, which makes things easier, but indeed
specifying the tag to be pushed is way safer.

> 
> That said, thank you for getting the release done. :)
