...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DE014884EC
	for <lists+linux-xfs@lfdr.de>; Fri,  9 Aug 2019 23:38:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726652AbfHIVi2 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 9 Aug 2019 17:38:28 -0400
Received: from userp2120.oracle.com ([156.151.31.85]:59514 "EHLO
        userp2120.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728190AbfHIVi1 (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Fri, 9 Aug 2019 17:38:27 -0400
Received: from pps.filterd (userp2120.oracle.com [127.0.0.1])
        by userp2120.oracle.com (8.16.0.27/8.16.0.27) with SMTP id x79LYPO7084493
        for <linux-xfs@vger.kernel.org>; Fri, 9 Aug 2019 21:38:26 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : subject :
 date : message-id : in-reply-to : references; s=corp-2019-08-05;
 bh=DQdanyK38FrNYWj4SZtFbKs5sGGx3TrxRCOK53iRTGc=;
 b= Xw== 
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=from : to : subject :
 date : message-id : in-reply-to : references; s=corp-2018-07-02;
 bh=DQdanyK38FrNYWj4SZtFbKs5sGGx3TrxRCOK53iRTGc=;
 b= HA== 
Received: from aserp3020.oracle.com (aserp3020.oracle.com [141.146.126.70])
        by userp2120.oracle.com with ESMTP id 2u8hgpa7y9-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-xfs@vger.kernel.org>; Fri, 09 Aug 2019 21:38:26 +0000
Received: from pps.filterd (aserp3020.oracle.com [127.0.0.1])
        by aserp3020.oracle.com (8.16.0.27/8.16.0.27) with SMTP id x79LcPZZ112215
        for <linux-xfs@vger.kernel.org>; Fri, 9 Aug 2019 21:38:25 GMT
Received: from userv0122.oracle.com (userv0122.oracle.com [156.151.31.75])
        by aserp3020.oracle.com with ESMTP id 2u8x9fxkbh-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-xfs@vger.kernel.org>; Fri, 09 Aug 2019 21:38:25 +0000
Received: from abhmp0017.oracle.com (abhmp0017.oracle.com [141.146.116.23])
        by userv0122.oracle.com (8.14.4/8.14.4) with ESMTP id x79LcMDE010617
...
Subject: [PATCH v1 15/19] xfsprogs: Add delayed attribute routines
Date:   Fri,  9 Aug 2019 14:38:00 -0700
Message-Id: <20190809213804.32628-16-allison.henderson@oracle.com>
...
---
 libxfs/xfs_attr.c | 720 ++++++++++++++++++++++++++++++++++++++++++++++++++++++
 libxfs/xfs_attr.h |   2 +
 2 files changed, 722 insertions(+)

diff --git a/libxfs/xfs_attr.c b/libxfs/xfs_attr.c
index 8e8d058..ecc525c 100644
--- a/libxfs/xfs_attr.c
+++ b/libxfs/xfs_attr.c
...
@@ -56,12 +57,16 @@ STATIC int xfs_leaf_has_attr(xfs_da_args_t *args, struct xfs_buf **bp);
  */
...
+xfs_attr_leaf_try_add(struct xfs_da_args *args, struct xfs_buf *bp);
 ...
 int
 xfs_attr_args_init(
@@ -283,6 +288,117 @@ xfs_attr_set_args(
 }
...
+/*
  ...
  */
 int
@@ -332,6 +448,57 @@ xfs_attr_remove_args(
 	return error;
 }
...
+
 ...
 xfs_attr_set(
 	struct xfs_inode	*dp,
@@ -835,6 +1002,150 @@ xfs_attr_leaf_addname(struct xfs_da_args	*args)
 }
...
index 53d7d7e..c673aa5 100644
--- a/libxfs/xfs_attr.h
+++ b/libxfs/xfs_attr.h
@@ -169,9 +169,11 @@ int xfs_attr_get(struct xfs_inode *ip, struct xfs_name *name,
