...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 05141711DFC
	for <lists+linux-xfs@lfdr.de>; Fri, 26 May 2023 04:32:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230126AbjEZCcV (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 25 May 2023 22:32:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56194 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229523AbjEZCcU (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 25 May 2023 22:32:20 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 716799C
        for <linux-xfs@vger.kernel.org>; Thu, 25 May 2023 19:32:16 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 0078E6157B
        for <linux-xfs@vger.kernel.org>; Fri, 26 May 2023 02:32:16 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 58EE0C433EF;
        Fri, 26 May 2023 02:32:15 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1685068335;
        bh=3kf6Q6U+o4b/yIxwWsd9KqWT0YtEKAfel2DSvYsV76A=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 25 May 2023 19:32:14 -0700
Subject: [PATCH 10/14] xfs_repair: check parent pointers
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org, cem@kernel.org
Cc:     linux-xfs@vger.kernel.org, allison.henderson@oracle.com,
        catherine.hoang@oracle.com
Message-ID: <168506078732.3750196.13897732268472318425.stgit@frogsfrogsfrogs>
...
index 9da97fb3a23..0a553f1115f 100644
--- a/libxfs/xfblob.c
+++ b/libxfs/xfblob.c
...
index d1282810bb1..0d6de8ce021 100644
--- a/libxfs/xfblob.h
+++ b/libxfs/xfblob.h
...
index a50d93a3cb0..10645be2a12 100644
--- a/repair/phase6.c
+++ b/repair/phase6.c
@@ -3414,5 +3414,7 @@ _("        - resetting contents of realtime bitmap and summary inodes\n"));
 		}
 	}
...
index 649f0089ffd..421dc9a0a49 100644
--- a/repair/pptr.c
+++ b/repair/pptr.c
@@ -6,8 +6,13 @@
 #include "libxfs.h"
...
index 0ca2e1c6ffc..1cf3444c808 100644
--- a/repair/pptr.h
+++ b/repair/pptr.h
