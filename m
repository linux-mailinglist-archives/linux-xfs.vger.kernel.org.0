Return-Path: <linux-xfs+bounces-30481-lists+linux-xfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-xfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SOhUB7g+emlB4wEAu9opvQ
	(envelope-from <linux-xfs+bounces-30481-lists+linux-xfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-xfs@lfdr.de>; Wed, 28 Jan 2026 17:52:08 +0100
X-Original-To: lists+linux-xfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id B115CA64B4
	for <lists+linux-xfs@lfdr.de>; Wed, 28 Jan 2026 17:52:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 20FE83122C1A
	for <lists+linux-xfs@lfdr.de>; Wed, 28 Jan 2026 16:15:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0408630F7FA;
...
X-Spamd-Result: default: False [-0.06 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-30481-lists,linux-xfs=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[lst.de:mid,lst.de:email,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,oracle.com:email,infradead.org:dkim,samsung.com:email]
X-Rspamd-Queue-Id: B115CA64B4
