Return-Path: <linux-xfs+bounces-8619-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 524188CB9BD
	for <lists+linux-xfs@lfdr.de>; Wed, 22 May 2024 05:23:18 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B66581F2182A
	for <lists+linux-xfs@lfdr.de>; Wed, 22 May 2024 03:23:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7803273502;
	Wed, 22 May 2024 03:23:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="KwQTb5Be"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 380A471B48
	for <linux-xfs@vger.kernel.org>; Wed, 22 May 2024 03:23:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1716348193; cv=none; b=paZns9uWEAZKjTM/+spEObZiyhTkR9g0ZGGpZvZz1QqBrLaYDedb8a0KA4RQsOyVUJtZG8c3DCY+nv7qLwHXI4axcol9EyNbPA8AsEIN/m1+DyWr1XfGx+iO0C1i+ly7Aim6yBveMXO2pFQMknBFjntx16bBjVibupLXvOMlixY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1716348193; c=relaxed/simple;
	bh=ZvTRHy/qTvaEA5CCS5YirftMxujxs0cneyP9P3PaR5U=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=XBDvIM3aA5nz7flfUhIrbOhXMwxuWlmz3wZ156KHzye5tAwDz3QUk+o5iY0ei+xaGDI8DRomZH71AsOIFwcvLVMf16D13abczNi/9F0ueyxwUe1UQ1uIUTZwK3A72pKKZJyEFeB1ohFnaoJ5Tpc51dCvkOB4o91PJQB5SHiYKow=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=KwQTb5Be; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 0779CC2BD11;
	Wed, 22 May 2024 03:23:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1716348193;
	bh=ZvTRHy/qTvaEA5CCS5YirftMxujxs0cneyP9P3PaR5U=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Tue, 21 May 2024 20:23:12 -0700
Subject: [PATCH 2/4] xfs_repair: create refcount bag
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org, cem@kernel.org
Cc: Christoph Hellwig <hch@lst.de>, linux-xfs@vger.kernel.org
Message-ID: <171634535834.2483533.10534733446448083817.stgit@frogsfrogsfrogs>
...
index cd2e6a8fb..2b1a2035c 100644
...
index 5ea8d9618..250c86cca 100644
--- a/repair/Makefile
+++ b/repair/Makefile
@@ -29,6 +29,7 @@ HFILES = \
 	protos.h \
...
index 11d69f997..bed7c7a8f 100644
...
index acd7765c8..49191595f 100644
