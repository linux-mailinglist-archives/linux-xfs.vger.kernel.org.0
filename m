...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4B467711D0B
	for <lists+linux-xfs@lfdr.de>; Fri, 26 May 2023 03:48:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231712AbjEZBsG (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 25 May 2023 21:48:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39572 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230297AbjEZBsG (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 25 May 2023 21:48:06 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6E7FB189
        for <linux-xfs@vger.kernel.org>; Thu, 25 May 2023 18:48:03 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id E8FBB64C19
        for <linux-xfs@vger.kernel.org>; Fri, 26 May 2023 01:48:02 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 4F452C433EF;
        Fri, 26 May 2023 01:48:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1685065682;
        bh=skz6LcFdfSbWykM1h6MHG4FeFF/YBJTSXgMt96HDT1o=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 25 May 2023 18:48:01 -0700
Subject: [PATCH 2/4] xfs_scrub: improve thread scheduling repair items during
 phase 4
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org, cem@kernel.org
Cc:     linux-xfs@vger.kernel.org
Message-ID: <168506072779.3744428.14221328041885064782.stgit@frogsfrogsfrogs>
...
index 09edd05625a..97b4386096e 100644
--- a/scrub/phase1.c
+++ b/scrub/phase1.c
...
index 8fe9cd4c831..a40545f6daf 100644
--- a/scrub/phase2.c
+++ b/scrub/phase2.c
...
index 93f503818f5..ad2723f9ae3 100644
--- a/scrub/phase3.c
+++ b/scrub/phase3.c
@@ -10,6 +10,7 @@
 #include "list.h"
...
index b3491f27312..61405dacec4 100644
--- a/scrub/phase4.c
+++ b/scrub/phase4.c
@@ -17,57 +17,166 @@
 #include "scrub.h"
...
index b49f2c7a8e1..b1395275160 100644
--- a/scrub/repair.c
+++ b/scrub/repair.c
...
index 185e539d53c..2ca00bef64a 100644
--- a/scrub/repair.h
+++ b/scrub/repair.h
...
index 1df3191e85c..96a6aa06eac 100644
--- a/scrub/xfs_scrub.h
+++ b/scrub/xfs_scrub.h
