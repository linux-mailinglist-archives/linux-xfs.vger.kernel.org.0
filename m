Return-Path: <linux-xfs+bounces-13792-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E20E999823
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 02:40:07 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E08E528352B
	for <lists+linux-xfs@lfdr.de>; Fri, 11 Oct 2024 00:40:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 76A403D64;
	Fri, 11 Oct 2024 00:40:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="Vzk73kLQ"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 351672F34
	for <linux-xfs@vger.kernel.org>; Fri, 11 Oct 2024 00:40:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1728607202; cv=none; b=Zu2TOEFs1HCq8JqIV+SyobqaNOZet1BkX8L5+9a6JpxTrCLEiog/OkFqK+HkqXWF+npZk2TTQ+/gWsW1Kb5Q//8xK7BrCb9hoOKuQQQJ0PPIuPnRzRr84dkOWVxRz/GhSZR7WEDXikYtFoRlpmqgNFD2O5kizegVjt+m9h5fG1k=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1728607202; c=relaxed/simple;
	bh=W2FyhatqFeLH1YPzHLdWe7r7bVrcp9ke18gOCOUQxUs=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=X2DP0Yz2WLq0+nnzcq16pZwEPc1lmZsWEkk9j9crvO5Wzkl6PaRU4yKRwCzRBDdI+G3hcAwjeU7dZ8e8ySfdA2DBs5D0Orns2WuQDXkYY2V2/2vxXhfmWzJdX8DRTnUw6qGP04rf5a6SCGTwYsDPyoiZ87uJqXUiIyoU25LIbNg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=Vzk73kLQ; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 0EEE2C4CEC5;
	Fri, 11 Oct 2024 00:40:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1728607202;
	bh=W2FyhatqFeLH1YPzHLdWe7r7bVrcp9ke18gOCOUQxUs=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Thu, 10 Oct 2024 17:40:01 -0700
Subject: [PATCH 09/25] xfs: add xfs_agbno_to_fsb and xfs_agbno_to_daddr
 helpers
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: linux-xfs@vger.kernel.org, hch@lst.de
Message-ID: <172860640562.4175438.11868451927245962394.stgit@frogsfrogsfrogs>
...
index 1c478a5c43b72d..3c62478b4b2e58 100644
--- a/fs/xfs/libxfs/xfs_ag.c
+++ b/fs/xfs/libxfs/xfs_ag.c
@@ -855,7 +855,7 @@ xfs_ag_shrink_space(
...
index d0991ae0aa77ef..e8ed5a33caea0a 100644
--- a/fs/xfs/libxfs/xfs_ag.h
+++ b/fs/xfs/libxfs/xfs_ag.h
@@ -329,4 +329,20 @@ int xfs_ag_extend_space(struct xfs_perag *pag, struct xfs_trans *tp,
 			xfs_extlen_t len);
...
index fcfb03abbe16a2..9071e1cb97f72a 100644
...
+				xfs_agbno_to_daddr(args->pag, fbno),
 		...
 		if (error)
 			goto error;
@@ -2936,9 +2936,8 @@ xfs_alloc_fix_freelist(
...
@@ -3599,7 +3598,7 @@ xfs_alloc_vextent_finish(
 		goto out_drop_perag;
 	}
...
@@ -3651,7 +3650,6 @@ xfs_alloc_vextent_this_ag(
...
-	struct xfs_mount	*mp = args->mp;
 	...
 	int			error;
@@ -3664,8 +3662,8 @@ xfs_alloc_vextent_this_ag(
...
index a00ec7ae17925d..7e9a4062a1c048 100644
