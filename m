Return-Path: <linux-xfs+bounces-6326-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 3210789D121
	for <lists+linux-xfs@lfdr.de>; Tue,  9 Apr 2024 05:35:55 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 749E41F21D5D
	for <lists+linux-xfs@lfdr.de>; Tue,  9 Apr 2024 03:35:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 075FD5491D;
	Tue,  9 Apr 2024 03:35:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="sJplCUvC"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A14132572;
	Tue,  9 Apr 2024 03:35:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712633749; cv=none; b=Zfb5+QzQ7pZkwN6VdUP4tothrW++oCy4DRSQxAB1bpUMELSMtLewDwK0TUF6SoWpqmaU6Hm7TC+H1GCF1XDeLcNzqEGRg5Oqu3mk9bNiFejElK++SyNBg6LtEUuoLIzBGarnrpN1hv5VzJ1x5MATb84js1Rc5we5ETSw1Lm5QOw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712633749; c=relaxed/simple;
	bh=7yb/2chAowV6N+vjU0Llh9xEcivpZj9mSmh74B1LDMo=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=RVytiU6C0O8lqHxl3R5JbhBjJ61yYppU/jGykWHO0fR/P7vsWJ1A8L6WcwxxTL0tc9jIyUeF2k8YQNcTc52kSqVRH9NWvrTsKk5aVQuI7owZEtujlfN1Ap4Z7y9wpnYwu6W6AHaa66ahzOvo98T33dXafphSryeLlkw9IhQLIvs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=sJplCUvC; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 6C9E7C433F1;
	Tue,  9 Apr 2024 03:35:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1712633749;
	bh=7yb/2chAowV6N+vjU0Llh9xEcivpZj9mSmh74B1LDMo=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Mon, 08 Apr 2024 20:35:48 -0700
...
Message-ID: <171263348545.2978056.2645566439391921253.stgit@frogsfrogsfrogs>
...
index a575e26ae1a58..6dab81fab72fb 100644
...
index 923c386cb9756..47b375661c2af 100644
--- a/fs/xfs/xfs_exchrange.h
+++ b/fs/xfs/xfs_exchrange.h
@@ -31,4 +31,12 @@ struct xfs_exchrange {
