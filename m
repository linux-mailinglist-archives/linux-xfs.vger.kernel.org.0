Return-Path: <linux-xfs+bounces-1435-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 4348B820E25
	for <lists+linux-xfs@lfdr.de>; Sun, 31 Dec 2023 21:58:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9BD16B21706
	for <lists+linux-xfs@lfdr.de>; Sun, 31 Dec 2023 20:58:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0E5DAC12B;
	Sun, 31 Dec 2023 20:58:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="XNciWu16"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CDB34C126
	for <linux-xfs@vger.kernel.org>; Sun, 31 Dec 2023 20:58:09 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 55489C433C8;
	Sun, 31 Dec 2023 20:58:09 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1704056289;
	bh=VaJZ+1/YANtXO1wdFb1ICPCYF2x0BtGvPxKhlpqHp6w=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=XNciWu16Er5kFmOuLStRfjPeZwXit1gzU78aaJfpcROlx/F0cYlUGWGSzf203RjGy
	 ...
	 aS01YuBgNEFGU/0IrvVgwHqeXnTR3mPoWwtQVsfuOzmV1FsjXBhAEAOLcCgMXMdz45
	 UamdfIGXtifOw1ZyaJgtfoVn8FfVpvzAxuGmGIwriJx07r/PAAx+TuQzpI8YCQo9Vd
	 Iu9k7dcwM+ksg==
Date: Sun, 31 Dec 2023 12:58:08 -0800
Subject: [PATCH 19/22] xfs: actually rebuild the parent pointer xattrs
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: catherine.hoang@oracle.com, allison.henderson@oracle.com,
 linux-xfs@vger.kernel.org
Message-ID: <170404842052.1757392.17748089433238342217.stgit@frogsfrogsfrogs>
...
---
 ...
 fs/xfs/scrub/parent_repair.c |  696 +++++++++++++++++++++++++++++++++++++++++-
 fs/xfs/scrub/trace.h         |    2 
 11 files changed, 707 insertions(+), 25 deletions(-)


diff --git a/fs/xfs/libxfs/xfs_attr.c b/fs/xfs/libxfs/xfs_attr.c
index ef32c2a22c617..9cefaeca8f854 100644
--- a/fs/xfs/libxfs/xfs_attr.c
+++ b/fs/xfs/libxfs/xfs_attr.c
@@ -935,7 +935,7 @@ xfs_attr_defer_add(
...
index 0204f62298cb5..a2cfe9e35fd43 100644
...
index f213d745746fd..555e1b65c78aa 100644
...
index cc964dc427e23..0c369a243a635 100644
...
index 0a9ffa7cfa906..ea73b8d498a24 100644
...
index 9468029f73933..ceb76b26c6cd1 100644
...
index dc893f2cdc1c3..44f9660ae544f 100644
...
index b94eebec3cc79..00e6735717a37 100644
...
@@ -751,6 +867,492 @@ xrep_parent_move_to_orphanage(
 	return 0;
 }
...
+	 * we're ready to swapext the attr fork.
+	 */
...
index b03e1e69740fa..10e2d6544c5ad 100644
