...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3656740A3B6
	for <lists+linux-xfs@lfdr.de>; Tue, 14 Sep 2021 04:42:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236953AbhINCn2 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Mon, 13 Sep 2021 22:43:28 -0400
Received: from mail.kernel.org ([198.145.29.99]:53594 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S234374AbhINCn2 (ORCPT <rfc822;linux-xfs@vger.kernel.org>);
        Mon, 13 Sep 2021 22:43:28 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 5C82F606A5;
        Tue, 14 Sep 2021 02:42:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1631587331;
        bh=2VXykYF1NpHP6SQ+p/icx2jUHdFl6wCBFB8HfzNvIBg=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Subject: [PATCH 24/43] xfs: replace xfs_sb_version checks with feature flag
 checks
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     sandeen@sandeen.net, djwong@kernel.org
Cc:     Dave Chinner <dchinner@redhat.com>, Christoph Hellwig <hch@lst.de>,
        linux-xfs@vger.kernel.org
Date:   Mon, 13 Sep 2021 19:42:11 -0700
Message-ID: <163158733109.1604118.2378745638711836230.stgit@magnolia>
...
index 9eda6eba..8051759a 100644
--- a/libxfs/xfs_ag.c
+++ b/libxfs/xfs_ag.c
@@ -467,7 +467,7 @@ xfs_rmaproot_init(
 	rrec->rm_offset = 0;
...
@@ -567,7 +567,7 @@ xfs_agflblock_init(
 	__be32			*agfl_bno;
 	int			bucket;
...
@@ -717,14 +717,14 @@ xfs_ag_init_headers(
...
@@ -732,7 +732,7 @@ xfs_ag_init_headers(
...
index be4b8fa3..79be19ec 100644
