Return-Path: <linux-xfs+bounces-16265-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 18A0C9E7D6C
	for <lists+linux-xfs@lfdr.de>; Sat,  7 Dec 2024 01:18:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id C6DA7282B4F
	for <lists+linux-xfs@lfdr.de>; Sat,  7 Dec 2024 00:18:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9AB9F2CAB;
	Sat,  7 Dec 2024 00:18:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="MDTMJ0uk"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5A50528E8
	for <linux-xfs@vger.kernel.org>; Sat,  7 Dec 2024 00:18:00 +0000 (UTC)
...
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1733530680; c=relaxed/simple;
	bh=u1zbKmA9mEaGKGwAy6Gl2T6IrGPA/G/qORvIUAK3FbA=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=RfnzxcCahMQOxaVl/L++b4iMT4RdZASHOB84TE3lJCP+1eRd6UMtIR3QCmcy2vqAt/imL/qXOjrXR8EMfq4kPF+LLsauhb1ny5f1GQbGridjX+IubFSum+Z6OoPGw8y+G3yU7l1fh7xX32hTJs1MdN6lA6BnZMNrB2pGvln5Lq4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=MDTMJ0uk; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 31B98C4CED1;
	Sat,  7 Dec 2024 00:18:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1733530680;
	bh=u1zbKmA9mEaGKGwAy6Gl2T6IrGPA/G/qORvIUAK3FbA=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Fri, 06 Dec 2024 16:17:59 -0800
Subject: [PATCH 50/50] mkfs: format realtime groups
From: "Darrick J. Wong" <djwong@kernel.org>
To: aalbersh@kernel.org, djwong@kernel.org
Cc: hch@lst.de, linux-xfs@vger.kernel.org
Message-ID: <173352752710.126362.4060220545378050721.stgit@frogsfrogsfrogs>
...
index de5f6baf59df95..c6a15bd2cb1e5e 100644
...
index 5b9fd0e92f7aba..cd00f3b3bd88f7 100644
--- a/mkfs/xfs_mkfs.c
+++ b/mkfs/xfs_mkfs.c
@@ -132,6 +132,8 @@ enum {
 	R_FILE,
