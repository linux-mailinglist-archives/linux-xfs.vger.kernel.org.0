Return-Path: <linux-xfs+bounces-30001-lists+linux-xfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-xfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WHb3OUN2cGktYAAAu9opvQ
	(envelope-from <linux-xfs+bounces-30001-lists+linux-xfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-xfs@lfdr.de>; Wed, 21 Jan 2026 07:46:27 +0100
X-Original-To: lists+linux-xfs@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A7D452444
	for <lists+linux-xfs@lfdr.de>; Wed, 21 Jan 2026 07:46:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 2E4E44FC3ED
	for <lists+linux-xfs@lfdr.de>; Wed, 21 Jan 2026 06:44:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CCF0A43C06A;
	Wed, 21 Jan 2026 06:43:55 +0000 (UTC)
...
X-Spamd-Result: default: False [0.14 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-30001-lists,linux-xfs=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[dfw.mirrors.kernel.org:rdns,dfw.mirrors.kernel.org:helo,lst.de:mid,infradead.org:url,infradead.org:dkim]
X-Rspamd-Queue-Id: 5A7D452444
