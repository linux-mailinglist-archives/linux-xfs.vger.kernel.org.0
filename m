Return-Path: <linux-xfs+bounces-4314-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E899D868722
	for <lists+linux-xfs@lfdr.de>; Tue, 27 Feb 2024 03:31:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id D7593B252BD
	for <lists+linux-xfs@lfdr.de>; Tue, 27 Feb 2024 02:31:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 78B514A0A;
	Tue, 27 Feb 2024 02:31:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="GsHlNuBt"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 394B8A21
	for <linux-xfs@vger.kernel.org>; Tue, 27 Feb 2024 02:31:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709001078; cv=none; b=Vm+Z20FMsm8uIHUXggZ98CwoEIlssVV7AuOwXlLsrXYgRKeECsN6rR9/bO63FjFurGYfQ9Y9kCuho/Ln/3O+YNgb/k5WOfekaMBzX0f9BCtRghcxNsn9Ot4WCGCdxfKpPp6cMxgLmhZuyBUPv0N8wlMs2tsB0BVEjvEpfWIK06E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709001078; c=relaxed/simple;
	bh=7KPE0Oqz3s/LSGAepyDXL1JI2SF57MJ2VtytYLb70Os=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=nofsly07ftzttYrLYSGxGjlqeWqEnJ1Qxol81XSGHxKwJEBcKxI+PJTn1XAXk2kM/9aXcHH3GbQO3sG3P9omai7AMjiRvX7WeVqKdU8nzeTwptzytGADOA+joQqgYn9x61UKTUxWq3J1cjMYqt1juiNStWbVV2BeWWAeaHf/mIk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=GsHlNuBt; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id BF9EFC433C7;
	Tue, 27 Feb 2024 02:31:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1709001077;
	bh=7KPE0Oqz3s/LSGAepyDXL1JI2SF57MJ2VtytYLb70Os=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Mon, 26 Feb 2024 18:31:17 -0800
Subject: [PATCH 2/4] xfs: scan the filesystem to repair a directory dotdot
 entry
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: linux-xfs@vger.kernel.org, hch@lst.de
Message-ID: <170900014488.939516.5368879219295258358.stgit@frogsfrogsfrogs>
...
index cdb2ee814300d..59e341083e10e 100644
--- a/fs/xfs/Makefile
+++ b/fs/xfs/Makefile
...
index 959b921752e84..e6979ed49408d 100644
...
+	return xrep_findparent_scan(&rd->pscan);
 ...
 /*
@@ -933,6 +940,10 @@ xrep_dir_salvage_entries(
...
@@ -1226,7 +1245,7 @@ xrep_dir_rebuild_tree(
...
@@ -1283,8 +1302,6 @@ xrep_dir_setup_scan(
 	char			*descr;
 	int			error;
...
@@ -1299,8 +1316,15 @@ xrep_dir_setup_scan(
 	if (error)
 		goto out_xfarray;
...
index ec3478bc505ef..71a04f3bd91c1 100644
...
index db0caef0748ab..8a254180de4f9 100644
--- a/fs/xfs/scrub/trace.h
+++ b/fs/xfs/scrub/trace.h
@@ -2605,6 +2605,7 @@ DEFINE_EVENT(xrep_parent_salvage_class, name, \
