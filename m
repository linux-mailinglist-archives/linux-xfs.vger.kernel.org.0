...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 87259711DC4
	for <lists+linux-xfs@lfdr.de>; Fri, 26 May 2023 04:22:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230154AbjEZCWl (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 25 May 2023 22:22:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52476 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230099AbjEZCWk (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 25 May 2023 22:22:40 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 352159B
        for <linux-xfs@vger.kernel.org>; Thu, 25 May 2023 19:22:39 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id ADDAB61276
        for <linux-xfs@vger.kernel.org>; Fri, 26 May 2023 02:22:38 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 18522C433EF;
        Fri, 26 May 2023 02:22:38 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1685067758;
        bh=EtfJv/pgevDcgdkMAJHkkhcTDu7sq1n9Oa1lxAV1QyA=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 25 May 2023 19:22:37 -0700
Subject: [PATCH 03/30] xfs: add parent pointer validator functions
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org, cem@kernel.org
Cc:     Allison Henderson <allison.henderson@oracle.com>,
        linux-xfs@vger.kernel.org, allison.henderson@oracle.com,
        catherine.hoang@oracle.com
Message-ID: <168506077929.3749421.2302263993928538690.stgit@frogsfrogsfrogs>
...
index f485ece835e..a12f43da149 100644
--- a/libxfs/Makefile
+++ b/libxfs/Makefile
@@ -49,6 +49,7 @@ HFILES = \
 	xfs_ialloc_btree.h \
...
index 0d0cf274cc7..ba880fb8575 100644
--- a/libxfs/xfs_attr.c
+++ b/libxfs/xfs_attr.c
@@ -24,6 +24,7 @@
...
index bb1776b8a6c..d2165c85f16 100644
--- a/libxfs/xfs_attr.h
+++ b/libxfs/xfs_attr.h
...
index 62d75e0f368..700c87743ae 100644
...
index c3a6d50267e..afe8073ca8e 100644
