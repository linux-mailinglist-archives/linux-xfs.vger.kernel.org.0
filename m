...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 91187711CC4
	for <lists+linux-xfs@lfdr.de>; Fri, 26 May 2023 03:36:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233928AbjEZBg4 (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 25 May 2023 21:36:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34680 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231451AbjEZBg4 (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 25 May 2023 21:36:56 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 15564195
        for <linux-xfs@vger.kernel.org>; Thu, 25 May 2023 18:36:53 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 98E2064C35
        for <linux-xfs@vger.kernel.org>; Fri, 26 May 2023 01:36:52 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 00F3FC433D2;
        Fri, 26 May 2023 01:36:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1685065012;
        bh=Ru1a0M74cQfE4BYUC0m+mLSfhlBAxPJ4bjPFaRczH8s=;
        h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
        b=
Date:   Thu, 25 May 2023 18:36:51 -0700
Subject: [PATCH 1/1] xfs: online repair of symbolic links
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     djwong@kernel.org
Cc:     linux-xfs@vger.kernel.org
Message-ID: <168506068012.3737907.1767060966517991501.stgit@frogsfrogsfrogs>
In-Reply-To: <168506067997.3737907.11606822392124518390.stgit@frogsfrogsfrogs>
References: <168506067997.3737907.11606822392124518390.stgit@frogsfrogsfrogs>
...
index e52cd4ccf8d6..6c9f6fe45815 100644
--- a/fs/xfs/Makefile
+++ b/fs/xfs/Makefile
...
index 687ff18e52c1..42932fb55cf3 100644
...
index 81be2b108ade..bba4c9ffcc22 100644
...
index 0798e580589e..af63a85d13f0 100644
--- a/fs/xfs/scrub/repair.h
+++ b/fs/xfs/scrub/repair.h
@@ -87,6 +87,7 @@ int xrep_setup_xattr(struct xfs_scrub *sc);
...
@@ -124,6 +125,7 @@ int xrep_fscounters(struct xfs_scrub *sc);
...
@@ -214,6 +216,11 @@ xrep_setup_rtsummary(
 	return 0;
 }
...
@@ -239,6 +246,7 @@ xrep_setup_rtsummary(
...
index f90223b909a2..b5bd7125ca34 100644
...
index 510eb9d5e9dd..b5c79178f000 100644
...
index 000000000000..a2ec1957a54f
--- /dev/null
...
index 7c93dc2922e5..1297f1b2e6a6 100644
...
index c90a444fe0c5..30cac2e0b478 100644
--- a/fs/xfs/scrub/trace.h
+++ b/fs/xfs/scrub/trace.h
@@ -2625,6 +2625,52 @@ DEFINE_REPAIR_DENTRY_EVENT(xrep_orphanage_check_child);
