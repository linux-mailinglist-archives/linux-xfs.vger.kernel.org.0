Return-Path: <linux-xfs+bounces-4906-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id ADC1A87A172
	for <lists+linux-xfs@lfdr.de>; Wed, 13 Mar 2024 03:11:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 395E01F214E1
	for <lists+linux-xfs@lfdr.de>; Wed, 13 Mar 2024 02:11:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 492F4BA2D;
	Wed, 13 Mar 2024 02:11:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="dBuonGTT"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0B84D8BE0
	for <linux-xfs@vger.kernel.org>; Wed, 13 Mar 2024 02:11:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710295909; cv=none; b=PbnnrVp1qwKWF33lB/eNFNnRTAh3ggVXKQp6ZOWR/xBKzobh8kvuygQnbtTIwXzRVAKO5pWBoGrH2k/O3Tp2msmHUlIBgoWjNNejRsz6y5hcEOhQuA3olSlQyU+WOLBOrQPB10ihQTPH54rUjCr0Xlky3301df62/CJ6AAojtS4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710295909; c=relaxed/simple;
	bh=sYvYo9EnT/3kskn67DljJ5QaWeGg1qxbQvSBUAtQQ80=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=dmejIep8QsgAAmLEE0l9v+rimgJRZiHtfXmkoog16hMEuJ/HhmaLu5zo3fAWH7rTIvXih+HO6YCkCNvmR2VsyIQw/cKlduZmUPgi9SjzmC1SG7nbeHr3Vljz9yKEHYmNsQEmR+Z7i3ESVTtwC2cCuAnt0Z0lVtdjg3d84M2H1Ts=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=dBuonGTT; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id DA30AC433F1;
	Wed, 13 Mar 2024 02:11:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1710295908;
	bh=sYvYo9EnT/3kskn67DljJ5QaWeGg1qxbQvSBUAtQQ80=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Tue, 12 Mar 2024 19:11:48 -0700
Subject: [PATCH 2/5] libxfs: refactor the fs_topology structure
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org, cem@kernel.org
Cc: Christoph Hellwig <hch@lst.de>, linux-xfs@vger.kernel.org
Message-ID: <171029433243.2063634.6109378862319035774.stgit@frogsfrogsfrogs>
...
index 06013d429456..8ae5f7483f96 100644
--- a/libxfs/topology.c
+++ b/libxfs/topology.c
@@ -173,18 +173,14 @@ check_overwrite(
 	return ret;
 }
