...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 06F22465449
	for <lists+linux-xfs@lfdr.de>; Wed,  1 Dec 2021 18:52:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240820AbhLARzc (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 1 Dec 2021 12:55:32 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36352 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237013AbhLARzc (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 1 Dec 2021 12:55:32 -0500
Received: from sin.source.kernel.org (sin.source.kernel.org [IPv6:2604:1380:40e1:4800::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 20780C061574
        for <linux-xfs@vger.kernel.org>; Wed,  1 Dec 2021 09:52:11 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by sin.source.kernel.org (Postfix) with ESMTPS id 35E45CE2021
        for <linux-xfs@vger.kernel.org>; Wed,  1 Dec 2021 17:52:09 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 4C498C53FAD;
        Wed,  1 Dec 2021 17:52:07 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1638381127;
        bh=JKriHr+cm9Xaxw707no+HML+WOQCEprRDIc4WoT61g4=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Wed, 1 Dec 2021 09:52:06 -0800
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     Allison Henderson <allison.henderson@oracle.com>
Cc:     linux-xfs@vger.kernel.org
Subject: Re: [PATCH v25 05/12] xfs: Implement attr logging and replay
Message-ID: <20211201175206.GK8467@magnolia>
References: <20211117041343.3050202-1-allison.henderson@oracle.com>
 ...
 <e000662b-e7c4-e61e-4658-ac0990bdf32c@oracle.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <e000662b-e7c4-e61e-4658-ac0990bdf32c@oracle.com>
Precedence: bulk
List-ID: <linux-xfs.vger.kernel.org>
X-Mailing-List: linux-xfs@vger.kernel.org

On Wed, Dec 01, 2021 at 12:34:56AM -0700, Allison Henderson wrote:
> 
> 
...
I suspect you can derive that from the buffer size, since for regular
operation the extra_bytes will always be zero, and that's the only case
where we can't tolerate memory allocation failures:

(I don't remember the xfs_xattri_init code off the top of my head, but
something like this?)

struct xfs_attri_log_item *
xfs_xattri_init(struct xfs_mount *mp, size_t extra_bytes)
{
	if (extra_bytes == 0) {
		ai = kmem_cache_alloc(xfs_xattr_intent_cache,
				GFP_NOFS | __GFP_NOFAIL);
	} else {
		ai = kmem_alloc(sizeof(...) + extra_bytes, GFP_NOFS);
		if (!ai)
			return NULL;
	}

	/* other attri item init */
	return ai;
}
...
> > starts returning -EAGAIN.Well, even when we dont get -EAGAIN, we still
> > need attr for the buffer
> unlock right?  I think we added that for the capture buffers patches we
> added in the last review.

Ah, right.  Ignore this comment then.
