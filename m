...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6228EE4579
	for <lists+linux-xfs@lfdr.de>; Fri, 25 Oct 2019 10:20:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2407905AbfJYIUi (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Fri, 25 Oct 2019 04:20:38 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:55224 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S2408068AbfJYIUi (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Fri, 25 Oct 2019 04:20:38 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1571991636;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=zW6Us6WZYAUEpleJW2DWH7qDgEC4K2G1lPGBB8iY2Po=;
        b=CUSiV6kekYH0b8ap8Hopcgy/DW6eCRWVwsnnR8VWR+TAPpG0JPVcadJ6Z7R5oqYmx5+4Q/
        3Uo/zLzWYwTM55Q8sBFvYvwQpSftzMh6r9a+zkNraMCzYOljlgbUBUX6cwp2qYYibK7hhU
        pDTDrnroQ9hti0L2SFS0A2POECSCqSE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-52-w_Lh5kH2MqKHae7u5hduBw-1; Fri, 25 Oct 2019 04:20:32 -0400
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id CA776107AD31;
        Fri, 25 Oct 2019 08:20:31 +0000 (UTC)
Received: from donald.localdomain (vpn2-54-104.bne.redhat.com [10.64.54.104])
        by smtp.corp.redhat.com (Postfix) with ESMTPS id 06F481001B28;
        Fri, 25 Oct 2019 08:20:31 +0000 (UTC)
Received: from localhost (localhost [IPv6:::1])
        by donald.localdomain (Postfix) with ESMTP id 6E97E2801C4;
        Fri, 25 Oct 2019 16:20:28 +0800 (AWST)
Message-ID: <c037e9c5af10e66857589cb3c00337f18ac660f2.camel@redhat.com>
...
Date:   Fri, 25 Oct 2019 16:20:28 +0800
In-Reply-To: <20191025080530.GA3802@dhcp-12-102.nay.redhat.com>
...
X-MC-Unique: w_Lh5kH2MqKHae7u5hduBw-1
...
>=20
> 2) The case expect there's not "logbufs=3DN" or "logbsize=3DN" output as
> default.
> But your system has these two options in /proc/mounts if mount
> without any
> options.
>=20
> Hmm... strange, I've tested this case on rhel8 and rhel7, all passed.
> Where
