Return-Path: <linux-xfs+bounces-14354-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 69D9E9A2CC4
	for <lists+linux-xfs@lfdr.de>; Thu, 17 Oct 2024 20:55:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id E62421F226C8
	for <lists+linux-xfs@lfdr.de>; Thu, 17 Oct 2024 18:55:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DFA2E219488;
	Thu, 17 Oct 2024 18:55:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="lR3Flq57"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9E8FC1FC7E9
	for <linux-xfs@vger.kernel.org>; Thu, 17 Oct 2024 18:55:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1729191331; cv=none; b=AFGv9nbDmyRw6gpYOPOj89bo3VmyFQmsclP5bybTKWeJUtgBlePB8fMihdWCD5GHTm0+ZDgUAnKe/2WW33OW4uo30khXNduiroE1gXI3k443/lgZghXFfsnoQDZsvZjOpIx9915i6ZNff6oSz0BpivOAc8DO3p4pMWAZ1+1hEs0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1729191331; c=relaxed/simple;
	bh=sfWNidKH7R8u/vM0bbNqynACAax7li2O2g+bAiZRarU=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=LnXHeuVkwdi9gzh5NvBsykYmKxPyjZr+xYHH6yOX9g05+EMMrtplBN9LzducRVDSBCWRkewDMepvs/9/29ivKk4tY2bJ267svSbbh0hhhsmdRSY7fMCOqao0DJ9KzfNhC5ocmzqRbU7lEuwtajjslknIv7/N4cfMYqJCVdPe1Jg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=lR3Flq57; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 7145FC4CEC3;
	Thu, 17 Oct 2024 18:55:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1729191331;
	bh=sfWNidKH7R8u/vM0bbNqynACAax7li2O2g+bAiZRarU=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Thu, 17 Oct 2024 11:55:31 -0700
Subject: [PATCH 05/29] xfs: define the on-disk format for the metadir feature
From: "Darrick J. Wong" <djwong@kernel.org>
To: djwong@kernel.org
Cc: linux-xfs@vger.kernel.org, hch@lst.de
Message-ID: <172919069532.3451313.4589151628714692214.stgit@frogsfrogsfrogs>
...
index 96e92409ca2523..ace52d7eceb524 100644
...
index a3324f3c90c658..2b5318212240a1 100644
--- a/fs/xfs/xfs_message.c
+++ b/fs/xfs/xfs_message.c
@@ -165,6 +165,10 @@ xfs_warn_experimental(
...
index 6eb3369be090db..90229ee0e5fa5c 100644
--- a/fs/xfs/xfs_message.h
+++ b/fs/xfs/xfs_message.h
@@ -97,6 +97,7 @@ enum xfs_experimental_feat {
...
index 1abe369b31a0b7..09a7fe1f81420e 100644
...
@@ -485,6 +487,8 @@ __XFS_HAS_FEAT(nouuid, NOUUID)
