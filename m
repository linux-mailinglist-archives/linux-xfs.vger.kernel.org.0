Return-Path: <linux-xfs+bounces-6864-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 1239D8A6056
	for <lists+linux-xfs@lfdr.de>; Tue, 16 Apr 2024 03:32:57 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 357301C20C26
	for <lists+linux-xfs@lfdr.de>; Tue, 16 Apr 2024 01:32:56 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7D0594C98;
	Tue, 16 Apr 2024 01:32:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="oVlY28WW"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3D64A80C
	for <linux-xfs@vger.kernel.org>; Tue, 16 Apr 2024 01:32:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713231170; cv=none; b=UjvBC51FBT8sitp2uW3p9s1Aav66sYabqGSixop7/pZ0VI7eXjAA0Ja5/ZdlVUuNIpXV3KWMB/teObpxM046IXr8sU62FA35FcCnhwXTYXDz8ZqjSrtkvOMkDSM5VBXwlu5ZSK30quq1Xanog3m2tb0f9bGRumHsWaktsXK6HdI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713231170; c=relaxed/simple;
	bh=8ncSAT+FRyQIam4Q72ICZdEjKSHExDhUz/On8DL3Ihs=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=cOMNTrfeqI6nOqxES9AouzDxAg8uFUDJeE436Tf5/huN+Ec4inA+Smr+xCM1smcDx1zLt7OmkVWyJvx+Zs/4bVfzze/pgRJ/3vAn71z6lyFEtFfuJQcgxi1LmKXI/c8BU/au8+YoJriAHfoKAI8tIn95cI72CN7bVLu0JUHyySo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=oVlY28WW; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B0FCCC113CC;
	Tue, 16 Apr 2024 01:32:49 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1713231169;
	bh=8ncSAT+FRyQIam4Q72ICZdEjKSHExDhUz/On8DL3Ihs=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Mon, 15 Apr 2024 18:32:49 -0700
Subject: [PATCH 26/31] xfs: add parent pointer ioctls
...
Cc: Christoph Hellwig <hch@lst.de>, allison.henderson@oracle.com,
 ...
 hch@lst.de
Message-ID: <171323028211.251715.6240463208868345727.stgit@frogsfrogsfrogs>
...
index b13dea75856a3..f9e294dfeecf1 100644
...
index 417e4a1f5e6cb..6fda363602a0b 100644
...
+ * Copyright (c) 2022-2024 Oracle.
  ...
  */
 #include "xfs.h"
@@ -656,3 +657,288 @@ xfs_attrmulti_by_handle(
 	dput(dentry);
 	return error;
 }
+
