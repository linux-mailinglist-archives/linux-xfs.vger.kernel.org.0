...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 993743F0EF1
	for <lists+linux-xfs@lfdr.de>; Thu, 19 Aug 2021 02:00:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235379AbhHSAAS (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 18 Aug 2021 20:00:18 -0400
Received: from mail105.syd.optusnet.com.au ([211.29.132.249]:59897 "EHLO
        mail105.syd.optusnet.com.au" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S235385AbhHSAAR (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 18 Aug 2021 20:00:17 -0400
Received: from dread.disaster.area (pa49-195-182-146.pa.nsw.optusnet.com.au [49.195.182.146])
        by mail105.syd.optusnet.com.au (Postfix) with ESMTPS id CFB4710499FF
...
Subject: [PATCH 13/16] xfs: convert xfs_sb_version_has checks to use mount features
Date:   Thu, 19 Aug 2021 09:59:32 +1000
Message-Id: <20210818235935.149431-14-david@fromorbit.com>
...
X-Optus-CM-Analysis: v=2.3 cv=F8MpiZpN c=1 sm=1 tr=0
        ...
        a=MhDmnRu9jo8A:10 a=20KFwNOVAAAA:8 a=VwQbUJbxAAAA:8 a=l0_hGK4vAAAA:8
        a=si-boftwRYcclaHsxq4A:9 a=HegpH3PzWjQGFYb7:21 a=xTqYg7mQ8leTTxgk:21
        a=AjGcO6oz07-iQ99wixmX:22 a=iXasW65n-xxAZI4iijma:22
Precedence: bulk
...
---
 ...
 34 files changed, 90 insertions(+), 96 deletions(-)

diff --git a/fs/xfs/libxfs/xfs_ag.c b/fs/xfs/libxfs/xfs_ag.c
index 6e391bdc4d6d..92033c4672a4 100644
...
index 6d7acfc414f3..d2f436c1bf40 100644
...
index 698af856a7f7..fefecdf3f632 100644
...
index 28c020472f9a..b322db523d65 100644
...
index 0455c3fa706f..e2b50f5e9f35 100644
...
index 99df706fe2b9..5e300daa2559 100644
...
index 9a7dd72a9884..0f6051d1854a 100644
...
index 0db855f0c82f..e8c70b0c74ac 100644
--- a/fs/xfs/scrub/agheader_repair.c
+++ b/fs/xfs/scrub/agheader_repair.c
@@ -809,7 +809,7 @@ xrep_agi_calc_from_btrees(
...
@@ -822,8 +822,7 @@ xrep_agi_calc_from_btrees(
...
index 14a3242e93ce..fb0d65ff8b14 100644
...
index 8ad347842583..74a442bc7e14 100644
--- a/fs/xfs/scrub/common.c
+++ b/fs/xfs/scrub/common.c
@@ -487,21 +487,21 @@ xchk_ag_btcur_init(
 	}
...
index b88ee69625d4..737aa5b39d5e 100644
...
index a8703278e168..d6e0e3a11fbc 100644
...
index 3cccd6d5b577..d6c1b00a4fc8 100644
...
index bb5676208c71..8f8029e6048f 100644
--- a/fs/xfs/xfs_super.c
+++ b/fs/xfs/xfs_super.c
@@ -1505,7 +1505,7 @@ xfs_fs_fill_super(
 	}
