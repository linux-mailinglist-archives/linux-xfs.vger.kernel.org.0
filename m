...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 53F72120089
	for <lists+linux-xfs@lfdr.de>; Mon, 16 Dec 2019 10:08:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726016AbfLPJIy (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Mon, 16 Dec 2019 04:08:54 -0500
Received: from us-smtp-1.mimecast.com ([205.139.110.61]:44940 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726141AbfLPJIy (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Mon, 16 Dec 2019 04:08:54 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1576487332;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=mE8Uh/CUBcoB8VtMY/YoW5m/opegWS5+gSzwaX/nnR8=;
        b=PBFHgMmphfSvdDGJfxFDsw+jDWSutA4+FMnuq0S690eyzirt1RG0vZdc/NJAr1DEO9rSoe
        RB9G9w9lGrq+CUhTyp79TYIdqQGBGFUwteyG6w+lgjuCtJwZNPVpOTP9RKmebZgLJAlVzz
        Dthjd8MR7ssRsueSs+06ZGNNRus3sJ4=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-368-qJ9v82YhO_yljR5YusxoNA-1; Mon, 16 Dec 2019 04:08:48 -0500
X-MC-Unique: qJ9v82YhO_yljR5YusxoNA-1
Received: from smtp.corp.redhat.com (int-mx07.intmail.prod.int.phx2.redhat.com [10.5.11.22])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 23239800C7A;
        Mon, 16 Dec 2019 09:08:47 +0000 (UTC)
Received: from localhost (dhcp-12-102.nay.redhat.com [10.66.12.102])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 5111F1001901;
        Mon, 16 Dec 2019 09:08:45 +0000 (UTC)
Date:   Mon, 16 Dec 2019 17:17:08 +0800
From:   Zorro Lang <zlang@redhat.com>
To:     Ian Kent <raven@themaw.net>
Cc:     "Darrick J. Wong" <darrick.wong@oracle.com>,
        fstests@vger.kernel.org, linux-xfs@vger.kernel.org
Subject: Re: [PATCH v2] xfstests: xfs mount option sanity test
Message-ID: <20191216091707.GC14328@dhcp-12-102.nay.redhat.com>
Mail-Followup-To: Ian Kent <raven@themaw.net>,
...
In-Reply-To: <381504a191f867dc53702454103b138eae94d61f.camel@themaw.net>
...
> > > > loop
> > > > device, which on my system means you get rmapbt=3D1 by default an=
d
> > > > whatnot.
> > >=20
...
> > > /proc/mounts?
> > >=20
> > > Actually set MKFS_OPTIONS=3D"" is not helpful for this case, due to=
 I
> > > run
...
The case expects there's "logbsize=3D16k", but it can't find that option.
...
> > > > > mount xfs.
> > > > >    Refer to https://marc.info/?l=3Dfstests&m=3D157199699615477&=
w=3D2
> > > > >=20
> > > > > Thanks,
> > > > > Zorro
...
> > > > > +do_test "-o allocsize=3D$blsize" pass "allocsize=3D$blsize" "t=
rue"
...
> > > > > +
> > > > > +# Test logbufs=3Dvalue. Valid numbers range from 2=E2=80=938 i=
nclusive.
> > > > > +# New kernel (refer to 4f62282a3696 xfs: cleanup
> > > > > xlog_get_iclog_buffer_size)
> > > > > +# prints "logbufs=3DN" in /proc/mounts, but old kernel not. So
> > > > > the default
...
> > > > > +# New kernel (refer to 4f62282a3696 xfs: cleanup
> > > > > xlog_get_iclog_buffer_size)
> > > > > +# prints "logbsize=3DN" in /proc/mounts, but old kernel not. S=
o
> > > > > the default
...
" "true"
> > > > > +do_test "-o sunit=3D128,swidth=3D128" pass "sunit=3D128,swidth=
=3D128"
> > > > > "true"
> > > > > +do_test "-o sunit=3D256,swidth=3D256" pass "sunit=3D256,swidth=
=3D256"
> > > > > "true"
