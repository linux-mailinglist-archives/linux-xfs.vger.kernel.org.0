...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DE12DF25B3
	for <lists+linux-xfs@lfdr.de>; Thu,  7 Nov 2019 04:02:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732928AbfKGDCV (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Wed, 6 Nov 2019 22:02:21 -0500
Received: from userp2130.oracle.com ([156.151.31.86]:44212 "EHLO
        userp2130.oracle.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1732732AbfKGDCV (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Wed, 6 Nov 2019 22:02:21 -0500
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
        by userp2130.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xA72x9j6049392;
        Thu, 7 Nov 2019 03:02:12 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=oracle.com; h=subject : from : to :
 cc : date : message-id : in-reply-to : references : mime-version :
 content-type : content-transfer-encoding; s=corp-2019-08-05;
 bh=GFY8PZpBDwxpe9wIbJ9NZDHu2h+v+aynetQj2CnmknM=;
 b= KA== 
Received: from aserp3030.oracle.com (aserp3030.oracle.com [141.146.126.71])
        by userp2130.oracle.com with ESMTP id 2w41w130ar-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Thu, 07 Nov 2019 03:02:12 +0000
Received: from pps.filterd (aserp3030.oracle.com [127.0.0.1])
        by aserp3030.oracle.com (8.16.0.27/8.16.0.27) with SMTP id xA72wiuX168661;
        Thu, 7 Nov 2019 03:02:11 GMT
Received: from aserv0122.oracle.com (aserv0122.oracle.com [141.146.126.236])
        by aserp3030.oracle.com with ESMTP id 2w41wds56e-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Thu, 07 Nov 2019 03:02:11 +0000
Received: from abhmp0001.oracle.com (abhmp0001.oracle.com [141.146.116.7])
        by aserv0122.oracle.com (8.14.4/8.14.4) with ESMTP id xA732AM2028921;
        Thu, 7 Nov 2019 03:02:10 GMT
Received: from localhost (/67.169.218.210)
        by default (Oracle Beehive Gateway v4.0)
        with ESMTP ; Wed, 06 Nov 2019 19:02:10 -0800
Subject: [PATCH 3/4] xfs: convert open coded corruption check to use
 XFS_IS_CORRUPT
From:   "Darrick J. Wong" <darrick.wong@oracle.com>
To:     darrick.wong@oracle.com
Cc:     linux-xfs@vger.kernel.org, hch@infradead.org
Date:   Wed, 06 Nov 2019 19:02:09 -0800
Message-ID: <157309572922.45542.2780240623887540291.stgit@magnolia>
...
index 68f9535b076b..4ba5557f4ae0 100644
...
@@ -2322,8 +2321,7 @@ xfs_free_agfl_block(
 		return error;
...
index d08bdb066555..e5b82429691c 100644
...
@@ -4420,11 +4414,8 @@ xfs_bmapi_write(
...
@@ -4690,11 +4681,8 @@ xfs_bmapi_remap(
...
@@ -5833,11 +5816,8 @@ xfs_bmap_collapse_extents(
 	int			error = 0;
 	int			logflags = 0;
...
@@ -5953,11 +5933,8 @@ xfs_bmap_insert_extents(
 	int			error = 0;
 	int			logflags = 0;
...
@@ -5995,8 +5972,8 @@ xfs_bmap_insert_extents(
 		goto del_cursor;
 	}
...
@@ -6062,12 +6039,8 @@ xfs_bmap_split_extent_at(
 	int				logflags = 0;
 	int				i = 0;
...
index b236a1bcd03b..d0f8003e8350 100644
...
-		XFS_ERROR_REPORT(__func__, XFS_ERRLEVEL_LOW, mp);
 	...
 	return 0;
@@ -1873,8 +1871,7 @@ xfs_btree_lookup(
...
index b0257ef9d29f..7a5d668a9dff 100644
...
@@ -5209,31 +5194,24 @@ xlog_valid_rec_header(
 {
 	int			hlen;
