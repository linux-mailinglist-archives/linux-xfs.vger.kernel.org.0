Return-Path: <linux-xfs+bounces-3643-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 6339B84EF9C
	for <lists+linux-xfs@lfdr.de>; Fri,  9 Feb 2024 05:23:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 52F5D1F26AA7
	for <lists+linux-xfs@lfdr.de>; Fri,  9 Feb 2024 04:23:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B4C9F5226;
	Fri,  9 Feb 2024 04:23:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="iQcfLOpW"
X-Original-To: linux-xfs@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 369D25221
	for <linux-xfs@vger.kernel.org>; Fri,  9 Feb 2024 04:23:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.129.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707452596; cv=none; b=qZXB3QmTQ2Rpzkq65JFNbfCCCSKgtAFrQqxEWOh8arl5E54/h3BSWLeSuq7e8aRXjP78aWfXyJg42edkOzByXYt1qgfMqS2aPci7pORstb3qziQ+VwAKiMr8Xb1SDpH1DpA1Gra+eO5i7Bwjvn7X8zUGtXui0MT720D2ZwCqg48=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707452596; c=relaxed/simple;
	bh=UZHgNJja55NRi4WHmcZASJ1QoK3R/n0zZcSrMDmAVUY=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=GTdxP1TwwbBCRZ5f4Ve5alnjjD+rWB9aBxYJuglZkX75YWBU8F7w8xZfzBls1ge+/E303tDPlPFWG+LpKipn6uqm9AB5SobdqP1VsmgVknUOI5lDhSuiLNkVv/lNsp9USj7FIN2Zglp4iwND3iO5c+Zy7VaX9jHKkAq8M9bGEec=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=iQcfLOpW; arc=none smtp.client-ip=170.10.129.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1707452585;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 in-reply-to:in-reply-to:references:references;
	bh=l2fJF5EYCwRh9/WzCUO7518vzbxrwfwlXme/xQS8MMc=;
	b=iQcfLOpWrLjKBffzLK0IzGkPPm0sAF+AvVRnuaDDX00m+fgUVNLqNE35EdmdBEdzryTHaZ
	Ykyr1g7+h+FH+28W4hCw17AEAofLKXYzQ6DjMp1396loKYyc9DIPWDlsxWRXy16C+zm83P
	CThCIApf0uRqpNe1h2NL6gWOqoK8aJI=
Received: from mail-pf1-f198.google.com (mail-pf1-f198.google.com
 [209.85.210.198]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-171-C5dOF_kuN2mu9B2f4ig6rA-1; Thu, 08 Feb 2024 23:23:02 -0500
X-MC-Unique: C5dOF_kuN2mu9B2f4ig6rA-1
Received: by mail-pf1-f198.google.com with SMTP id d2e1a72fcca58-6e085a2c38bso306381b3a.3
        for <linux-xfs@vger.kernel.org>; Thu, 08 Feb 2024 20:23:02 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707452581; x=1708057381;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=l2fJF5EYCwRh9/WzCUO7518vzbxrwfwlXme/xQS8MMc=;
        b=
X-Gm-Message-State: AOJu0YwUkDbIy7z9UuyvP5XQ/pulZ21XkrG5yma4O0yXwk1WCZXaWhNn
	QjoAgQgtFTFA63Mz/9eVavQl49CPcfzembdPLbj6YM8j6oOhw+ObZ1BQgvA875nrz05BTR2m8Bi
	6UPyKaKm3c+P2dhdEOLU4n0KQq8hzu7w7Qyv7tpMm5wMSFenEq6/F8h48fZJFoKYwPZTZ
X-Received: by 2002:a05:6a00:2f97:b0:6e0:532a:d5f4 with SMTP id fm23-20020a056a002f9700b006e0532ad5f4mr584002pfb.27.1707452579361;
        Thu, 08 Feb 2024 20:22:59 -0800 (PST)
X-Google-Smtp-Source: AGHT+IGzpWbHybIndNbI2nNA8SdkiM9iLjLsghFavSurHt6fzJU1cPqT0WeNdMIp1cr6n94EC8qu5g==
X-Received: by 2002:a05:6a00:2f97:b0:6e0:532a:d5f4 with SMTP id fm23-20020a056a002f9700b006e0532ad5f4mr583962pfb.27.1707452578178;
        Thu, 08 Feb 2024 20:22:58 -0800 (PST)
Received: from dell-per750-06-vm-08.rhts.eng.pek2.redhat.com ([43.228.180.230])
        by smtp.gmail.com with ESMTPSA id l184-20020a633ec1000000b005d67862799asm705417pga.44.2024.02.08.20.22.55
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 08 Feb 2024 20:22:56 -0800 (PST)
Date: Fri, 9 Feb 2024 12:22:53 +0800
...
Message-ID: <20240209042253.xdrktzjj76yciwfa@dell-per750-06-vm-08.rhts.eng.pek2.redhat.com>
References: <20240208084616.6l3cfdelev7trv3w@dell-per750-06-vm-08.rhts.eng.pek2.redhat.com>
 <87r0hn3s0p.fsf@debian-BULLSEYE-live-builder-AMD64>
Precedence: bulk
...
In-Reply-To: <87r0hn3s0p.fsf@debian-BULLSEYE-live-builder-AMD64>

On Thu, Feb 08, 2024 at 07:10:48PM +0530, Chandan Babu R wrote:
...
Maybe you need a real multiple stripes storage? Or the multi-stripe size is
related? I didn't set any sunit/swith mkfs option to "MKFS_OPTIONS", the
multi-strips comes from a megaraid_sas storage of my testing machine.
...
Although I give 400 to the loop number, but I triggered this issue once in
8 times, once in 39 times.

I'm not sure which kernel config is needed, the kernel config file I used as
below:

#
# Automatically generated file; DO NOT EDIT.
# Linux/x86_64 6.8.0-rc3 Kernel Configuration
#
CONFIG_CC_IS_GCC=y
...
CONFIG_BUILD_SALT="5.14.0-418.el9.x86_64"
