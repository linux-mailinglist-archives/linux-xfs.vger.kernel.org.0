Return-Path: <linux-xfs+bounces-31884-lists+linux-xfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-xfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id cKEMD7VSqGkTtQAAu9opvQ
	(envelope-from <linux-xfs+bounces-31884-lists+linux-xfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-xfs@lfdr.de>; Wed, 04 Mar 2026 16:41:41 +0100
X-Original-To: lists+linux-xfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id D038620300E
	for <lists+linux-xfs@lfdr.de>; Wed, 04 Mar 2026 16:41:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id B4C37319FCC4
	for <lists+linux-xfs@lfdr.de>; Wed,  4 Mar 2026 15:35:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5914134F497;
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	URIBL_MULTI_FAIL(0.00)[sea.lore.kernel.org:server fail,pengutronix.de:server fail,pnres.sk:server fail];
	TAGGED_FROM(0.00)[bounces-31884-lists,linux-xfs=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[jlayton@kernel.org,linux-xfs@vger.kernel.org];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[pengutronix.de:email,pnres.sk:url]
