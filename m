...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7AD4F56AD7D
	for <lists+linux-xfs@lfdr.de>; Thu,  7 Jul 2022 23:32:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236490AbiGGVcE (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Thu, 7 Jul 2022 17:32:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42406 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236418AbiGGVcC (ORCPT
        <rfc822;linux-xfs@vger.kernel.org>); Thu, 7 Jul 2022 17:32:02 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0A461326FB;
        Thu,  7 Jul 2022 14:31:59 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 1D700B82409;
        Thu,  7 Jul 2022 21:31:57 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 57EF6C3411E;
        Thu,  7 Jul 2022 21:31:55 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1657229515;
        bh=ewiTAB9VIbgKVDi6dWiWclQi8/upaxssVU/lwWVmrGw=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Thu, 7 Jul 2022 14:31:54 -0700
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     kernel test robot <oliver.sang@intel.com>
Cc:     Dave Chinner <dchinner@redhat.com>,
        LKML <linux-kernel@vger.kernel.org>, linux-xfs@vger.kernel.org,
        lkp@lists.01.org, lkp@intel.com
Subject: Re: [xfs]  7cf2b0f961:
 BUG:KASAN:use-after-free_in_xfs_attr3_node_inactive[xfs]
Message-ID: <YsdQyhwBpKLLIrw+@magnolia>
References: <YsbxPjmWXXobY/QH@xsang-OptiPlex-9020>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <YsbxPjmWXXobY/QH@xsang-OptiPlex-9020>
...
On Thu, Jul 07, 2022 at 10:44:14PM +0800, kernel test robot wrote:
> 
> 
> Greeting,
> 
...
Hm.  That resolves to the following code:
...
So -- I think the fix here is s/bp/child_bp/.
...
> 	export submit_id='62c56cbe4cee56e081d82bc2'
> 	export job_file='/lkp/jobs/scheduled/lkp-ivb-d05/xfstests-4HDD-xfs-xfs-group-43-ucode=0x21-debian-11.1-x86_64-20220510.cgz-7cf2b0f9611b9971d663e1fc3206eeda3b902922-20220706-57473-1julhi-14.yaml'
> 	export id='74a78685b656500e5ef19fc13feaaf3577581aff'
...
> {"PCI"=>"y"}
> XFS_FS'
> 	export commit='7cf2b0f9611b9971d663e1fc3206eeda3b902922'
...
> 	export enqueue_time='2022-07-06 19:06:38 +0800'
> 	export _id='62c56cbf4cee56e081d82bca'
> 	export _rt='/result/xfstests/4HDD-xfs-xfs-group-43-ucode=0x21/lkp-ivb-d05/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922'
> 	export user='lkp'
> 	export compiler='gcc-11'
> 	export LKP_SERVER='internal-lkp-server'
> 	export head_commit='3b16782cb55643906c145a3641864e842736ec5f'
> 	export base_commit='88084a3df1672e131ddc1b4e39eeacfd39864acf'
> 	export branch='linus/master'
> 	export rootfs='debian-11.1-x86_64-20220510.cgz'
> 	export result_root='/result/xfstests/4HDD-xfs-xfs-group-43-ucode=0x21/lkp-ivb-d05/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/19'
> 	export scheduler_version='/lkp/lkp/.src-20220706-194955'
> 	export arch='x86_64'
> 	export max_uptime=2100
> 	export initrd='/osimage/debian/debian-11.1-x86_64-20220510.cgz'
> 	export bootloader_append='root=/dev/ram0
> RESULT_ROOT=/result/xfstests/4HDD-xfs-xfs-group-43-ucode=0x21/lkp-ivb-d05/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/19
> BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/vmlinuz-5.19.0-rc2-00004-g7cf2b0f9611b
> branch=linus/master
> job=/lkp/jobs/scheduled/lkp-ivb-d05/xfstests-4HDD-xfs-xfs-group-43-ucode=0x21-debian-11.1-x86_64-20220510.cgz-7cf2b0f9611b9971d663e1fc3206eeda3b902922-20220706-57473-1julhi-14.yaml
> user=lkp
> ARCH=x86_64
...
> vga=normal
> rw'
> 	export modules_initrd='/pkg/linux/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/modules.cgz'
...
> 	export last_kernel='5.19.0-rc2-00006-gca76a761ea24'
> 	export repeat_to=20
> 	export schedule_notify_address=
> 	export kbuild_queue_analysis=1
> 	export kernel='/pkg/linux/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/vmlinuz-5.19.0-rc2-00004-g7cf2b0f9611b'
> 	export dequeue_time='2022-07-06 20:11:01 +0800'
> 	export job_initrd='/lkp/jobs/scheduled/lkp-ivb-d05/xfstests-4HDD-xfs-xfs-group-43-ucode=0x21-debian-11.1-x86_64-20220510.cgz-7cf2b0f9611b9971d663e1fc3206eeda3b902922-20220706-57473-1julhi-14.cgz'
> 
> 	[ -n "$LKP_SRC" ] ||
...
> 
> 	run_test test='xfs-group-43' $LKP_SRC/tests/wrapper xfstests
> }
> 
> extract_stats()
> {
...
> 
> 	env test='xfs-group-43' $LKP_SRC/stats/wrapper xfstests
...
> 2022-07-06 12:12:02 export TEST_DIR=/fs/sdb1
> 2022-07-06 12:12:02 export TEST_DEV=/dev/sdb1
> 2022-07-06 12:12:02 export FSTYP=xfs
> 2022-07-06 12:12:02 export SCRATCH_MNT=/fs/scratch
> 2022-07-06 12:12:02 mkdir /fs/scratch -p
> 2022-07-06 12:12:02 export SCRATCH_DEV=/dev/sdb4
> 2022-07-06 12:12:02 export SCRATCH_LOGDEV=/dev/sdb2
> 2022-07-06 12:12:02 export SCRATCH_XFS_LIST_METADATA_FIELDS=u3.sfdir3.hdr.parent.i4
> 2022-07-06 12:12:02 export SCRATCH_XFS_LIST_FUZZ_VERBS=random
> 2022-07-06 12:12:02 sed "s:^:xfs/:" //lkp/benchmarks/xfstests/tests/xfs-group-43
> 2022-07-06 12:12:02 ./check xfs/431 xfs/432 xfs/433 xfs/438
> FSTYP         -- xfs (debug)
> PLATFORM      -- Linux/x86_64 lkp-ivb-d05 5.19.0-rc2-00004-g7cf2b0f9611b #1 SMP Tue Jul 5 20:31:57 CST 2022
> MKFS_OPTIONS  -- -f /dev/sdb4
> MOUNT_OPTIONS -- /dev/sdb4 /fs/scratch
> 
> xfs/431        3s
> xfs/432        24s
> xfs/433       _check_dmesg: something found in dmesg (see /lkp/benchmarks/xfstests/results//xfs/433.dmesg)
> 
> xfs/438        5s
> Ran: xfs/431 xfs/432 xfs/433 xfs/438
> Failures: xfs/433
> Failed 1 of 4 tests
> 
...
> submit_id: 62c42dc858aefa4cb882aaa1
> job_file: "/lkp/jobs/scheduled/lkp-ivb-d05/xfstests-4HDD-xfs-xfs-group-43-ucode=0x21-debian-11.1-x86_64-20220510.cgz-7cf2b0f9611b9971d663e1fc3206eeda3b902922-20220705-19640-u7d4vw-0.yaml"
> id: a4f83b8586c043a5a9f1b66fc37d16955ed4ccdb
...
> bisect_dmesg: true
> :#! include/fs/OTHERS:
> enqueue_time: 2022-07-05 20:25:44.556834664 +08:00
> _id: 62c42dc858aefa4cb882aaa1
> _rt: "/result/xfstests/4HDD-xfs-xfs-group-43-ucode=0x21/lkp-ivb-d05/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922"
> :#! schedule options:
> user: lkp
> compiler: gcc-11
> LKP_SERVER: internal-lkp-server
> head_commit: 3b16782cb55643906c145a3641864e842736ec5f
> base_commit: 88084a3df1672e131ddc1b4e39eeacfd39864acf
> branch: internal-devel/devel-hourly-20220704-200348
> rootfs: debian-11.1-x86_64-20220510.cgz
> result_root: "/result/xfstests/4HDD-xfs-xfs-group-43-ucode=0x21/lkp-ivb-d05/debian-11.1-x86_64-20220510.cgz/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/1"
> scheduler_version: "/lkp/lkp/.src-20220705-170941"
> arch: x86_64
> max_uptime: 2100
...
> - BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/vmlinuz-5.19.0-rc2-00004-g7cf2b0f9611b
> - branch=internal-devel/devel-hourly-20220704-200348
> - job=/lkp/jobs/scheduled/lkp-ivb-d05/xfstests-4HDD-xfs-xfs-group-43-ucode=0x21-debian-11.1-x86_64-20220510.cgz-7cf2b0f9611b9971d663e1fc3206eeda3b902922-20220705-19640-u7d4vw-0.yaml
> - user=lkp
> - ARCH=x86_64
> - kconfig=x86_64-rhel-8.3-func
> - commit=7cf2b0f9611b9971d663e1fc3206eeda3b902922
...
> - vga=normal
> - rw
> modules_initrd: "/pkg/linux/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/modules.cgz"
...
> watchdog:
> :#! runtime status:
> last_kernel: 5.19.0-rc2-00004-g7cf2b0f9611b
> schedule_notify_address:
> :#! user overrides:
> kernel: "/pkg/linux/x86_64-rhel-8.3-func/gcc-11/7cf2b0f9611b9971d663e1fc3206eeda3b902922/vmlinuz-5.19.0-rc2-00004-g7cf2b0f9611b"
> dequeue_time: 2022-07-05 20:59:18.860216052 +08:00
> :#! /cephfs/db/releases/20220705194647/lkp-src/include/site/inn:
> job_state: finished
> loadavg: 1.31 0.47 0.17 1/154 13205
> start_time: '1657026025'
> end_time: '1657026066'
> version: "/lkp/lkp/.src-20220705-171024:ca0124d3a:834749f7f"
...
> sed "s:^:xfs/:" //lkp/benchmarks/xfstests/tests/xfs-group-43
> ./check xfs/431 xfs/432 xfs/433 xfs/438
