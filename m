...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4D329381992
	for <lists+linux-xfs@lfdr.de>; Sat, 15 May 2021 17:32:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232697AbhEOPds (ORCPT <rfc822;lists+linux-xfs@lfdr.de>);
        Sat, 15 May 2021 11:33:48 -0400
Received: from mail.kernel.org ([198.145.29.99]:33340 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232479AbhEOPdo (ORCPT <rfc822;linux-xfs@vger.kernel.org>);
        Sat, 15 May 2021 11:33:44 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 88ADE61363;
        Sat, 15 May 2021 15:32:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1621092751;
        bh=C0uLGA2dUfq8LT7+F5jkUvnLx5lBgHAS7ICuXyFn61c=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Sat, 15 May 2021 08:32:31 -0700
From:   "Darrick J. Wong" <djwong@kernel.org>
To:     Allison Henderson <allison.henderson@oracle.com>
Cc:     linux-xfs@vger.kernel.org
Subject: Re: [PATCH RESEND v18 11/11] xfs: Add delay ready attr set routines
Message-ID: <20210515153231.GQ9675@magnolia>
References: <20210512161408.5516-1-allison.henderson@oracle.com>
 ...
 <14e648fc-94e1-cf0f-d2f8-d64ffa3d67dd@oracle.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <14e648fc-94e1-cf0f-d2f8-d64ffa3d67dd@oracle.com>
Precedence: bulk
List-ID: <linux-xfs.vger.kernel.org>
X-Mailing-List: linux-xfs@vger.kernel.org

On Fri, May 14, 2021 at 10:41:40PM -0700, Allison Henderson wrote:
> 
> 
...
> much effort into getting all the "dela_state =" assignments into the same
> scope.
> 
> I can certainly explore that in another patch, but I would encourage adding
> that patch in the extended set, maybe in the fully delayed series which
> already has a few cleanup patches queued up in it.  That way delayed attrs
> and parent pointers can sort of progress in parrallel with the clean up
> rather than falling back into yet more refactoring.  My inkling is that this
> proposal will be met with a lot of opinion.
> 
> My plan here was to sort of get through this subseries, and then jump right
> into the next 12 patches of the extended set.  How about we add the extra
> patch there?  Maybe around near the end?
...
> > path?
> Yes, I think that's the point of the assert tho.  This is a condition that
> should never happen, so assert that is not the case.  This was part of some
> psuedo code that was suggested earlier.  I do sort of worry about
> continueing to change the patch after it's earned the rvbs though?

Yet another to add to the cleaning series, then.

(Don't drop the RVBs on this one just to fix an assert)
