Return-Path: <linux-xfs+bounces-29029-lists+linux-xfs=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-xfs@lfdr.de
Delivered-To: lists+linux-xfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A581CF6FFA
	for <lists+linux-xfs@lfdr.de>; Tue, 06 Jan 2026 08:14:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 0D27230517EB
	for <lists+linux-xfs@lfdr.de>; Tue,  6 Jan 2026 07:12:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BE239309EE4;
	Tue,  6 Jan 2026 07:12:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="JiaJX9PG"
X-Original-To: linux-xfs@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7B1692C0307;
	Tue,  6 Jan 2026 07:12:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767683547; cv=none; b=ZX6m8kfDrP6A5XwtO7oS/33cgneyL/h4rAohxtBnKES3EFhPMuWC6cfflPy0E2nmhiMjiBAodyD6mK/QZKAh7mg7D51GJH7I3qwj93oxdZ+cgvqVaQnFV0brCDUcO7Su2mb8fzl8mRrVVrW2/CeXDHQeehx6/gOrkb6adtMMFr0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767683547; c=relaxed/simple;
	bh=5MgLtbxSZnIz7pLPIIpA/o1tjLXs0SfFJckK/VDIICI=;
	h=Date:Subject:From:To:Cc:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=pHvfyjZ+zoVVnpu1h6sSVsohu0/Cs2jwuKyPlsi3KZkS4f1oKz97hJ9qk1VuruPhoFyvcTS9rX5UZwktHpvVN4GlNx2dP0ECN9UH+1vlHKcm5Px3Xib2BBGrNfh2flqETV1HpMeiVc9cpRFaUF+6IzQn09L4zoei0DVsT9kDIjg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=JiaJX9PG; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 541ACC19424;
	Tue,  6 Jan 2026 07:12:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1767683547;
	bh=5MgLtbxSZnIz7pLPIIpA/o1tjLXs0SfFJckK/VDIICI=;
	h=Date:Subject:From:To:Cc:In-Reply-To:References:From;
	b=
Date: Mon, 05 Jan 2026 23:12:26 -0800
...
Message-ID: <176766637399.774337.10462015367991320041.stgit@frogsfrogsfrogs>
...
index 2d6ba6060c09c8..486677c79b8608 100644
...
index 2077b50c41b1ab..8cf685b1dda1c2 100644
...
@@ -247,6 +248,19 @@ xfs_healthmon_merge_events(
...
+		return false;
 	...
 	return false;
@@ -586,6 +600,48 @@ xfs_healthmon_report_shutdown(
...
@@ -638,6 +694,9 @@ static const unsigned int domain_map[] = {
...
@@ -648,6 +707,7 @@ static const unsigned int type_map[] = {
...
@@ -699,6 +759,12 @@ xfs_healthmon_format_v0(
