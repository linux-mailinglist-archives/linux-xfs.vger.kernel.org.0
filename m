Return-Path: <linux-xfs+bounces-30243-lists+linux-xfs=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-xfs@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id t4EsGQ1qc2l9vgAAu9opvQ
	(envelope-from <linux-xfs+bounces-30243-lists+linux-xfs=lfdr.de@vger.kernel.org>)
	for <lists+linux-xfs@lfdr.de>; Fri, 23 Jan 2026 13:31:09 +0100
X-Original-To: lists+linux-xfs@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 799BF75D0C
	for <lists+linux-xfs@lfdr.de>; Fri, 23 Jan 2026 13:31:06 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id B7CC2303CE3B
	for <lists+linux-xfs@lfdr.de>; Fri, 23 Jan 2026 12:28:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 771E233A9DB;
...
X-Spamd-Result: default: False [1.34 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,oracle.onmicrosoft.com:dkim,oracle.com:email,oracle.com:dkim,lucifer.local:mid];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-30243-lists,linux-xfs=lfdr.de];
	MIME_TRACE(0.00)[0:+];
